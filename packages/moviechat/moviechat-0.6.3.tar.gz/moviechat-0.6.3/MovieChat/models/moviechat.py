...
class MovieChat(Blip2Base):
    ...
    def from_config(cls, device):
        ...
        ckpt_path = "https://huggingface.co/DAMO-NLP-SG/Video-LLaMA-Series/resolve/main/finetune-vicuna7b-v2.pth?download=true"  # load weights of MiniGPT-4
        save_path = "pretrained_minigpt4.pth"
        if ckpt_path:
            print("Load first Checkpoint: {}".format(ckpt_path))
            response = requests.get(ckpt_path, stream=True)  # Ensure that download is handled in stream mode
