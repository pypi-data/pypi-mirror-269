        ...
        for row in self._weather_data_seventimer:
            ...
            if (
                ...
                for i in range(0, 3):
                    ...
                    item["seeing"] = int(100 - await self._astro_seeing.calculate_seeing_model4(details.get("air_temperature", -1), details.get("wind_speed", -1), details.get("relative_humidity", -1), self._elevation) * 40)
