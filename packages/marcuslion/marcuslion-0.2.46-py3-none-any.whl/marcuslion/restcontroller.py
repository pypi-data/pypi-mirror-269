...
from marcuslion.config import __base_url__, __api_key__, __api_version__
...
class RestController:
    ...
    def _get_url(self, action) -> str:
        ...
        full_url = __base_url__ + '/' + __api_version__ + '/' + self._url_path
