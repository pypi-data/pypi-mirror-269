...
class VersionUpgradeType(Enum):
    major = "重大更新"  # 重大功能更新 version1
    api = "api更新"  # api 变动 version2
    minor = "小功能更新"  # 小功能迭代 version3
    none = "无功能更新"  # 没有功能更新
    abnormal = "异常更新"  # 异常更新
    ...
    def check_for_package_updates(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if result == VersionUpgradeType.major or result == VersionUpgradeType.api or result == VersionUpgradeType.minor:
