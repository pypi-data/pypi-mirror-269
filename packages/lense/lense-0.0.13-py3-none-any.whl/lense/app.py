...
def start():
    ...
    app.mount("/", StaticFiles(directory="../lense/lense/backend/my_frontend", html=True), name="my_frontend")
    uvicorn.run("lense.app:app", reload=False, host="127.0.0.1", port=9016,workers=1)
