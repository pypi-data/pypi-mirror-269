...
class MutateApp:
    ...
    # all keys in prover_dict must exist as attribute of certoraRun
    def check_prover_dict(self) -> None:
        prover_attrs = [attr.get_conf_key() for attr in ContextAttribute]
        for key in self.prover_dict.keys():
    ...
    def read_conf_file(self) -> None:
        ...
        def get_conf_file() -> Optional[str]:
