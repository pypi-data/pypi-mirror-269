...
class BffExperimentRunProto(_message.Message):
    __slots__ = ("id", "experiment_id", "status", "algorithm", "hardware", "metadata", "result", "error_message", "created_by", "cancelled_by", "created_at", "duration_millis", "sequential_id", "model_id", "model_name", "dataset_name", "model_description", "parent_id", "industry", "problem_type", "use_case")
