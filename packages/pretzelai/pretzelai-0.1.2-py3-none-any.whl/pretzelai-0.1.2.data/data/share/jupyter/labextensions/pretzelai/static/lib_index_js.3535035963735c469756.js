        ...
        function getEmbeddings() {
            ...
            if ((notebook === null || notebook === void 0 ? void 0 : notebook.model) && openai) {
                ...
                app.serviceManager.contents
                    ...
                    const embeddings = await Promise.all(cells.slice(0, 1).map(async (cell) => {
                        try {
                            const response = await openai.embeddings.create({
                                model: 'text-embedding-3-large',
                                input: cell.source
                            });
                            return { id: cell.id, embedding: response.data[0].embedding };
                        }
                        catch (error) {
...
//# sourceMappingURL=lib_index_js.3535035963735c469756.js.map