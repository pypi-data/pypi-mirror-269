...
/* harmony import */ var crypto__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! crypto */ "?8845");
        ...
        function getEmbeddings() {
            ...
            if ((notebook === null || notebook === void 0 ? void 0 : notebook.model) && openai) {
                ...
                app.serviceManager.contents
                    ...
                    .catch(async (error) => {
                    console.log(`Creating file ${embeddingsPath} as it does not exist.`);
                    const cells = notebook.model.sharedModel.cells;
                    const embeddings = await Promise.all(cells.map(async (cell) => {
                        const hash = (0,crypto__WEBPACK_IMPORTED_MODULE_5__.createHash)('xxh64');
                        hash.update(cell.source);
...
//# sourceMappingURL=lib_index_js.f18f98325073a770a60c.js.map