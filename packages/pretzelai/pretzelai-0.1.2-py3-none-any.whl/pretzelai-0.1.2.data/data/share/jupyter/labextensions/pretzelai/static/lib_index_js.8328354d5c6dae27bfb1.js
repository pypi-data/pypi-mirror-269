                ...
                app.serviceManager.contents
                    ...
                    try {
                        ...
                        createEmbeddings(embJSON, notebook.model.sharedModel.cells).then(() => {
                            app.serviceManager.contents.save(embeddingsPath, { type: 'file', format: 'text', content: JSON.stringify(embJSON) });
                        });
                    }
                    catch (error) {
                    ...
                    .catch(async (error) => {
                    createEmbeddings([], notebook.model.sharedModel.cells);
                });
            }
            else {
...
//# sourceMappingURL=lib_index_js.8328354d5c6dae27bfb1.js.map