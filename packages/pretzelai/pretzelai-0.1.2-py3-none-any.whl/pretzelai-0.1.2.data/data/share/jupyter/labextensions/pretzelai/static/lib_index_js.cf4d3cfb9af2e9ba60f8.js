    ...
    activate: async (app, palette, notebookTracker, settingRegistry) => {
        ...
        function printCellSources() {
            ...
            if (notebook === null || notebook === void 0 ? void 0 : notebook.model) {
                const currentNotebook = notebook.context.path;
                const embeddingsPath = currentNotebook.split('.ipynb')[0] + '_embeddings.json';
...
//# sourceMappingURL=lib_index_js.cf4d3cfb9af2e9ba60f8.js.map