        ...
        function printCellSources() {
            ...
            if (notebook === null || notebook === void 0 ? void 0 : notebook.model) {
                ...
                readFile(embeddingsPath)
                    ...
                    console.log(`Creating file at ${embeddingsPath} as it does not exist.`);
                    try {
                        await app.serviceManager.contents.save(embeddingsPath, { type: 'file', format: 'text', content: '{}' });
...
//# sourceMappingURL=lib_index_js.c7407c4c4a80cf7ecc60.js.map