    ...
    activate: async (app, palette, notebookTracker, settingRegistry) => {
        ...
        function printCellSources() {
            ...
            if (notebook === null || notebook === void 0 ? void 0 : notebook.model) {
                ...
                // Read embeddings.json from the file system
                Object(function webpackMissingModule() { var e = new Error("Cannot find module 'fs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('embeddings.json', 'utf8', (err, data) => {
                    if (err) {
                ...
                setTimeout(printCellSources, 1000);
            }
        }
        printCellSources();
...
//# sourceMappingURL=lib_index_js.1b9438d1d38b505c60ee.js.map