...
class Inventory(models.Model):
    ...
    type = models.CharField(max_length=30, choices=TYPE, default=_("Select Type"), verbose_name=_("Type"))
    condition = models.CharField(max_length=30, choices=CONDITION, default=_("Select Please"), verbose_name=_("Type"))
...
class SocialLinks(models.Model):
    ...
    social_url=models.URLField(max_length=80, null=True, blank=True)
