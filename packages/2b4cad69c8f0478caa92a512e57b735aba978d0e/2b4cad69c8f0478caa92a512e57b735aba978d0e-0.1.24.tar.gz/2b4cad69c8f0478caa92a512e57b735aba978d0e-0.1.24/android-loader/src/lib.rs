...
mod tests {
    ...
    fn load_android_libraries() {
        ...
        let store_services_core = AndroidLibrary::load(
            "/workspaces/apple-private-apis/applemusic/lib/arm64-v8a/libstoreservicescore.so",
        )
        ...
        let library_path =
            CString::new("/workspaces/apple-private-apis/applemusic/lib/arm64-v8a/").unwrap();
