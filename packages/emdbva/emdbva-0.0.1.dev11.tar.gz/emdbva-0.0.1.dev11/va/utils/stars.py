...
class GetStars:
    ...
    def feature_zone(self, data_curves):
        ...
        if isinstance(levels, np.ndarray) and isinstance(corrected_curve, np.ndarray) and isinstance(phase_rand_curve, np.ndarray):
            ...
            levels, corrected_curve, phase_rand_curve = self.intersections_into_curve(intersections, levels, corrected_curve, phase_rand_curve)
            feature_area, overfit_area = self.plot_feature_zone(intersections, levels, corrected_curve, phase_rand_curve)
