...
class CommonCreateSupportTicketMessageSerializer(serializers.Serializer):
    ...
    def to_internal_value(self, data):
        print("CommonCreateSupportTicketMessageSerializer bef", data)
        data = super().to_internal_value(data)
        print("CommonCreateSupportTicketMessageSerializer aft", data)
...
class CommonCreateSupportTicketSerializer(serializers.ModelSerializer):
    ...
    def to_internal_value(self, data):
        print("CommonCreateSupportTicketSerializer bef", data)
        ...
        data = super().to_internal_value(data)
        print("CommonCreateSupportTicketSerializer aft", data)
        return data
