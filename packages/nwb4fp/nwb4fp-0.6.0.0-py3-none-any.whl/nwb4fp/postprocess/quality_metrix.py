...
def qualitymetrix(path, temp_folder):
    ...
    analyzer1 = si.create_sorting_analyzer(sorting=sorting, recording=rec_save, format='binary_folder', folder=fr"{temp_folder}_analy",overwrite=True)
    ...
    qm_ext = analyzer1.compute(input={"principal_components": dict(n_components=3, mode="by_channel_local"),
