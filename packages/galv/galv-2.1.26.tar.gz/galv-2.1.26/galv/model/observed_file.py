...
class ObservedFile(
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        applicable_mappings: typing.Union[MetaOapg.properties.applicable_mappings, list, tuple, ],
        upload_errors: typing.Union[MetaOapg.properties.upload_errors, list, tuple, ],
        mapping: typing.Union[MetaOapg.properties.mapping, None, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ObservedFile':
        return super().__new__(
