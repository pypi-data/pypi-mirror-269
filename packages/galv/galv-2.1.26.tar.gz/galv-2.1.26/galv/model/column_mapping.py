...
class ColumnMapping(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "uuid", "name", "map", "rendered_map", "is_valid", "missing_required_columns", "team", "permissions", "read_access_level", "edit_access_level", "delete_access_level", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "uuid", "name", "map", "rendered_map", "is_valid", "missing_required_columns", "team", "permissions", "read_access_level", "edit_access_level", "delete_access_level", ], str]):
        return super().get_item_oapg(name)
