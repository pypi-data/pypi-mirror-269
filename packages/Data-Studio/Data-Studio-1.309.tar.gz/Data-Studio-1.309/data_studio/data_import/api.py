...
@method_decorator(name='post', decorator=swagger_auto_schema(
        ...
        operation_description="""
            ...
            **Note:** Imported data is verified against a project *label_config* and must
            ...
            Update this example to specify your authorization token and Data Studio instance host, then run the following from
            the command line.
            ...
            Update this example to specify your authorization token, Data Studio instance host, and file name and path,
