...
def find_file(file):
    return find_node('data_studio', file, 'file')


def find_dir(directory):
    return find_node('data_studio', directory, 'dir')
...
def validate_upload_url(url, block_local_urls=True):
    """Utility function for defending against SSRF attacks. Raises
        ...
        - DataStudioAPIException if the hostname cannot be resolved
    ...
    try:
        ...
        raise DataStudioAPIException(f"Can't resolve hostname {domain}")
