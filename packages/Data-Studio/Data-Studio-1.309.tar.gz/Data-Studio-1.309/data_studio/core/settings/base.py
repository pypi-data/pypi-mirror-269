...
AUTHENTICATION_BACKENDS = ['rules.permissions.ObjectPermissionBackend', 'django.contrib.auth.backends.ModelBackend', 'users.emailAuth.EmailAuthenticationBackend']
