...
from data_studio.core.utils.params import get_bool_env, get_all_env_with_prefix
from data_studio.core.utils.io import find_node
from data_studio.core.current_request import get_current_request

logger = logging.getLogger(__name__)


def get_feature_file_path():
    package_name = 'data_studio' if settings.VERSION_EDITION == 'Community' else 'label_studio_enterprise'
