...
from data_studio.core.utils.io import find_file
from data_studio.core.utils.exceptions import (
...
def parse_config(config_string):
    ...
    """
    logger.warning("Using deprecated method - switch to data_studio.tools.label_config.parse_config!")
...
def _fix_choices(config):
    ...
    https://github.com/heartexlabs/data-studio/issues/1259
    '''
