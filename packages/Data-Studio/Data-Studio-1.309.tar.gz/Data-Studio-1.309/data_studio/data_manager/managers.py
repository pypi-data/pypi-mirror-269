...
from data_studio.core.utils.params import cast_bool_from_str
from data_studio.core.utils.common import load_func
...
def get_fields_for_evaluation(prepare_params, user):
    ...
    if fields:
        from data_studio.data_manager.functions import TASKS
