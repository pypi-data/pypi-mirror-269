...
async def extract_links(text):
    result = []
    try:
        link_regex = r'\bhttps?://\S+\b'
        links = re.findall(link_regex, text)
        result = [link for link in links if link.endswith(('.mp4', '.jpg', '.jpeg', '.png', '.mp3', '.ogg'))]

        # link_regex = r'\bhttp?://\S+\b'
        # links = re.findall(link_regex, text)
        # res2 = [link for link in links if link.endswith(('.mp4', '.jpg', '.jpeg', '.png', '.mp3', '.ogg'))]
