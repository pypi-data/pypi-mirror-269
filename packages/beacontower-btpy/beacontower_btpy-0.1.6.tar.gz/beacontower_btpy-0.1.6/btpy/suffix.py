...
def write(data, filename="suffix.json"):
    """
...
def write_global_suffix(suffix=None):
    data = (
    ...
    write(data, filename=os.path.join(app_dir, "global_suffix.json"))
...
def write_environment_suffix(suffix=None):
    data = (
    ...
    write(data, filename=os.path.join(env_dir, "environment_suffix.json"))
