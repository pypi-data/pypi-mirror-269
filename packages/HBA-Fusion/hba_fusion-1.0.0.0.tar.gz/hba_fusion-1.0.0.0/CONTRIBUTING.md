...
Welcome to `HBA_Fusion` contributor's guide.
...
If you experience bugs or general issues with `HBA_Fusion`, please have a look
...
You can help improve `HBA_Fusion` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`HBA_Fusion` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `HBA_Fusion`'s files. While this mechanism can
...
```
conda create -n HBA_Fusion python=3 six virtualenv pytest pytest-cov
conda activate HBA_Fusion
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/HBA_Fusion.git
   cd HBA_Fusion
   ```
...
5. Install [pre-commit]:
   ...
   `HBA_Fusion` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/HBA_Fusion
[issue tracker]: https://github.com/<USERNAME>/HBA_Fusion/issues
