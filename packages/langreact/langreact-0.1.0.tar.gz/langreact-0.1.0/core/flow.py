...
from core.plugin.qwen_plugin import QwenTurboPlugin
from core.steps import ConcludeStep, PlanStep
from core.tools import flatten_and_dropduplicate
import asyncio
from core.tools import get_timer
import logging
import copy
...
class Flow:
    ...
    def prepare_context(
        ...
        if params.cot_web_retrieve or params.web_retrieve:
            local_context.search_application = (
                ...
                ].create_new_application(local_context)
            )
    ...
    def reflection_context_prepare(
        ...
        reflection_context.application = (
            context.application_plugin.create_new_application(context, reflection=True)
        )
