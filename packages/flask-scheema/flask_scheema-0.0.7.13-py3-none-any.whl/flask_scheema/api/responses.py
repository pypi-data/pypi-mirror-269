...
def xml_to_dict(xml_data):
    ...
    def element_to_dict(element):
        ...
        """
        # Base case: If there's no children and there is text, return the text directly.
        if element.text and not list(element) and element.text.strip():
            return element.text.strip()

        # Recursion case: Build a dictionary from children elements
        else:
            dict_data = {}
