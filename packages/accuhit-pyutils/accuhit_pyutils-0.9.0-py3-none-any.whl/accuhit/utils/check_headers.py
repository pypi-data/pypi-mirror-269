...
from accuhit.utils.exceptions import CommonRuntimeException
from accuhit.utils.payload import ReponsePayloadBulider
    ...
    def decorator(fn):
        ...
        def accept(*args, **kwargs):
            ...
            if app_context and error_code:
                ...
                return json.dumps(response_payload.bulid_from_exception(CommonRuntimeException(error_code)))
