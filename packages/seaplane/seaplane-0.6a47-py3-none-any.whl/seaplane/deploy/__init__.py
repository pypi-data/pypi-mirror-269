...
async def deploy_debug(app: App, project_directory_name: str) -> None:
    ...
    substation_replicate_config = {
        ...
        root.webhook = http://localhost:9000
"""
                },
                {
                    "http": f"""
...
"""
        ...
        fields_mapping: |
          root.model_version = meta("X-Version")
...
"""
    ...
    with open(
        ...
        yaml.dump(substation_replicate_config, stream)
...
[
    {
        "id": "replicate",
        "execute-command": "/var/scripts/webhook-replicate.py",
