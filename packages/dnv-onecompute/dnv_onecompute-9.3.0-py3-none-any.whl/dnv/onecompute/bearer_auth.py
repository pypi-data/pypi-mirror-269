...
class BearerAuth(Auth):
    ...
    Attributes:
        _authenticator (IAuthenticator): The authenticator.
        _sync_lock (threading.Lock): Lock for synchronization in sync_auth_flow.
        _async_lock (asyncio.Lock): Lock for synchronization in async_auth_flow.
    """
