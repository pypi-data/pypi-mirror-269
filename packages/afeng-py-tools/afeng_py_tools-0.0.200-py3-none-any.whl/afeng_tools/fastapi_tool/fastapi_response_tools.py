...
def resp_template(request: Request, template_file: str, context_data: dict[str, Any], is_redirect: bool = False):
    """响应模板"""
    if is_redirect:
        return create_cache_template_response(request=request, template_file=template_file, context=context_data)
