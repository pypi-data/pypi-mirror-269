...
import sys
import numpy as np
from PyQt5.QtWidgets import (QComboBox, QMainWindow, QApplication, QPushButton,
...
def main():
    ...
    typeComb.currentIndexChanged.connect(
        lambda i: model.changeDatatype(typeComb.itemText(i)))
