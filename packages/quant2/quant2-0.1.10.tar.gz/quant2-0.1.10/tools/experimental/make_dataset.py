...
# 转换特征+拆分数据集+导出数据到文件
file = "runs/table20240419/samples.pkl"

date_min = "2023-01-01"
date_sep = "2024-01-01"
date_max = "2024-02-01"

name_suffix = "_train_2301_2312_2401_lb_10_label_whole_c20_maxabs_direct"

points = [i + 0.5 for i in range(60, 90)]
# points = None

preprocess_args = [[10], "label", True, 20, "maxabs", "direct"]
