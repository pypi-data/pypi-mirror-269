...
class TestDatasetPlugin(unittest.TestCase):
    ...
    @patch("requests.get")
    def test_query_endpoint_and_download_file_failure(self, mock_requests_get):
        # Arrange
    ...
    @patch("requests.get")
    def test_request_exception_query_endpoint(self, mock_requests_get):
        # Arrange
        dataset_plugin = DatasetPlugin()
        url = "http://dataset.com/dataset"
        bucket_name = "mlpipeline"
    ...
    @patch("cogflow.cogflow.dataset_plugin.DatasetPlugin.create_minio_client")
    def test_delete_from_minio_success(self, mock_create_minio_client):
        # Arrange
        dataset_plugin = DatasetPlugin()
    ...
    @patch("cogflow.cogflow.dataset_plugin.DatasetPlugin.create_minio_client")
    def test_delete_from_minio_object_not_found(self, mock_create_minio_client):
        # Arrange
        dataset_plugin = DatasetPlugin()
        object_name = "test_object"
        bucket_name = "test_bucket"
    ...
    @patch("cogflow.cogflow.dataset_plugin.DatasetPlugin.create_minio_client")
    def test_delete_from_minio_exception(self, mock_create_minio_client):
        # Arrange
        dataset_plugin = DatasetPlugin()
        object_name = "test_object"
        bucket_name = "test_bucket"
