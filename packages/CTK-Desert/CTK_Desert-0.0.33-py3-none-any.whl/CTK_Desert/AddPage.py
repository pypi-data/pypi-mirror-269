...
class Workspace(Page_BM):
    def __init__(self, window, THEFrame, parent):
        ...
        self.scrollableCB  =    self.c_wgts.section_unit(self.content_sec, title="Scrollable", widget="checkbutton", default=True)
    ...
    def create_page(self):
        ...
        if not (file_name == "" or self.icon_path == None):
            ...
            data = data.replace(r'"SCRL_VAL__"', self.scrollableCB.gval())
