...
class Workspace(Page_BM):
    def __init__(self, window, THEFrame, parent):
        ...
        self.parent_type   =    self.c_wgts.section_unit(self.content_sec, title="Parent Type", widget="combobox", values=["Panel Frame", "Section Frame"], )
        ...
        self.Reset.winfo_children()[-1].configure(height=50, font=(FONT_B, 17), fg_color = (hvr_clr_g(LIGHT_MODE["background"], "l", 50), hvr_clr_g(DARK_MODE["background"], "d", 50)))
