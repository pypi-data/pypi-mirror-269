...
def remove_none_by_dict(d: dict[str | None, list[str]]) -> dict[str, list[str]]: ...
def clean_dict(d: dict[str | None, list[str]]) -> dict[str, str]: ...
...
class LoadData:
    ...
    @property
    def data(self) -> None: ...
    def try_json(self) -> None: ...
    def try_str(self) -> None: ...
    def try_file(self) -> None: ...
