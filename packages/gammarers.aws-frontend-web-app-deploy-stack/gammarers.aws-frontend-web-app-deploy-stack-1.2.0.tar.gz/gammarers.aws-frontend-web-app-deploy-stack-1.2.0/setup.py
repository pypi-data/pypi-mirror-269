    ...
    """
{
    ...
    "license": "Apache-2.0",
    "url": "https://github.com/gammaresr/aws-frontend-web-app-deploy-stack.git",
    ...
    "project_urls": {
        "Source": "https://github.com/gammaresr/aws-frontend-web-app-deploy-stack.git"
    },
    "package_dir": {
        "": "src"
    },
    ...
    "package_data": {
        "gammarers.aws_frontend_web_app_deploy_stack._jsii": [
            "aws-frontend-web-app-deploy-stack@1.2.0.jsii.tgz"
        ],
        "gammarers.aws_frontend_web_app_deploy_stack": [
            "py.typed"
        ]
