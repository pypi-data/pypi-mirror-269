...
public:
    ...
    int ModuleBindFunction(AsdRtModule module, const char *funcName, AsdRtFunction func) override;
    int RegisterAllFunction(AsdRtModuleInfo *moduleInfo, void **handle) override;
    int FunctionLaunch(const AsdRtFunction func, const AsdRtKernelParam *param, AsdRtStream stream) override;
    ...
    int FunctionLaunchWithFlag(const AsdRtFunction func, const AsdRtKernelParam *param, AsdRtStream stream,
                               const RtTaskCfgInfoT *cfgInfo) override;
