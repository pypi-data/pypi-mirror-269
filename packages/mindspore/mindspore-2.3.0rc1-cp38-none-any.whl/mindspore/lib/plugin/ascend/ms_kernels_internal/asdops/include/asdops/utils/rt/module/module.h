...
int AsdRtModuleBindFunction(AsdRtModule module, const char *funcName, AsdRtFunction func);
int AstRtRegisterAllFunction(AsdRtModuleInfo *moduleInfo, void **handle);
int AsdRtFunctionLaunch(const AsdRtFunction func, const AsdRtKernelParam *launchParam, AsdRtStream stream);
...
int AsdRtFunctionLaunchWithFlag(const AsdRtFunction func, const AsdRtKernelParam *launchParam, AsdRtStream stream,
    const RtTaskCfgInfoT *cfgInfo);
}
#ifdef __cplusplus
}
