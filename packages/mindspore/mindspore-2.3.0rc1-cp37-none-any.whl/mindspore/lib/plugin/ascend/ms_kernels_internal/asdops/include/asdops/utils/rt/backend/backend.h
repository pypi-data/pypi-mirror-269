...
public:
    ...
    virtual int ModuleBindFunction(AsdRtModule module, const char *funcName, AsdRtFunction func) = 0;
    virtual int RegisterAllFunction(AsdRtModuleInfo *moduleInfo, void **handle) = 0;
    virtual int FunctionLaunch(const AsdRtFunction func, const AsdRtKernelParam *param, AsdRtStream stream) = 0;
    ...
    virtual int FunctionLaunchWithFlag(const AsdRtFunction func, const AsdRtKernelParam *param, AsdRtStream stream,
                                       const RtTaskCfgInfoT *cfgInfo) = 0;
