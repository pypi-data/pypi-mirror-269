...
Add the CC and TO fields to the mail.mail model and fill these fields automatically when receiving an email without res_partner model dependency.
...
The mail.mail model contains the new CC and TO fields for the model without res_partner model dependency.
