...
class Manager:
    ...
    def plot_signal_to_noise_tofolder(self, folder,embryo_name,one_stack_only=False,stack_chosen=0):
        """ Generate the plot of intensities means and std deviations in Raw Images in a specified folder

        :param folder: Folder to find raw data in
        :type folder: str
        :param embryo_name:
        :type embryo_name: str
        :param one_stack_only: Should we use only one stack in raw (Default value = False)
    ...
    def printEmbryoMetadata(self):
        """ Print all metadata contained in an embryo json metadata file """
        printMetadata("./")