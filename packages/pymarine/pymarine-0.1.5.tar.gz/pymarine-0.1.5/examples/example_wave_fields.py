...
fig, axis = wave1.plot_spectrum(
    add_limit_markers=True, add_hs_estimate=True, plot_title="Compare " "Spectra"
)
fig, axis = wave2.plot_spectrum(
    fig=fig,
    axis=axis,
    linecolor="r",
    linestyle="--",
    line_markers="v",
    y_n_points_label=0.7,
    markersize=10,
)
