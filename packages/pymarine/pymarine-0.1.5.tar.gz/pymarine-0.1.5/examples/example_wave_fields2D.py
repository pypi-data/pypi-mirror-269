...
for wave_construction, polar_projection in zip(
    ("DFTpolar", "DFTcartesian", "FFT"), (True, True, False)
):
    ...
    wave2D_1.plot_spectrum(
        plot_title=wave_construction,
