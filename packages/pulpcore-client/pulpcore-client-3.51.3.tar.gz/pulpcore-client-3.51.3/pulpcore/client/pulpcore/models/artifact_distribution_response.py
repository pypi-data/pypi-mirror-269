...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, base_url=None, base_path=None, hidden=False, content_guard=None, pulp_labels=None, name=None, pulp_created=None, pulp_last_updated=None, local_vars_configuration=None):  # noqa: E501
