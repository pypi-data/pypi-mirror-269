...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, content_guard=None, pulp_labels=None, pulp_href=None, hidden=False, name=None, pulp_last_updated=None, base_path=None, base_url=None, local_vars_configuration=None):  # noqa: E501
