...
from dl2050utils.db import row_to_rec, rec_to_row
...
class Auth():
    ...
    async def get_users(self, request):
        ...
        res = self.db.sync_query(f"""
            select *,users.org as org_id,orgs.name as org_name
            from users join orgs on users.org=orgs.id
            where users.id={}
        """)
