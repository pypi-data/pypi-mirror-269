...
## [api documentation here!](https://ultrafunkamsterdam.github.io/ramdriver)
...
* utility function to convert a running undetected_chromedriver.Chrome instance
  to a ramdriver.Browser instance and contintue from there
...
async def main():
    ...
    page3 = await browser.get('https://github.com/ultrafunkamsterdam/ramdriver', new_window=True)
