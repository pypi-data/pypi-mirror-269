...
args.model="/data/model/formal/llama-13b-tongcheng-v0.5_230926/"
...
args.max_num_batched_tokens=25600
...
openai_serving_chat = OpenAIServingChat(engine, args.model,
                                        args.response_role,
                                        args.chat_template)
openai_serving_completion = OpenAIServingCompletion(engine, args.model)
