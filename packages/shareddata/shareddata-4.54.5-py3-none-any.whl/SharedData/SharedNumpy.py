...
class SharedNumpy(np.ndarray):
    ...
    def subscribe(self, host, port, lookbacklines=1000, lookbackdate=None, method='websocket', snapshot=False, bandwidth=1e6):
        self.table.subscribe(host, port, lookbacklines,
                             lookbackdate, method, snapshot, bandwidth)
        
    def publish(self, host, port, lookbacklines=1000, lookbackdate=None, method='websocket', snapshot=False, bandwidth=1e6):
