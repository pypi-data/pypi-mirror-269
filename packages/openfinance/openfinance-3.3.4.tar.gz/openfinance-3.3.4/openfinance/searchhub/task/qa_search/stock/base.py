...
from openfinance.searchhub.task.qa_search.stock.prompt import FORMAT_INSTRUCTIONS, PREFIX, SUFFIX
from openfinance.searchhub.task.qa_search.stock.output_parser import StockOutputParser
from openfinance.searchhub.task.qa_search.stock import STOCK_FUNDAMENTAL
...
class StockInfoChain(IntentExecutor):
    ...
    """
    intent_name: str = list(STOCK_FUNDAMENTAL.keys())[0]
