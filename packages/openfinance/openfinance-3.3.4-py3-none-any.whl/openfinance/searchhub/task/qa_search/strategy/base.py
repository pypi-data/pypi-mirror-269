...
from openfinance.searchhub.task.qa_search.strategy.prompt import FORMAT_INSTRUCTIONS, PREFIX, SUFFIX
from openfinance.searchhub.task.qa_search.strategy.output_parser import StockOutputParser
from openfinance.searchhub.task.qa_search.strategy import STOCK_SELECT_STRATEGY
...
class StockStrategyAgent(Agent):
...
class StockStrategyChain(IntentExecutor):
    ...
    """
    intent_name: str = list(STOCK_SELECT_STRATEGY.keys())[0]
    ...
    def from_chains(
        ...
        """
        agent = StockStrategyAgent.from_llm_and_tools(llm, tools)
