...
class InlineResponse20044Response(object):
    ...
    swagger_types = {
        'message': 'str',
        'status': 'int',
        'user': 'InlineResponse20044ResponseUser'
    }
    ...
    @property
    def user(self):
        """Gets the user of this InlineResponse20044Response.  # noqa: E501


        :return: The user of this InlineResponse20044Response.  # noqa: E501
        :rtype: InlineResponse20044ResponseUser
        """
        return self._user

    @user.setter
    def user(self, user):
        """Sets the user of this InlineResponse20044Response.


        :param user: The user of this InlineResponse20044Response.  # noqa: E501
        :type: InlineResponse20044ResponseUser
        """
