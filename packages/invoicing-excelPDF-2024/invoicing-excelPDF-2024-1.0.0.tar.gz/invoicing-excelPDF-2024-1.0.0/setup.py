...
setup(
  name = 'invoicing-excelPDF-2024',         #* Your package will have this name
  ...
  author = 'Patrick Lacey',                   # Your name
  author_email = 'placeyapp@gmail.com',  # Your email
  url = 'https://example.com',              # Homepage of your library (e.g. github or your website)
  keywords = ['invoice', 'excel', 'pdf', 'PDF', 'excelPDF'],   # Keywords users can search on pypi.org
