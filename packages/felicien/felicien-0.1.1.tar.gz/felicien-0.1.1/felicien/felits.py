...
class FeliTS:
    ...
    def __init__(
        ...
        Args:
            ...
            values (pandas Series, optional): Values and their timestamp of
                the timeserie
                Example:
                2015-07-01 20:10:30.780999899    1.0
                2015-07-01 20:10:45.780999899    1.0
                2015-07-01 20:11:00.780999899    1.0
                dtype: float64
    ...
    def frequency(self) -> dt.timedelta:
        ...
        # results
        frequencies = self.data.index.floor("s").diff().value_counts()
    ...
    def as_prometheus(self) -> dict:
        ...
        result["values"] = self.data.to_list()
        result["timestamps"] = (
