'''
    ############################################################################
    ######################## Print Tricks & More - version 0.3.149a #############
    ############################################################################
...
TODO_QUICK = """
    ...
    - pt.easy_testing -     
        ...
        - Speed Issue: 
            - At some point, I noticed that I had a huge drawback in speed when using this so I suddenly
...
TODO_LONG_TERM = """
    ...
    - pt. cpu, ram, gpu profilers:
        (pc resources system resources processing power)
        Use psutil and GPUtil to check the cpu usage, memory (ram), and GPU usage of the running python app
        - see my file "test_millions_of_auras_memory.py" for how to implement these in a nicely
        formatted fashion
...
class pt:
    ...
    def easy_imports(source=''):
        ...
        if source in pt.easy_imports_sources:
            ...
            pt.easy_imports_sources.append(source)
        ...
        if gpus:
            for gpu in gpus:
                print(  f"   - GPU:"
                        ...
                        f"\n      Used GPU Memory: {gpu.memoryUsed:.0f}MB, "
                        f"\n      Free GPU Memory: {gpu.memoryFree:.0f}MB,"
                        f"\n      Total GPU Memory: {gpu.memoryTotal:.0f}MB")
        else:
            print("No GPU found.")
