...
class CalendarReader:
    ...
    def _get_day_cal(self, cal_date: datetime):
    ...
    def fill_prep(self, parsed_day: datetime = datetime.today()):
        ...
        for apt in relevant_apts:
            ...
            elif last_apt_end_time and free_slots[
                -1].end_datetime < apt.start_datetime and last_apt_end_time < apt.start_datetime:
    ...
    def wipe_prep(self, parsed_day: datetime = datetime.today()):
        ...
        try:
            ...
            # TODO: Fix the wiping logic so that Outlook never throws this
            pass
