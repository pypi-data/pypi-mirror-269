...
def calib_score(points, num_variables, intercept, calibracion='adm'):

    n = num_variables
    
    if calibracion == 'adm': pdo, odds, scorecard_points = 20, 1, 500
    elif calibracion == 'comp': pdo, odds, scorecard_points = 15, 15, 660
    else: raise Exception('WTF! Ese tipo de calibración no está contemplado!')
...
pvalues=False, ret_coefs=False, redondeo=True, logistic_method='newton', calibracion='adm'):
...
check_overfitting=True, logistic_method='newton', calibracion='adm'):
