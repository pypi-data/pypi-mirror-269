...
def get_trace_data(
    ...
    """
    Get the trace data from the trace_id
...
def get_ingestion_trace_events(
    take: int = 10,
    lastmile_api_token: Optional[str] = None,
    # TODO: Create macro for default timeout value
    timeout: int = 60,
    ...
    """
    Get the ingestion trace events. TODO: Add more filtering options
...
def get_latest_ingestion_trace_id(
    ...
    """
    ingestion_traces: dict[str, Any] = get_ingestion_trace_events(
