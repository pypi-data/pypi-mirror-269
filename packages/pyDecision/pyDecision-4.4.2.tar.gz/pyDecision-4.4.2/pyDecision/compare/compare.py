...
def compare_weigths(dataset, criterion_type, custom_methods = [], custom_weigths = [], methods_list = [], mic = [], lic = [], alpha = 0.5):
    if ('all' in methods_list):
        methods_list = ['bwm', 'bwm_s', 'cilos', 'critic', 'idocriw', 'entropy',  'merec']
