...
class V1GetLightningappSourceCodeDownloadUrlResponse(object):
    ...
    def __eq__(self, other: 'V1GetLightningappSourceCodeDownloadUrlResponse') -> bool:
        """Returns true if both objects are equal"""
        if not isinstance(other, V1GetLightningappSourceCodeDownloadUrlResponse):
            return False

        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'V1GetLightningappSourceCodeDownloadUrlResponse') -> bool:
