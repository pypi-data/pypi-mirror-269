...
_NOTE_NAMES = {'Cb': -1, 'C': 0, 'C#': 1, 'Db': 1, 'D': 2, 'D#': 3, 'Eb': 3,
               'E': 4, 'E#': 5, 'F': 5, 'F#': 6, 'Gb': 6, 'G': 7, 'G#': 8,
               'Ab': 8, 'A': 9, 'A#': 10, 'Bb': 10, 'B': 11, 'B#': 12}
_NOTE_INT_TO_NOTE_NAME_MAP_SHARPS = ('C', 'C#', 'D', 'D#', 'E', 'F',
                                     'F#', 'G', 'G#', 'A', 'A#', 'B')
_NOTE_INT_TO_NOTE_NAME_MAP_FLATS = ('C', 'Db', 'D', 'Eb', 'E', 'F',
                                    'Gb', 'G', 'Ab', 'A', 'Bb', 'B')
...
class NoteData:
    ...
    def __init__(self, int_or_name: Union[int, str], use_flats: bool = False):
        """
        Args:
