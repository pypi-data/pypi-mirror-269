...
class Msg:
    ...
    def __init__(self, type: str, source: Optional[Input] = None):
        """
        Args:
    ...
    def __repr__(self):
        return f'{self.__class__.__name__}{self.__as_tuple()}'
    ...
    def matches(self, *args_conditions, **kwargs_conditions) -> bool:
        ...
        """
        attr_conditions = dict(zip(self.__match_args__, args_conditions))
        ...
        for parameter, condition in attr_conditions.items():
            ...
            if (isinstance(condition, Container) and
                    not type(condition) is str and
                    attr in condition):
                continue
