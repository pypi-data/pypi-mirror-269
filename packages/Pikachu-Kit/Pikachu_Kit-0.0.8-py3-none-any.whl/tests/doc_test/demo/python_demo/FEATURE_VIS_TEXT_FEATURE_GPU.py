...
################################################################################
"""
Brief: FEATURE_VIS_TEXT_FEATURE_GPU.py Demo, 以及压测数据生成的DEMO
Author: wanglongchao(wanglongchao@baidu.com)
Date: 2022.4.11
Filename: FEATURE_VIS_TEXT_FEATURE_GPU.py
"""
...
def feature_calculate(input_data):
    ...
    info_texts.key = 'medical_title'
    info_texts.value = "中国人民一起加油"
    #info_texts = proto_data.info.texts.add()
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_TEXT_FEATURE_GPU',
