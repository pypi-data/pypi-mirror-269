...
################################################################################
"""
Brief: FEATURE_VIS_IMG_3DPHOTO_GPU_V5 Demo, 以及压测数据生成的DEMO
Author: chenjunru(chenjunru@baidu.com)
Date: 2024-03-14
Filename: FEATURE_VIS_IMG_3DPHOTO_GPU_V5.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_3DPHOTO_GPU_V5 demo
    """
    def prepare_request(self, data):
        ...
        """
        req_data = {
            'image_url': base64.b64encode(data['image_url']),
            'type_name': 'inpainting3d',
            'traj_type': 3, #[0,1,2,3,4,5,6]
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_3DPHOTO_GPU_V5',
    ...
    res_json = json.loads(base64.b64decode(result))
    video_data = base64.b64decode(res_json['video'])
    img_data = base64.b64decode(res_json['image'])
    # with open(os.path.join('res.gif'), 'wb') as f:
    #     f.write(video_data)
    # with open(os.path.join('res.jpg'), 'wb') as f:
    #     f.write(img_data)
...
if __name__ == '__main__':
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        #特征计算Demo
        feature_calculate('http://10.153.117.33:8999/1.png') #./image_dir/img_file 本地图片