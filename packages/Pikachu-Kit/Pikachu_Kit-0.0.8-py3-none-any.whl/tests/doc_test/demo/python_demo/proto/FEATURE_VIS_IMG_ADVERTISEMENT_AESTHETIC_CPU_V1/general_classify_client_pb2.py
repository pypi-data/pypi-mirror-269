...
_CLASSIFYRESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='isface', full_name='vis.generalclassifyclient.ClassifyResult.isface', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='isexam', full_name='vis.generalclassifyclient.ClassifyResult.isexam', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='class_name', full_name='vis.generalclassifyclient.ClassifyResult.class_name', index=9,
