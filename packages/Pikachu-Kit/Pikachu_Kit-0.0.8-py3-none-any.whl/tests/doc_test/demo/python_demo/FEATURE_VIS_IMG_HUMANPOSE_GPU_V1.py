...
################################################################################
"""
Brief:FEATURE_VIS_IMG_HUMANPOSE_GPU_V1 Demo, 以及压测数据生成的DEMO
Author: yangyongzhen(yangyongzhen@baidu.com)
Date: 2020-02-12
Filename: FEATURE_VIS_IMG_HUMANPOSE_GPU_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_HUMANPOSE_GPU_V1 demo
    """
    def prepare_request(self, data):
        ...
        return json.dumps({
                    ...
                    'cmdid': '123',
                    'clientip': '0.0.0.0',
                    'data': base64.b64encode(json.dumps(image_data)),
                })
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_HUMANPOSE_GPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_HUMANPOSE_GPU_V1.py
    生成压测数据：
        python FEATURE_VIS_IMG_HUMANPOSE_GPU_V1.py GEN_STRESS_DATA
    """
