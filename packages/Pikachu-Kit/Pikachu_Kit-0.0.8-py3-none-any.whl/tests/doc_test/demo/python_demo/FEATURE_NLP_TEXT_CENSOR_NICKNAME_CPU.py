...
################################################################################
"""
Brief:FEATURE_NLP_TEXT_CENSOR_NICKNAME_CPU Demo, 以及压测数据生成的DEMO
Author: wangzanbo(wangzanbo@baidu.com)
Date: 2022-06-29
Filename: FEATURE_NLP_TEXT_CENSOR_NICKNAME_CPU.py
"""
import json
import os
import random
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_NLP_TEXT_CENSOR_NICKNAME_CPU demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_NLP_TEXT_CENSOR_NICKNAME_CPU',
...
if __name__ == '__main__':
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        #特征计算Demo
        feature_calculate('95式铁血')  # "今天天气如何" 是本地测试数据
