...
@Date:   2020-03-12
@Filename: FEATURE_VIS_IMG_CARRECV8_GPU_V8.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_CARRECV8_GPU_V8 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_CARRECV8_GPU_V8_DAG',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_CARRECV8_GPU_V8.py
    生成压测数据：
        python FEATURE_VIS_IMG_CARRECV8_GPU_V8.py GEN_STRESS_DATA
    """
