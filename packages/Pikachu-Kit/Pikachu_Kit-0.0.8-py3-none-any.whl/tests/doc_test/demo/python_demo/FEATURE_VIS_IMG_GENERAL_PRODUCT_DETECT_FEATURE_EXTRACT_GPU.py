...
# -*- coding: utf-8 -*-
"""
Brief:FEATURE_VIS_IMG_GENERAL_PRODUCT_DETECT_FEATURE_EXTRACT_GPU Demo, 以及压测数据生成的DEMO
Author: weixiang01(weixiang01@baidu.com)
Date: 2022-05-12
Filename: FEATURE_VIS_IMG_GENERAL_PRODUCT_DETECT_FEATURE_EXTRACT_GPU.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_GENERAL_PRODUCT_DETECT_FEATURE_EXTRACT_GPU demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_GENERAL_PRODUCT_DETECT_FEATURE_EXTRACT_GPU',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_GENERAL_PRODUCT_DETECT_FEATURE_EXTRACT_GPU.py
    生成压测数据：
        python FEATURE_VIS_IMG_GENERAL_PRODUCT_DETECT_FEATURE_EXTRACT_GPU.py GEN_STRESS_DATA
    """
