...
################################################################################
"""
Brief:FEATURE_NLP_TEXT_CENSOR_GAME_CPU Demo, 以及压测数据生成的DEMO
Author: caoyuhui(caoyuhui@baidu.com)
Date: 2021-10-14
Filename: FEATURE_NLP_TEXT_CENSOR_GAME_CPU.py
"""
import json
import os
import random
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_NLP_TEXT_CENSOR_GAME_CPU demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_NLP_TEXT_CENSOR_GAME_CPU',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_NLP_TEXT_CENSOR_GAME_CPU.py
    生成压测数据：
        python FEATURE_NLP_TEXT_CENSOR_GAME_CPU.py GEN_STRESS_DATA
    """
