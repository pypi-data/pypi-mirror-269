...
"""
Brief: FEATURE_KG_IMG_AW_SERVER_CPU_V3 Demo, 以及压测数据生成的DEMO
Author: shengguangzhi(shengguangzhi@baidu.com)
Date: 2021-08-25
Filename: FEATURE_KG_IMG_AW_SERVER_CPU_V3.py
"""
...
class FeatureReq(XvisionDemo):
    """
        FEATURE_KG_IMG_AW_SERVER_CPU_V3 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_KG_IMG_AW_SERVER_CPU_V3',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_KG_IMG_AW_SERVER_CPU_V3.py
    生成压测数据：
        python FEATURE_KG_IMG_AW_SERVER_CPU_V3.py GEN_STRESS_DATA
    """
    op_type = sys.argv[1] if len(sys.argv) == 2 else 'FEATURE_CALCULATE'
    if op_type == 'GEN_STRESS_DATA':
        # 生成压测数据
        gen_stress_data('./text_dir/xvision_nangwang_aw_server_testcase.txt')
    else:
        # 一行数据Demo
        test_data = {"query": "新闻", "api_path": "/kg_recom/hot_trend/"}
