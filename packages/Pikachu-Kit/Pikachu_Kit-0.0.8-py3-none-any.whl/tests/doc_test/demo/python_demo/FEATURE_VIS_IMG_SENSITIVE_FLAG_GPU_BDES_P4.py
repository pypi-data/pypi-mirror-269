...
################################################################################
"""
Brief:FEATURE_VIS_IMG_SENSITIVE_FLAG_GPU_BDES_P4 Demo, 以及压测数据生成的DEMO
Author: gongzhenting@baidu.com
Date: 2022-02-11
Filename: FEATURE_VIS_IMG_SENSITIVE_FLAG_GPU_BDES_P4.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_SENSITIVE_FLAG_GPU_BDES_P4 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_SENSITIVE_FLAG_GPU_BDES_P4',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_SENSITIVE_FLAG_GPU_BDES_P4.py
    生成压测数据：
        python FEATURE_VIS_IMG_SENSITIVE_FLAG_GPU_BDES_P4.py GEN_STRESS_DATA
    """
