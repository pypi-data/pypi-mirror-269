...
################################################################################
"""
Brief:FEATURE_AR_IMG_MULTISTYLE_FACESKELETON_CPU_V1.py Demo, 以及压测数据生成的DEMO
Author: xieshuai(xieshuai@baidu.com)
Date: 2020-06-16
Filename: FEATURE_AR_IMG_MULTISTYLE_FACESKELETON_CPU_V1.py.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_AR_IMG_MULTISTYLE_FACESKELETON_CPU_V1.py demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_AR_IMG_MULTISTYLE_FACESKELETON_CPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_AR_IMG_MULTISTYLE_FACESKELETON_CPU_V1.py.py 
    生成压测数据：
        python FEATURE_AR_IMG_MULTISTYLE_FACESKELETON_CPU_V1.py.py GEN_STRESS_DATA
    """
