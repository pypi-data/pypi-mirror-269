...
@Date:   2020-03-20
@Filename: FEATURE_DE_IMG_LUTAOELEMENT_GPU.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_DE_IMG_LUTAOELEMENT_GPU demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_DE_IMG_LUTAOELEMENT_GPU',
...
if __name__ == '__main__':
    ...
    if op_type == 'GEN_STRESS_DATA':
        # 生成压测词表
        input_data = {
            'img': './image_dir/FEATURE_DE_IMG_LUTAOELEMENT_GPU/img/',
            'seg': './image_dir/FEATURE_DE_IMG_LUTAOELEMENT_GPU/seg/'
        }
        gen_stress_data(input_data)
    else:
        # 特征计算Demo
        input_data = {
            'img': './image_dir/FEATURE_DE_IMG_LUTAOELEMENT_GPU/img/img.jpg',
            'seg': './image_dir/FEATURE_DE_IMG_LUTAOELEMENT_GPU/seg/seg.jpg'
        }
