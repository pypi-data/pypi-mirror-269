...
################################################################################
"""
Brief:FEATURE_VIS_IMG_CARATTRIBUTE_GPU_V3 Demo, 以及压测数据生成的DEMO
Author: v_tanjinxiang(v_tanjinxiang@baidu.com)
Date: 2019-08-30
Filename: FEATURE_VIS_IMG_CARATTRIBUTE_GPU_V3.py
"""
import base64
import json
import os
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_CARATTRIBUTE_GPU_V3 demo
    """
    ...
    def prepare_request(self, data):
        ...
        base_data['type'] = 'vehicle_type,roof_rack'
        base_data['model_type'] = "1"
        return json.dumps({
            'appid': '1234567',
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_CARATTRIBUTE_GPU_V3',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_CARATTRIBUTE_GPU_V3.py
    生成压测数据：
        python FEATURE_VIS_IMG_CARATTRIBUTE_GPU_V3.py GEN_STRESS_DATA
    """
