...
"""
Brief: FEATURE_KG_TOPICEXTRA_GPU_V2 Demo, 以及压测数据生成的DEMO
Author: huangyanhui(huangyanhui@baidu.com)
Date: 2021-12-14
Filename: FEATURE_KG_TOPICEXTRA_GPU_V2.py
"""
...
class FeatureReq(XvisionDemo):
    """
        FEATURE_KG_TOPICEXTRA_GPU_V2 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_KG_TOPICEXTRA_GPU_V2',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_KG_TOPICEXTRA_GPU_V2.py
    生成压测数据：
        python FEATURE_KG_TOPICEXTRA_GPU_V2.py GEN_STRESS_DATA
    """
    op_type = sys.argv[1] if len(sys.argv) == 2 else 'FEATURE_CALCULATE'
    if op_type == 'GEN_STRESS_DATA':
        # 生成压测数据
        gen_stress_data('./text_dir/topicextra_testcase.mini.txt')
    else:
        # 文本主题生成Demo
        test_data = {
            "title": "测试数据"
