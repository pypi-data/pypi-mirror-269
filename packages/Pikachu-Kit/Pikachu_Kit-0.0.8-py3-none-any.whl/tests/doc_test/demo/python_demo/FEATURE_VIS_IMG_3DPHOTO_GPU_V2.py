...
################################################################################
"""
Brief: FEATURE_VIS_IMG_3DPHOTO_GPU_V2 Demo, 以及压测数据生成的DEMO
Author: yuanweihang(yuanweihang@baidu.com)
Date: 2022-11-09
Filename: FEATURE_VIS_IMG_3DPHOTO_GPU_V2.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_3DPHOTO_GPU_V2 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_3DPHOTO_GPU_V2',
    ...
    video = base64.b64decode(result['video'])
    score = result['score']
    file_name = os.path.basename(input_data)
    with open(os.path.join(file_name + '.avi'), 'wb') as f:
        f.write(video_data)
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_3DPHOTO_GPU_V2.py
    生成压测数据：
        python FEATURE_VIS_IMG_3DPHOTO_GPU_V2.py GEN_STRESS_DATA
    """
