...
@Author: yuanruiting
@Date:   2020-03-27
@Filename: FEATURE_VIS_IMG_DRIVER_GPU_V5.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_DRIVER_GPU_V5 demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_DRIVER_GPU_V5',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_DRIVER_GPU_V5.py 
    生成压测数据：
        python FEATURE_VIS_IMG_DRIVER_GPU_V5.py GEN_STRESS_DATA
    """
