...
################################################################################
"""
Brief:FEATURE_NLP_TEXT_CENSOR_ERNIE_TINY_GPU Demo, 以及压测数据生成的DEMO
Author: wangzanbo(wangzanbo@baidu.com)
Date: 2022-06-16
Filename: FEATURE_NLP_TEXT_CENSOR_ERNIE_TINY_GPU.py
"""
import json
import os
import random
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_NLP_TEXT_CENSOR_ERNIE_TINY_GPU demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_NLP_TEXT_CENSOR_ERNIE_TINY_GPU',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_NLP_TEXT_CENSOR_ERNIE_TINY_GPU.py
    生成压测数据：
        python FEATURE_NLP_TEXT_CENSOR_ERNIE_TINY_GPU.py GEN_STRESS_DATA
    """
