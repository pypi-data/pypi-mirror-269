...
################################################################################
"""
Brief:FEATURE_VIS_IMG_DISGUST_GPU_V2 Demo, 以及压测数据生成的DEMO
@Author: yuanruiting
@Date:   2020-03-19 14:26:40
@Filename: FEATURE_VIS_IMG_DISGUST_GPU_V2.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_DISGUST_GPU_V2 demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_DISGUST_GPU_V2',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_DISGUST_GPU_V2.py 
    生成压测数据：
        python FEATURE_VIS_IMG_DISGUST_GPU_V2.py GEN_STRESS_DATA
    """
