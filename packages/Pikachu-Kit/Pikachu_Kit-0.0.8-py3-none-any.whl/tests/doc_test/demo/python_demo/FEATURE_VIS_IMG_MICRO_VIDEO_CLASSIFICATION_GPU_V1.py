...
################################################################################
"""
Brief: FEATURE_VIS_IMG_MICRO_VIDEO_CLASSIFICATION_GPU_V1 Demo
Author: fumingxin(fumingxin@baidu.com)
Author update: zhouzhichao01(zhouzhichao01@baidu.com)
Date: 2020-06-15
Filename: FEATURE_VIS_IMG_MICRO_VIDEO_CLASSIFICATION_GPU_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_MICRO_VIDEO_CLASSIFICATION_GPU_V1 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_MICRO_VIDEO_CLASSIFICATION_GPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_MICRO_VIDEO_CLASSIFICATION_GPU_V1.py
    """
...
# python FEATURE_VIS_IMG_MICRO_VIDEO_CLASSIFICATION_GPU_V1.py GEN_STRESS_DATA
