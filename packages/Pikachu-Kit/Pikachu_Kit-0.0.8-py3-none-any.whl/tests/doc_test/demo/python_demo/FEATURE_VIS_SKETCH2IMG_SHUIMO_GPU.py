...
################################################################################
"""
Brief:FEATURE_VIS_SKETCH2IMG_SHUIMO_GPU Demo, 以及压测数据生成的DEMO
Author: liufanglong(liufanglong@baidu.com)
Date: 2023-07-26
Filename: FEATURE_VIS_SKETCH2IMG_SHUIMO_GPU.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_SKETCH2IMG_SHUIMO_GPU demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_SKETCH2IMG_SHUIMO_GPU',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_SKETCH2IMG_SHUIMO_GPU.py
    生成压测数据：
        python FEATURE_VIS_SKETCH2IMG_SHUIMO_GPU.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        # 特征计算Demo
        feature_calculate('./1.jpeg')  # ./image_dir/img_file 本地图片