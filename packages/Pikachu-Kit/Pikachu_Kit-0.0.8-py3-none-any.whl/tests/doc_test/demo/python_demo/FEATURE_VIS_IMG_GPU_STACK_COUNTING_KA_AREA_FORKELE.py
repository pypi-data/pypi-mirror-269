...
"""
Brief:FEATURE_VIS_IMG_GPU_STACK_COUNTING_KA_AREA_FORKELE Demo, 以及压测数据生成的DEMO
Author: anrongqiao (anrongqiao@baidu.com)
Date: 2021-03-03
Filename: FEATURE_VIS_IMG_GPU_STACK_COUNTING_KA_AREA_FORKELE.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_GPU_STACK_COUNTING_KA_AREA_FORKELE demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_GPU_STACK_COUNTING_KA_AREA_FORKELE',
    ...
    # res_json['features'][0]['fea_data'] need base64decode
    infos = base64.b64decode(res_json['features'][0]['fea_data'])  
    infos_json = json.loads(infos)
    print("detection result:", infos_json)
    return infos_json
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_GPU_STACK_COUNTING_KA_AREA_FORKELE.py 
    生成压测数据：
        python FEATURE_VIS_IMG_GPU_STACK_COUNTING_KA_AREA_FORKELE.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        #特征计算Demo
        feature_calculate('./image_dir/FEATURE_VIS_IMG_GPU_STACK_COUNTING_KA_AREA_FORKELE.jpg') #./image_dir/img_file 本地图片
