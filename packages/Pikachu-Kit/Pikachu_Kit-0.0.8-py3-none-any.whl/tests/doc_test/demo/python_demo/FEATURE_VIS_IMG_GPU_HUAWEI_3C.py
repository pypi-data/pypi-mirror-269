...
################################################################################
"""
Brief: FEATURE_VIS_IMG_GPU_HUAWEI_3C.py Demo, 以及压测数据生成的DEMO
Author: wanglongchao(wanglongchao@baidu.com)
Date: 2022.3.17
Filename: FEATURE_VIS_IMG_GPU_HUAWEI_3C.py
"""
...
import os
import random
from proto.FEATURE_VIS_IMG_GPU_HUAWEI_3C import imgfeature_pb2
from proto.FEATURE_VIS_IMG_GPU_HUAWEI_3C.protobuf_to_dict import protobuf_to_dict
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_GPU_HUAWEI_3C',
