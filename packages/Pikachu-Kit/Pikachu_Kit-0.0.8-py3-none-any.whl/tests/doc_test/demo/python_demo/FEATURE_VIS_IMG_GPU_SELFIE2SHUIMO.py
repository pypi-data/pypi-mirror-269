...
################################################################################
"""
Brief:FEATURE_VIS_IMG_GPU_SELFIE2SHUIMO Demo, 以及压测数据生成的DEMO
Author: lifu(lifu@baidu.com)
Date: 2020-05-26
Filename: FEATURE_VIS_IMG_GPU_SELFIE2SHUIMO.py 
"""
...
class FeatureReq(XvisionDemoEnc):
    """
    FEATURE_VIS_IMG_GPU_SELFIE2SHUIMO demo  
    """

    def prepare_request(self, data, index=1):
        """
        功能：构建算子的输入数据
        输入：
        ...
        new_data = {
            ...
            "type_name": "selfie2sketch",
            "back_index": str(index)
...
def feature_calculate(input_data):
    ...
    feature_data, meta = featureDemo.prepare_request(data, index)
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_GPU_SELFIE2SHUIMO',
...
def gen_stress_data(input_dir):
    ...
    for image_file in img_file_list:
        ...
        index = random.randint(1, 8)
        print featureDemo.prepare_request(data, index)  # 压测词表数据
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_GPU_SELFIE2SHUIMO.py 
    生成压测数据：
        python FEATURE_VIS_IMG_SELFIE2HADNDRAWING_GPU_V1.py GEN_STRESS_DATA
    """
