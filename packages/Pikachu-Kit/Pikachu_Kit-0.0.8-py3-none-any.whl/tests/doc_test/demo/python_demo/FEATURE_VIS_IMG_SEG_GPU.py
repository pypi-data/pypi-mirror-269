...
################################################################################
"""
Brief:FEATURE_VIS_IMG_SEG_GPU Demo, 以及压测数据生成的DEMO
Author: zhangjian52(zhangjian52@baidu.com)
Date: 2019-07-29
Filename: FEATURE_VIS_IMG_SEG_GPU.py 
"""
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_SEG_GPU',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_SEG_GPU.py 
    生成压测数据：
        python FEATURE_VIS_IMG_SEG_GPU.py GEN_STRESS_DATA
    """
