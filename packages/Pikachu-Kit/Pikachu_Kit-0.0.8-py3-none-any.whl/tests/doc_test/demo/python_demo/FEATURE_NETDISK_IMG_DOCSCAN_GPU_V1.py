...
class FeatureReq(XvisionDemo):
    """
    FEATURE_NETDISK_IMG_DOCSCAN_GPU_V1 demo  
    """
...
def feature_calculate(input_data, out_file):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_NETDISK_IMG_DOCSCAN_GPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_NETDISK_IMG_DOCSCAN_GPU_V1.py 
    生成压测数据：
        python FEATURE_NETDISK_IMG_DOCSCAN_GPU_V1.py GEN_STRESS_DATA
    """
