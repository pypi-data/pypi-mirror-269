...
################################################################################
"""
Brief:FEATURE_IMG_DECT_SEAL_GPU_V1 Demo, 以及压测数据生成的DEMO
Author: wuyongjun01(wuyongjun01@baidu.com)
Date: 2019-10-18
Filename: FEATURE_IMG_DECT_SEAL_GPU_V1.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_IMG_DECT_SEAL_GPU_V1 demo  
    """
    def prepare_request(self, data):
        ...
        return json.dumps({
                    ...
                    'cmdid': '123',
                    'clientip': '0.0.0.0',
                    'data': base64.b64encode("object_type=dect_seal&image=" + base64.b64encode(data['image'])),
                })
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_IMG_DECT_SEAL_GPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_IMG_DECT_SEAL_GPU_V1.py 
    生成压测数据：
        python FEATURE_IMG_DECT_SEAL_GPU_V1.py GEN_STRESS_DATA
    """
