...
################################################################################
"""
Brief:FEATURE_NLP_TEXT_CTINKER_CPU_V02 Demo, 以及压测数据生成的DEMO
Author: mayun03(mayun03@baidu.com)
Date: 2022-03-24
Filename: FEATURE_NLP_TEXT_CTINKER_CPU_V02.py
"""
import json
import os
import random
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_NLP_TEXT_CTINKER_CPU_V02 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_NLP_TEXT_CTINKER_CPU_V02',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_NLP_TEXT_CTINKER_CPU_V02.py
    生成压测数据：
        python FEATURE_NLP_TEXT_CTINKER_CPU_V02.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        #特征计算Demo
        sample = "同时，大力推行一线工作法，该县医疗保障系统的工作人员，每天早晨7点出发，晚上8点回家，一天行程260公里，短短两个星期就把全县20各乡镇走访了两遍。"
