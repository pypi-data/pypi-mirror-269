...
################################################################################
"""
Brief:FEATURE_VIS_IMG_SENSITIVEFLAG_NOSEARCH_GPU Demo, 以及压测数据生成的DEMO
Author: zhouzhichao01@baidu.com
Date: 2021-12-27
Filename: FEATURE_VIS_IMG_SENSITIVEFLAG_NOSEARCH_GPU.py1
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_SENSITIVEFLAG_NOSEARCH_GPU demo
    """
    ...
    def prepare_request(self, data):
        ...
        new_data = {
            ...
            "extra_info": json.dumps({"featureids":"sensitiveflag"}),
        }
        return json.dumps({
            'appid': '123456',
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_SENSITIVEFLAG_NOSEARCH_GPU',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_SENSITIVEFLAG_NOSEARCH_GPU.py
    生成压测数据：
        python FEATURE_VIS_IMG_SENSITIVEFLAG_NOSEARCH_GPU.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        feature_calculate('./image_dir/winnie.jpg')  # ./image_dir/img_file 本地图片
