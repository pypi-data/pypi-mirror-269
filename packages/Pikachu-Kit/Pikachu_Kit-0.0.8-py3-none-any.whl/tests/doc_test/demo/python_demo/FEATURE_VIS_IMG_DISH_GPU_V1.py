...
################################################################################
"""
Brief:FEATURE_VIS_IMG_DISH_GPU_V1 Demo, 以及压测数据生成的DEMO
Author: yexiang02(yexiang02@baidu.com)
Date: 2019-08-22
Filename: FEATURE_VIS_IMG_DISH_GPU_V1.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_DISH_GPU_V1 demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_DISH_GPU_V1',
