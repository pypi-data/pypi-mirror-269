...
################################################################################
"""
Brief:FEATURE_NLP_TEXT_CENSOR_CPU_MEITUAN Demo, 以及压测数据生成的DEMO
Author: wangzanbo(wangzanbo@baidu.com)
Date: 2023-2-27
Filename: FEATURE_NLP_TEXT_CENSOR_CPU_MEITUAN.py
"""
import json
import os
import random
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_NLP_TEXT_CENSOR_CPU_MEITUAN demo
    """
    ...
    def prepare_request(self, data):
        ...
        json_data = {
            ...
            "config": {
                "labels": ["1", "2", "3", "4", "5", "6"],
                #"sub_labels":{"4": ["1", "2"]},
                "versions": {"2": "0", "3": "0", "5": "0"},
                "new_sub_labels": {"7":["1", "2"], "4":["1", "2", "3", "4", "5", "6"]}
            }
        }
        request_data = {
            "appid": "123456",
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_NLP_TEXT_CENSOR_CPU_MEITUAN',
...
if __name__ == '__main__':
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        #特征计算Demo
        feature_calculate('test')  # "今天天气如何" 是本地测试数据
