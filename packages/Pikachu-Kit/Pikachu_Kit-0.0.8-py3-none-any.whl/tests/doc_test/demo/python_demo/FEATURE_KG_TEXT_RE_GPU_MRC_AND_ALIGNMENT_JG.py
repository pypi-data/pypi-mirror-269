...
"""
Author: liujian23@baidu.com
message: FEATURE_KG_TEXT_RE_GPU_MRC_AND_ALIGNMENT_JG Demo, 以及用于压测数据生成的DEMO
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_KG_TEXT_RE_GPU_MRC_AND_ALIGNMENT_JG demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_KG_TEXT_RE_GPU_MRC_AND_ALIGNMENT_JG',
...
if __name__ == '__main__':
    ...
    input = {
                "texts": [
                    {"text": "金镕范(김용범，1902年－1947年)，朝鲜政治家，国内派人，也是朝鲜劳动党的创立人之一。"},
                    {"text": "俄军升级R-27空空导弹 苏35装备后能打五代机"}
                ],
                "config": {
                    "model_name": "mrc_and_alignment_model",
                    "domain": "JG"
                }
            }
