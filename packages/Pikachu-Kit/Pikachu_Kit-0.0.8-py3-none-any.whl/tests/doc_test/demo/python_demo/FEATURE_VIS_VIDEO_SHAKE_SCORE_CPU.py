...
################################################################################
"""
Brief: FEATURE_VIS_VIDEO_SHAKE_SCORE_CPU Demo
Filename: FEATURE_VIS_VIDEO_SHAKE_SCORE_CPU.py
"""
...
class FeatureVisVideoShakeScoreCPU(XvisionDemo):
    """
    FEATURE_VIS_VIDEO_SHAKE_SCORE_CPU Demo
    """
...
def feature_calculate():
    ...
    url_type = 'file'
    featureDemo = FeatureVisVideoShakeScoreCPU()
    # 生成算子输入
    data = {
        'video_url': input_url,
        'url_type': url_type,
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_VIDEO_SHAKE_SCORE_CPU',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行:
        python FEATURE_VIS_VIDEO_SHAKE_SCORE_CPU.py
    生成压测数据：
        python FEATURE_VIS_VIDEO_SHAKE_SCORE_CPU.py GEN_STRESS_DATA
    """
