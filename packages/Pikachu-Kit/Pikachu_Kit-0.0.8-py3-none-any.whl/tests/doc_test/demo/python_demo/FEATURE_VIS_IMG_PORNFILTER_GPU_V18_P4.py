...
################################################################################
"""
Brief:FEATURE_VIS_IMG_PORNFILTER_GPU_V18_A10 Demo, 以及压测数据生成的DEMO
Author: zhouzhichao01@baidu.com
Date: 2021-11-18
Filename: FEATURE_VIS_IMG_PORNFILTER_GPU_V18_A10.py1
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_PORNFILTER_GPU_V18_A10 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_PORNFILTER_GPU_V18_A10',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_PORNFILTER_GPU_V18_A10.py
    生成压测数据：
        python FEATURE_VIS_IMG_PORNFILTER_GPU_V18_A10.py GEN_STRESS_DATA
    """
