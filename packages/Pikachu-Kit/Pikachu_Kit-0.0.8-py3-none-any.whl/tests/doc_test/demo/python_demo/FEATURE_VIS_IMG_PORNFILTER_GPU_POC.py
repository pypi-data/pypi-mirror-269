...
################################################################################
"""
Brief:FEATURE_VIS_IMG_PORNFILTER_GPU_POC Demo, 以及压测数据生成的DEMO
Author: Wu Yongjun01(wuyongjun01@baidu.com)
Date: 2020-03-10
Filename: FEATURE_VIS_IMG_PORNFILTER_GPU_POC.py
"""
...
from proto.FEATURE_VIS_IMG_PORNFILTER_GPU_POC import general_classify_client_pb2
from proto.FEATURE_VIS_IMG_PORNFILTER_GPU_POC.protobuf_to_dict import protobuf_to_dict


class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_PORNFILTER_GPU_POC demo
    """
	...
	# 20分类：0 一般色情、1卡通色情、2SM、3艺术品色情、4儿童裸露、5低俗、6性玩具 、7一般女性性感、8卡通女性性感、9男性性感、10男性裸露、11一般亲密行为、12卡通亲密行为、13特殊、14一般正常、15卡通正常、16臀部特写、17裆部特写、18脚部特写、19孕肚裸露
        ...
        classifytype1.type_name = 'antiporn_20class_poc'
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_PORNFILTER_GPU_POC',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_PORNFILTER_GPU_POC.py
    生成压测数据：
        python FEATURE_VIS_IMG_PORNFILTER_GPU_POC.py GEN_STRESS_DATA
    """
