...
class FeatureReq(XvisionDemo):
    """
    FEATURE_NETDISK_IMG_DOCDEWATERMARK_GPU_V1_A30 demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_NETDISK_IMG_DOCDEWATERMARK_GPU_V1_A30',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_NETDISK_IMG_DOCDEWATERMARK_GPU_V1_A30.py 
    生成压测数据：
        python FEATURE_NETDISK_IMG_DOCDEWATERMARK_GPU_V1_A30.py GEN_STRESS_DATA
    """
