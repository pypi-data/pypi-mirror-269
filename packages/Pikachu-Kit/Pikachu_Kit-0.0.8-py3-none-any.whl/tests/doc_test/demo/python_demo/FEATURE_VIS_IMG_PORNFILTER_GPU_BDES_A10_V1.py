...
################################################################################
"""
Brief:FEATURE_VIS_IMG_PORNFILTER_GPU_BDES_A10_V1 Demo, 以及压测数据生成的DEMO
Author: Zhou Zhichao01(zhouzhichao01@baidu.com)
Date: 2021-12-20
Filename: FEATURE_VIS_IMG_PORNFILTER_GPU_BDES_A10_V1.py
"""
...
from proto.FEATURE_VIS_IMG_PORNFILTER_GPU_BDES_A10_V1 import general_classify_client_pb2
from proto.FEATURE_VIS_IMG_PORNFILTER_GPU_BDES_A10_V1.protobuf_to_dict import protobuf_to_dict


class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_PORNFILTER_GPU_BDES_A10_V1 demo
    """
    def prepare_request(self, imgData):
        ...
        # 3分类antiporn、 6分类接口antiporn_6class和、11分类接口antiporn_11class、16分类接口antiporn_16class,  20分类接口antiporn_20class(为本次新增）
    	# 对应分类的具体标签如下：
	# 3分类：0色情、1性感、2正常
	...
	# 20分类：0 一般色情、1卡通色情、2SM、3艺术品色情、4儿童裸露、5低俗、6性玩具 、7一般女性性感、8卡通女性性感、9男性性感、10男性裸露、11一般亲密行为、12卡通亲密行为、13特殊、14一般正常、15卡通正常、16臀部特写、17裆部特写、18脚部特写、19孕肚裸露
        ...
        classifytype1.type_name = 'antiporn_16class'
        classifytype1.enable_remove_border = 1
        classifytype1.enable_edge_detection = 0
        classifytype1.enable_retrieve = 0
        classifytype1.enable_feature = 0
        classifytype1.enable_retry = 0
        classifytype1.retry_times = 3
        classifytype1.retry_ratio = 0.6
        classifytype1.enable_heatmap = 0
        classifytype1.enable_split_abnormal = 1
...
def feature_calculate(input_data):
    ...
    job_name = "STRESSJOBFEATURE_VIS_IMG_PORNFILTER_GPU_BDES_A10_V1"  # 申请的作业名
    token = "ea2baa0e-7b2f-54c8-927a-bf51d951ba39"  # 作业的token
    headers = {
        'Content-Type': 'application/json; charset=UTF-8',
        'resource_key': 'test.jpg',
        'auth_key': token,
        'business_name': job_name,
        'feature_name': 'FEATURE_VIS_IMG_PORNFILTER_GPU_BDES_A10_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_PORNFILTER_GPU_BDES_A10_V1.py
    生成压测数据：
        python FEATURE_VIS_IMG_PORNFILTER_GPU_BDES_A10_V1.py GEN_STRESS_DATA
    """
