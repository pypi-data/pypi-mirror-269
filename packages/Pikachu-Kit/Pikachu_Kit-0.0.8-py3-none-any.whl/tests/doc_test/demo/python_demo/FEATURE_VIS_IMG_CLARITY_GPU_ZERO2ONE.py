...
################################################################################
"""
Brief:FEATURE_VIS_IMG_CLARITY_GPU_ZERO2ONE Demo, 以及压测数据生成的DEMO
Author: wuyongjun01(wuyongjun01@baidu.com)
Date: 2019-11-22
Filename: FEATURE_VIS_IMG_CLARITY_GPU_ZERO2ONE.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_CLARITY_GPU_ZERO2ONE demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_CLARITY_GPU_ZERO2ONE',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_CLARITY_GPU_ZERO2ONE.py 
    生成压测数据：
        python FEATURE_VIS_IMG_CLARITY_GPU_ZERO2ONE.py GEN_STRESS_DATA
    """
