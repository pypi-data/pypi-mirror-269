...
Author: yaohai
Date: 2022-04-08
Description: 网盘去摩尔纹GPU版, 无bdes加解密
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_NETDISK_IMG_DEMOIRE_GPU_V2 demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_NETDISK_IMG_DEMOIRE_GPU_V2',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_NETDISK_IMG_DEMOIRE_GPU_V2.py 
    生成压测数据：
        python FEATURE_NETDISK_IMG_DEMOIRE_GPU_V2.py GEN_STRESS_DATA
    """
