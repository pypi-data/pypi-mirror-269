...
################################################################################
"""
Brief:FEATURE_VIS_IMAGE_WATERCOLORPORTRAIT_GPU_V1 Demo, 以及压测数据生成的DEMO
Author: lifu(lifu@baidu.com)
Date: 2020-05-26
Filename: FEATURE_VIS_IMAGE_WATERCOLORPORTRAIT_GPU_V1.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMAGE_WATERCOLORPORTRAIT_GPU_V1 demo  
    """
    def prepare_request(self, data):
        ...
        输出：
            返回算子的输入数据
        """
        #type_name  string  请求类型： "selfie2watercolor"

        new_data = {
            "image": base64.b64encode(data['image']),
            "type": "selfie2watercolorportrait"
        }
        return json.dumps({
                    'appid': '123456',
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMAGE_WATERCOLORPORTRAIT_GPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMAGE_WATERCOLORPORTRAIT_GPU_V1.py 
    生成压测数据：
        python FEATURE_VIS_IMAGE_WATERCOLORPORTRAIT_GPU_V1.py GEN_STRESS_DATA
    """
