...
################################################################################
"""
Brief:FEATURE_IMG_OCR_GPU_GENERAL_V6_NEW_ARCH_R200 Demo, 以及压测数据生成的DEMO
Author: wanghua11(wanghua11@baidu.com)
Date: 2019-11-22
Filename: FEATURE_IMG_OCR_GPU_GENERAL_V6_NEW_ARCH_R200.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_IMG_OCR_GPU_GENERAL_V6_NEW_ARCH_R200 demo  
    """
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_IMG_OCR_GPU_GENERAL_V6_NEW_ARCH_R200.py 
    生成压测数据：
        python FEATURE_IMG_OCR_GPU_GENERAL_V6_NEW_ARCH_R200.py GEN_STRESS_DATA
    """
