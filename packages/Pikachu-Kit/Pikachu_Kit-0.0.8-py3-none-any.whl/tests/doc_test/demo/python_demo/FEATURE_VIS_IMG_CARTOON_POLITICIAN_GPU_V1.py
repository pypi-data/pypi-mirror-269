...
################################################################################
"""
Brief:FEATURE_VIS_IMG_CARTOON_POLITICIAN_GPU_V1 Demo, 以及压测数据生成的DEMO
Author: gongzhenting@baidu.com
Date: 2022-01-25
Filename: FEATURE_VIS_IMG_CARTOON_POLITICIAN_GPU_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_CARTOON_POLITICIAN_GPU_V1 demo
    """
    ...
    def prepare_request(self, data):
        ...
        new_data = {
            ...
            "extra_info": json.dumps({"featureids":"cartoon_politician"}),
        }
        return json.dumps({
            'appid': '123456',
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_CARTOON_POLITICIAN_GPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_CARTOON_POLITICIAN_GPU_V1.py
    生成压测数据：
        python FEATURE_VIS_IMG_CARTOON_POLITICIAN_GPU_V1.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        # 特征计算Demo
        feature_calculate('./image_dir/cartoon-politicican-test1.jpg')  # ./image_dir/img_file 本地图片
