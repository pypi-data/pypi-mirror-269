...
@Author: yejin03
@Date:   2022-01-24
@Filename: FEATURE_VIS_IMG_DHWIDTHDET_GPU_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_DHWIDTHDET_GPU_V1 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'auth_key': 'bc6da47a-277c-5d9b-8365-b9f55dfa74b8',
        'business_name': 'STRESSJOBFEATURE_VIS_IMG_DHWIDTHDET_GPU_V1',
        'feature_name': 'FEATURE_VIS_IMG_DHWIDTHDET_GPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_DHWIDTHDET_GPU_V1.py
    生成压测数据：
        python FEATURE_VIS_IMG_DHWIDTHDET_GPU_V1.py GEN_STRESS_DATA
    """
