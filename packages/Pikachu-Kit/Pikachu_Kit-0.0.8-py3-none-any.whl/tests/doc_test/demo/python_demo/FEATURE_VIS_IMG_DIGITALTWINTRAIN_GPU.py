...
################################################################################
"""
Brief:FEATURE_VIS_IMG_DIGITALTWINTRAIN_GPU Demo, 以及压测数据生成的DEMO
Author: wanghui48(wanghui48@baidu.com)
Date: 2023-10-25
Filename: FEATURE_VIS_IMG_DIGITALTWINTRAIN_GPU.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_DIGITALTWINTRAIN_GPU demo  
    """
...
def feature_calculate(input_data):
    ...
    job_name = ""  # 申请的作业名
    token = ""  # 作业的token
    feature_name = 'FEATURE_VIS_IMG_DIGITALTWINTRAIN_GPU'
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_DIGITALTWINTRAIN_GPU.py 
    """
