...
@Date:   2020-03-13
@Filename: FEATURE_ACG_AUDIO_GENDER_CPU_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_ACG_AUDIO_GENDER_CPU_V1 demo
    """
    def prepare_request(self, data):
        ...
        req_data = {
            ...
            "audio_data": base64.b64encode(data['audio']),
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_ACG_AUDIO_GENDER_CPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_ACG_AUDIO_GENDER_CPU_V1.py
    生成压测数据：
        python FEATURE_ACG_AUDIO_GENDER_CPU_V1.py GEN_STRESS_DATA
    """
