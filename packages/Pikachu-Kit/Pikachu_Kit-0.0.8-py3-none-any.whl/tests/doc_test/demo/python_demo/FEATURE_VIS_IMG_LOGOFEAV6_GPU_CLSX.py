...
################################################################################
"""
Brief:STRESSJOBFEATURE_VIS_IMG_LOGOFEAV6_GPU_CLSX Demo, 以及压测数据生成的DEMO
Author: Wang Hui(wanghui48@baidu.com)
Date: 2022-06-29
Filename: STRESSJOBFEATURE_VIS_IMG_LOGOFEAV6_GPU_CLSX.py
"""
...
class FeatureReq(XvisionDemo):
    """
    STRESSJOBFEATURE_VIS_IMG_LOGOFEAV6_GPU_CLSX demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_LOGOFEAV6_GPU_CLSX',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python STRESSJOBFEATURE_VIS_IMG_LOGOFEAV6_GPU_CLSX.py
    生成压测数据：
        python STRESSJOBFEATURE_VIS_IMG_LOGOFEAV6_GPU_CLSX.py GEN_STRESS_DATA
    """
