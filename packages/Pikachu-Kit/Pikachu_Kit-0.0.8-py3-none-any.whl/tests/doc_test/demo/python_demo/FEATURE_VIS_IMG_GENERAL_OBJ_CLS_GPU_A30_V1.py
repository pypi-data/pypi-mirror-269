...
################################################################################
"""
Brief:FEATURE_VIS_IMG_GENERAL_OBJ_CLS_GPU_A30_V1 Demo, 以及压测数据生成的DEMO
Author: wanghui48@baidu.com
Date: 2022-09-6
Filename: FEATURE_VIS_IMG_GENERAL_OBJ_CLS_GPU_A30_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_GENERAL_OBJ_CLS_GPU_A30_V1 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_GENERAL_OBJ_CLS_GPU_A30_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_GENERAL_OBJ_CLS_GPU_A30_V1.py
    生成压测数据：
        python FEATURE_VIS_IMG_GENERAL_OBJ_CLS_GPU_A30_V1.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        feature_calculate('./image_dir/FEATURE_VIS_IMG_SEMANTICS_DIVISION_GPU_T4_V1.jpg')