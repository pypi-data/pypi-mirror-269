...
################################################################################
"""
Brief:FEATURE_VIS_IMG_MAPRECO_GPU_V1 Demo, 以及压测数据生成的DEMO
Author: wujiang01(wujiang01@baidu.com)
Date: 2020-02-10
Filename: FEATURE_VIS_IMG_MAPRECO_GPU_V1.py 
"""
from xvision_demo import XvisionDemo
from proto.FEATURE_VIS_IMG_MAPRECO_GPU_V1 import imgfeature_pb2
from proto.FEATURE_VIS_IMG_MAPRECO_GPU_V1.protobuf_to_dict import protobuf_to_dict
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_MAPRECO_GPU_V1 demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_MAPRECO_GPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_MAPRECO_GPU_V1.py 
    生成压测数据：
        python FEATURE_VIS_IMG_MAPRECO_GPU_V1.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        # 特征计算Demo
        feature_calculate('./image_dir/FEATURE_VIS_IMG_MAPRECO_GPU_V1.jpg')  # ./image_dir/img_file 本地图片
