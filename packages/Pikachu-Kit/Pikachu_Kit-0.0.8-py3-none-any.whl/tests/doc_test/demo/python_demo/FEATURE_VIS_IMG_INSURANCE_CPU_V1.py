...
################################################################################
"""
Brief:FEATURE_VIS_IMG_INSURANCE_CPU_V1 Demo, 以及压测数据生成的DEMO
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_INSURANCE_CPU_V1 demo  
    """
    def prepare_request(self, data):
        ...
        return json.dumps({
                    ...
                    'cmdid': '123',
                    'clientip': '0.0.0.0',
                    'data': base64.b64encode("object_type=kv&image=" + base64.b64encode(data['image'])),
                })
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_INSURANCE_CPU_V1',
