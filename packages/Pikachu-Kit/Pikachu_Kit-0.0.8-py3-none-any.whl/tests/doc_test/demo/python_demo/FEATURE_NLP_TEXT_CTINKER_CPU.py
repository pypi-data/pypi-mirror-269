...
################################################################################
"""
Brief:FEATURE_NLP_TEXT_CTINKER_CPU Demo, 以及压测数据生成的DEMO
Author: v_zhouxuhui(v_zhouxuhui@baidu.com)
Date: 2022-01-11
Filename: FEATURE_NLP_TEXT_CTINKER_CPU.py
"""
import json
import os
import random
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_NLP_TEXT_CTINKER_CPU demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_NLP_TEXT_CTINKER_CPU',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_NLP_TEXT_CTINKER_CPU.py
    生成压测数据：
        python FEATURE_NLP_TEXT_CTINKER_CPU.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        #特征计算Demo
        feature_calculate('习近萍副主席')  #本地测试数据