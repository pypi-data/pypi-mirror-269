...
################################################################################
"""
Brief:FEATURE_VIS_IMG_HUMANDET_GPU_V2 Demo, 以及压测数据生成的DEMO
Author: wangha11(wanghua11@baidu.com)
Date: 2019-12-12
Filename: FEATURE_VIS_IMG_HUMANDET_GPU_V2.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_HUMANDET_GPU_V2 demo  
    """
    def prepare_request(self, data):
        ...
        new_data = {
            ...
            "return_crop": 0 #是否将检测到的行人crop出图片返回，0或1(0表示false，1表示true)
        }
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_HUMANDET_GPU_V2',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_HUMANDET_GPU_V2.py 
    生成压测数据：
        python FEATURE_VIS_IMG_HUMANDET_GPU_V2.py GEN_STRESS_DATA
    """
