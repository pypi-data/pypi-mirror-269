...
################################################################################
"""
Brief:FEATURE_AR_IMG_VPAS_GPU_A10_BJXY Demo, 以及压测数据生成的DEMO
Author: zhengxuexing(zhengxuexing@baidu.com)
Date: 2021-08-24
Filename: FEATURE_AR_IMG_VPAS_GPU_A10_BJXY.py 
"""
import os
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_AR_IMG_VPAS_GPU_A10_BJXY demo
    """
...
def trackframe(input_data):
    ...
    job_name = "STRESSJOBFEATURE_AR_IMG_VPAS_GPU_A10_BJXY"  # 申请的作业名
    token = "9ac5e66f-4dbb-52bb-89d2-384b8707713a"  # 作业的token
    headers = {
        'Content-Type': 'application/json; charset=UTF-8',
        'resource_key': 'test.jpg',
        'auth_key': token,
        'business_name': job_name,
        'feature_name': 'FEATURE_AR_IMG_VPAS_GPU_A10_BJXY',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_AR_IMG_VPAS_GPU_A10_BJXY.py
    生成压测数据：
        python FEATURE_AR_IMG_VPAS_GPU_A10_BJXY.py GEN_STRESS_DATA
    """
