...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_GPU_PRODUCT_FEATURE_EXTRACT demo  
    """
    def prepare_request(self, data):
        ...
        info_texts.value = 'res101_nas_126w_320_int8_char'
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_GPU_PRODUCT_FEATURE_EXTRACT',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_GPU_PRODUCT_FEATURE_EXTRACT.py 
    生成压测数据：
        python FEATURE_VIS_IMG_GPU_PRODUCT_FEATURE_EXTRACT.py GEN_STRESS_DATA
    """
