...
"""
Brief: FEATURE_KG_TOPICEXTRA_GPU_V1 Demo, 以及压测数据生成的DEMO
Author: huangyanhui(huangyanhui@baidu.com)
Date: 2021-12-14
Filename: FEATURE_KG_TOPICEXTRA_GPU_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
        FEATURE_KG_TOPICEXTRA_GPU_V1 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_KG_TOPICEXTRA_GPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_KG_TOPICEXTRA_GPU_V1.py
    生成压测数据：
        python FEATURE_KG_TOPICEXTRA_GPU_V1.py GEN_STRESS_DATA
    """
