...
message: FEATURE_KG_NER_FLAT_MRC_NANWANG Demo, 以及压测数据生成的DEMO
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_KG_NER_FLAT_MRC_NANWANG demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_KG_NER_FLAT_MRC_NANWANG',
...
if __name__ == '__main__':
    ...
    input = {
                "data": ["F.1 油浸式平波电抗器用组合换位导线主要技术参数及适用范围", 
                         "1中填写对地电容pF39直流偏磁耐受能力直流偏磁耐受值(折算至网侧)单相长期承受10A投标人填写单相3小时承受12A投标人填写40接口要求换流变压器阀侧套管与阀厅的连接方式/在表", 
                         "表E.2 电抗器用组合导线主要技术参数及适用范围"], 
