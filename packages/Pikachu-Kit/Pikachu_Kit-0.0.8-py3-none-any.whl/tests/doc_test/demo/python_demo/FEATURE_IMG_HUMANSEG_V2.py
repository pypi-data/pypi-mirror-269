...
@Filename: FEATURE_IMG_HUMANSEG_V2.py
"""
...
from proto.FEATURE_IMG_HUMANSEG_V2 import parseservice_pb2
from proto.protobuf_to_dict import protobuf_to_dict


class FeatureReq(XvisionDemo):
    """
    FEATURE_IMG_HUMANSEG_V2 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_IMG_HUMANSEG_V2',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_IMG_HUMANSEG_V2.py
    生成压测数据：
        python FEATURE_IMG_HUMANSEG_V2.py GEN_STRESS_DATA
    """
