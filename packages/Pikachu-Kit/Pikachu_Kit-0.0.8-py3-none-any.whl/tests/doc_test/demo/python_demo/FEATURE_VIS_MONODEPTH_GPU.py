...
@Author: yuanruiting
@Date:   2020-03-27
@Filename: FEATURE_VIS_MONODEPTH_GPU.py
"""
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_MONODEPTH_GPU',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_MONODEPTH_GPU.py 
    生成压测数据：
        python FEATURE_VIS_MONODEPTH_GPU.py GEN_STRESS_DATA
    """
