...
################################################################################
"""
Brief: FEATURE_VIS_VIDEO_FACE_INCOMPLETE_CPU Demo
Filename: FEATURE_VIS_VIDEO_FACE_INCOMPLETE_CPU.py
"""
...
class FeatureVisVideoFaceIncomplete(XvisionDemo):
    """
    FEATURE_VIS_VIDEO_FACE_INCOMPLETE_CPU Demo
    """
...
def feature_calculate():
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_VIDEO_FACE_INCOMPLETE_CPU',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行:
        python FEATURE_VIS_VIDEO_FACE_INCOMPLETE_CPU.py
    生成压测数据：
        python FEATURE_VIS_VIDEO_FACE_INCOMPLETE_CPU.py GEN_STRESS_DATA
    """
