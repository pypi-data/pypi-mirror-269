...
################################################################################
"""
Brief:FEATURE_AR_IMG_FACECLS_GPU_V4 Demo, 以及压测数据生成的DEMO
Author: xieshuai(xieshuai@baidu.com)
Date: 2022-07-01
Filename: FEATURE_AR_IMG_FACECLS_GPU_V4.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_AR_IMG_FACECLS_GPU_V4 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_AR_IMG_FACECLS_GPU_V4',
