...
"""
Brief:FEATURE_KG_TEXT_EVENTQUERY_GPU_V2 Demo, 以及压测数据生成的DEMO
Author: huangjiayan(huangjiayan@baidu.com)
Date: 2021-02-24
Filename: FEATURE_KG_TEXT_EVENTQUERY_GPU_V2.py
"""
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_KG_TEXT_EVENTQUERY_GPU_V2',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_KG_TEXT_WORDTAG_GPU.py
    生成压测数据：
        python FEATURE_KG_TEXT_WORDTAG_GPU.py GEN_STRESS_DATA
    """
