...
Brief:
@Author: chenminjie04
@Date:   2020-12-28 17:15:44
@Filename: FEATURE_DE_IMG_ZY_LT_QJ_SEGMENT_GPU.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_DE_IMG_ZY_LT_QJ_SEGMENT_GPU demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_DE_IMG_ZY_LT_QJ_SEGMENT_GPU',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_DE_IMG_ZY_LT_QJ_SEGMENT_GPU.py
    生成压测数据：
        python FEATURE_DE_IMG_ZY_LT_QJ_SEGMENT_GPU.py GEN_STRESS_DATA
    """
