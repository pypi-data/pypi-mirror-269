...
################################################################################
"""
Brief:FEATURE_VIS_IMG_VEHICLE_MOT_GPU_V4_DYNAMIC Demo, 以及压测数据生成的DEMO
Author: yangxipeng01(yangxipeng011@baidu.com)
Date: 2020-04-09
Filename: FEATURE_VIS_IMG_VEHICLE_MOT_GPU_V4_DYNAMIC.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_VEHICLE_MOT_GPU_V4_DYNAMIC demo  
    """
...
def feature_calculate(input_dir):
    ...
    for image_idx, image_file in enumerate(img_file_list):
        ...
        feature_data = featureDemo.prepare_request(data, image_idx)
        ...
        headers = {
            ...
            'feature_name': 'FEATURE_VIS_IMG_VEHICLE_MOT_GPU_V4_DYNAMIC',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_VEHICLE_MOT_GPU_V4_DYNAMIC.py 
    生成压测数据：
        python FEATURE_VIS_IMG_VEHICLE_MOT_GPU_V4_DYNAIC.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        # 动态车流Demo
        feature_calculate('./image_dir/FEATURE_VIS_IMG_VEHICLE_MOT_GPU')  # ./image_dir/ 本地图片dir
