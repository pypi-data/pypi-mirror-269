...
################################################################################
"""
Brief:FEATURE_VIS_VIDEO_CLUSTER_V1 Demo, 以及压测数据生成的DEMO
Author: yangmin09(yangmin09@baidu.com)
Date: 2022-07-22
Filename: FEATURE_VIS_VIDEO_CLUSTER_V1.py 
"""
...
def feature_calculate():
    ...
    feature_data = feature_demo.prepare_request()
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_VIDEO_CLUSTER_V1',
