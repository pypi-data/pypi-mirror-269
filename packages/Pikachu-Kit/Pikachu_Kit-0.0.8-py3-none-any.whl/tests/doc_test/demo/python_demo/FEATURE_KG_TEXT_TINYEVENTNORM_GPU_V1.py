...
# -*- coding: utf-8 -*-
# @Author: shixi
# @Date:   2021-03-09 12:07:40
"""
Brief:FEATURE_KG_TEXT_TINYEVENTNORM_GPU_V1 Demo, 以及压测数据生成的DEMO
Author: shixi(shixi@baidu.com)
Date: 2021-03-09
Filename: FEATURE_KG_TEXT_TINYEVENTNORM_GPU_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_KG_TEXT_TINYEVENTNORM_GPU_V1 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_KG_TEXT_TINYEVENTNORM_GPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_KG_TEXT_TINYEVENTNORM_GPU_V1.py
    生成压测数据：
        python FEATURE_KG_TEXT_TINYEVENTNORM_GPU_V1.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        #特征计算Demo
        feature_calculate([["特朗普和梅拉尼娅1月已经接种疫苗", "特朗普夫妇曾在1月“悄悄”接种新冠疫苗"]])
