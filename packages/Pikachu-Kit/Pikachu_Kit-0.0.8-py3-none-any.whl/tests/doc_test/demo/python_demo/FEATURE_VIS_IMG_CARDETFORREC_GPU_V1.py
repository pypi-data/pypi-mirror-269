...
################################################################################
"""
Brief:FEATURE_VIS_IMG_CARDETFORREC_GPU_V1 Demo, 以及压测数据生成的DEMO
Author: fumingxin(fumingxin@baidu.com)
Date: 2019-09-03
Filename: FEATURE_VIS_IMG_CARDETFORREC_GPU_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_CARDETFORREC_GPU_V1 demo
    """
    def prepare_request(self, data):
        ...
        req_array = {
            ...
            'cmdid': '123',
            'clientip': clientip,
            'data': base64.b64encode(json.dumps({'image':base64.b64encode(data['image']), 'top_num': 5})),
        }
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_CARDETFORREC_GPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_CARDETFORREC_GPU_V1.py
    生成压测数据：
        python FEATURE_VIS_IMG_CARDETFORREC_GPU_V1.py GEN_STRESS_DATA
    """
