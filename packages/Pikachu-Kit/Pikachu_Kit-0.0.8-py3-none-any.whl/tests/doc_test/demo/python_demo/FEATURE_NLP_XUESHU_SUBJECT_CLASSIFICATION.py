...
#
"""
File: FEATURE_NLP_XUESHU_SUBJECT_CLASSIFICATION.py
Author: wuyuwei(wuyuwei@baidu.com)
Date: 2022/10/13 2:26 下午
"""
...
class FeatureReq(XvisionDemo):
    """
        FEATURE_NLP_XUESHU_SUBJECT_CLASSIFICATION demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_NLP_XUESHU_SUBJECT_CLASSIFICATION',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_NLP_XUESHU_SUBJECT_CLASSIFICATION.py
    生成压测数据：
        python FEATURE_NLP_XUESHU_SUBJECT_CLASSIFICATION.py GEN_STRESS_DATA
    """
