...
################################################################################
"""
Brief: FEATURE_VIS_IMG_GENERAL_AESTHETIC_GPU_WANGPAN_T4 Demo, 以及压测数据生成的 Demo
Filename: FEATURE_VIS_IMG_GENERAL_AESTHETIC_GPU_WANGPAN_T4.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_GENERAL_AESTHETIC_GPU_WANGPAN_T4 Demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_GENERAL_AESTHETIC_GPU_WANGPAN_T4',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行:
        python FEATURE_VIS_IMG_GENERAL_AESTHETIC_GPU_WANGPAN_T4.py 
    生成压测数据:
        python FEATURE_VIS_IMG_GENERAL_AESTHETIC_GPU_WANGPAN_T4.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        # 特征计算Demo
        # ./image_dir/FEATURE_VIS_IMG_GENERAL_AESTHETIC_WANGPAN_T4.jpg 本地图片
        feature_calculate('./image_dir/FEATURE_VIS_IMG_GENERAL_AESTHETIC_WANGPAN_T4.jpg')
