...
Date: 2022-05-07
Filename: FEATURE_VIS_VIDEO_CLIP_GPU_V1.py 
"""
...
def feature_calculate(input_data):
    ...
    job_name = "STRESSJOBFEATURE_VIS_VIDEO_CLIP_GPU_V1"  # 替换为申请的作业名
    token = "9b8bb483-56ce-5f05-8c02-e5706552a5c2"  # 替换为申请作业的token
    headers = {
        'Content-Type': 'application/json; charset=UTF-8',
        'resource_key': 'test.jpg',
        'auth_key': token,
        'business_name': job_name,
        'feature_name': 'FEATURE_VIS_VIDEO_CLIP_GPU_V1',
