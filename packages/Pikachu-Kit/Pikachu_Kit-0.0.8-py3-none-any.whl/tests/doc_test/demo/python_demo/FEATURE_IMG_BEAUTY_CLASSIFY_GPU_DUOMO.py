...
################################################################################
"""
Brief: FEATURE_IMG_BEAUTY_CLASSIFY_GPU_DUOMO Demo, 以及压测数据生成的DEMO
Author: Zhou Zhichao(zhouzhichao01@baidu.com)
Date: 2020-11-18
Filename: FEATURE_IMG_BEAUTY_CLASSIFY_GPU_DUOMO.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_IMG_BEAUTY_CLASSIFY_GPU_DUOMO demo
    """
    ...
    def prepare_request(self, imgData):
        ...
        return json.dumps({
            ...
            'cmdid': '123',
            'client': '0.0.0.0',
            'data': base64.b64encode(json.dumps({'image': base64.b64encode(imgData)}))
        })
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_IMG_BEAUTY_CLASSIFY_GPU_DUOMO',
    ...
    if (("code" in res_data)
        ...
        res_data = json.loads(base64.b64decode(res_json['result']))
    # 打印输出
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_IMG_BEAUTY_CLASSIFY_GPU_DUOMO.py
    生成压测数据：
        python FEATURE_IMG_BEAUTY_CLASSIFY_GPU_DUOMO.py GEN_STRESS_DATA
    """
