...
################################################################################
"""
Brief:FEATURE_NLP_TEXT_KEYWORDSDETECTION_ANA_CPU_V01 Demo, 以及压测数据生成的DEMO
Author: mayun03(mayun03@baidu.com)
Date: 2022-08-12
Filename: FEATURE_NLP_TEXT_KEYWORDSDETECTION_ANA_CPU_V01.py
"""
import json
import os
import random
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_NLP_TEXT_KEYWORDSDETECTION_ANA_CPU_V01 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_NLP_TEXT_KEYWORDSDETECTION_ANA_CPU_V01',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_NLP_TEXT_KEYWORDSDETECTION_ANA_CPU_V01.py
    生成压测数据：
        python FEATURE_NLP_TEXT_KEYWORDSDETECTION_ANA_CPU_V01.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        #特征计算Demo
        sample = "各级党委和政府要深化产业工人队伍建设改革，重视发挥技术工人队伍作用，使他们的创新才智充分涌流。"
