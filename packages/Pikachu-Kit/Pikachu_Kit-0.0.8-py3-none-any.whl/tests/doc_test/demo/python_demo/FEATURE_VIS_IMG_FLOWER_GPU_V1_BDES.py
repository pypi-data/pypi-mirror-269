...
################################################################################
"""
Brief:FEATURE_VIS_IMG_FLOWER_GPU_V1_BDES Demo, 以及压测数据生成的DEMO
Author: dengxiao03(dengxiao03@baidu.com)
Date: 2019-08-28
Filename: FEATURE_VIS_IMG_FLOWER_GPU_V.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_FLOWER_GPU_V1 demo  
    """
    ...
    def prepare_request(self, data):
        ...
        new_data, meta = bdes_encode(json.dumps(new_data))
        return json.dumps({
            'appid': '123456',
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_FLOWER_GPU_V1_BDES',
    ...
    print base64.b64decode(json.loads(json.loads(res_data)['feature_result']['value'])['result'])
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_FLOWER_GPU_V1.py 
    生成压测数据：
        python FEATURE_VIS_IMG_FLOWER_GPU_V1.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        # 特征计算Demo
        feature_calculate('./image_dir/qiulan.jpg')  # ./image_dir/img_file 本地图片
