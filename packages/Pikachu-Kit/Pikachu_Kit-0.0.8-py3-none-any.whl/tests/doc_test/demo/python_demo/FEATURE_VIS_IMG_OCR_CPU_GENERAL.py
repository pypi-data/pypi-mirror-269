...
################################################################################
"""
Brief:FEATURE_VIS_IMG_OCR_CPU_GENERAL Demo, 以及压测数据生成的DEMO
Author: v_tanjinxiang(v_tanjinxiang@baidu.com)
Date: 2019-09-20
Filename: FEATURE_VIS_IMG_OCR_CPU_GENERAL.py
"""
import base64
import json
import os
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_OCR_CPU_GENERAL demo
    """
    ...
    def prepare_request(self, data):
        ...
        输出：
            返回算子的输入数据
        """
        dataTmp = "type=st_ocrapi_all&appid=10005&clientip=x.x.x.x&fromdevice=pc&version=1.0.0&detecttype=LocateRecognize&encoding=1&international=1&languagetype=CHN_ENG&recg_type=seq&locate_type=v2&image=" + base64.b64encode(data['image'])
        return json.dumps({
            'appid': 'xvision-app',
            'logid': 1234567,
            'from': 'xvision',
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_OCR_CPU_GENERAL',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_OCR_CPU_GENERAL.py
    生成压测数据：
        python FEATURE_VIS_IMG_OCR_CPU_GENERAL.py GEN_STRESS_DATA
    """
