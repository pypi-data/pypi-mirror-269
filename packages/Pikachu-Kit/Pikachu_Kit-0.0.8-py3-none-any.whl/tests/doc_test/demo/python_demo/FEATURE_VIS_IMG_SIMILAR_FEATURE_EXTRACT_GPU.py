...
################################################################################
"""
Brief:FEATURE_VIS_IMG_SIMILAR_FEATURE_EXTRACT_GPU Demo, 以及压测数据生成的DEMO
Author: songyuxin02(songyuxin02@baidu.com)
Date: 2023-02-27
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_SIMILAR_FEATURE_EXTRACT_GPU demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_SIMILAR_FEATURE_EXTRACT_GPU',
    ...
    infos = {"featureids": "1164,1111,1108"}
...
def parse_result(res_data):
    ...
    feature_1111 = np.fromstring(features[1111], dtype=np.int32)
    feature_1108 = np.fromstring(features[1108], dtype=np.uint8)
    print("feature_1164.shape:", feature_1164.shape)
    print("feature_1111.shape:", feature_1111.shape)
