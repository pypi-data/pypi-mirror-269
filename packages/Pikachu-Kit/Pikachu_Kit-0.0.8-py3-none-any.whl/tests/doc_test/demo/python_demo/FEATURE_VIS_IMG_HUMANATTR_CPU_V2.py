...
################################################################################
"""
Brief:FEATURE_VIS_IMG_HUMANATTR_CPU_V2 Demo, 以及压测数据生成的DEMO
Author: chengang06(chengang06@baidu.com)
Date: 2019-08-26
Filename: FEATURE_VIS_IMG_HUMANATTR_CPU_V2.py
"""
import base64
import json
import os
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_HUMANATTR_CPU_V2 demo
    """
    ...
    def prepare_request(self, data):
        ...
        base_data['type'] = 'gender,age'  # could be pencil or cartoon
        return json.dumps({
            'appid': '1234567',
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_HUMANATTR_CPU_V2',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_HUMANATTR_CPU_V2.py
    生成压测数据：
        python FEATURE_VIS_IMG_HUMANATTR_CPU_V2.py GEN_STRESS_DATA
    """
