...
################################################################################
"""
Brief:FEATURE_IMG_IMAGECAPTION_GPU_A10_V3 Demo, 以及压测数据生成的DEMO
Author: RongKang (rongkang@baidu.com)
Date: 2023-08-03
Filename: FEATURE_IMG_IMAGECAPTION_GPU_A10_V3.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_IMG_IMAGECAPTION_GPU_A10_V3 demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_IMG_IMAGECAPTION_GPU_A10_V3',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_IMG_IMAGECAPTION_GPU_A10_V3.py 
    生成压测数据：
        python FEATURE_IMG_IMAGECAPTION_GPU_A10_V3.py GEN_STRESS_DATA
    """
