...
################################################################################
"""
Brief:FEATURE_VIS_IMG_GIFGEN_V2_ASYNC_GPU Demo, 以及压测数据生成的DEMO
Author: wuye03(wuye03@baidu.com)
Date: 2023-05-31
Filename: FEATURE_VIS_IMG_GIFGEN_V2_ASYNC_GPU.py
Note: before you  execute "python2 FEATURE_VIS_IMG_GIFGEN_V2_ASYNC_GPU.py", you need execute "python3 callback.py" to launch a local server to receive the return json. As for "callback.py",please contact wuye03
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_SELFIE2ANIME_DIFFUSION_GPU_A30 demo  
    """
...
def feature_calculate(input_data):
    ...
    params = {
        ...
        "text_prompt": "a cute cat with its hands up"
    }
    

    callback = {
        "host": "10.255.106.18", # 填写测试机器（接收服务返回结果的机器）的ip,请注意一定要写对ip,否则无法接收返回的结果。
    ...
    job_name = ""  # 申请的作业名
    token = ""  # 作业的token
    feature_name = "FEATURE_VIS_IMG_GIFGEN_V2_ASYNC_GPU"
    data = {
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_SELFIE2ANIME_DIFFUSION_GPU_A30.py
    生成压测数据：
        python FEATURE_VIS_IMG_SELFIE2ANIME_DIFFUSION_GPU_A30.py GEN_STRESS_DATA
    """
