...
################################################################################
"""
Brief:FEATURE_VIS_IMG_GPU_SHELF_COMPLETE_DETECTION_AIPE Demo,以及压测数据生成DEMO
Author: anrongqiao(anrongqiao@baidu.com)
Date: 2021-07-28
Filename: FEATURE_VIS_IMG_GPU_SHELF_COMPLETE_DETECTION_AIPE.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_GPU_SHELF_COMPLETE_DETECTION_AIPE demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_GPU_SHELF_COMPLETE_DETECTION_AIPE',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_GPU_SHELF_COMPLETE_DETECTION_AIPE.py 
    生成压测数据：
        python FEATURE_VIS_IMG_GPU_SHELF_COMPLETE_DETECTION_AIPE.py GEN_STRESS_DATA
    """
