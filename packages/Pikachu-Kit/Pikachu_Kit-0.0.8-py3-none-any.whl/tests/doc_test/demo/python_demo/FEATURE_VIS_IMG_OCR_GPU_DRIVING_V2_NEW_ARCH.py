...
################################################################################
"""
Brief: FEATURE_VIS_IMG_OCR_GPU_DRIVING_V2_NEW_ARCH.py Demo, 以及压测数据生成的DEMO
...
class FeatureReq(XvisionDemo):
    ...
    def prepare_request(self, data):
        ...
        return json.dumps({
            ...
            'cmdid': '123',
            'clientip': '0.0.0.0',
            'data': base64.b64encode('object_type=driving_license&image=' + base64.b64encode(data['image'])),
        })
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_OCR_GPU_DRIVING_V2_NEW_ARCH',
