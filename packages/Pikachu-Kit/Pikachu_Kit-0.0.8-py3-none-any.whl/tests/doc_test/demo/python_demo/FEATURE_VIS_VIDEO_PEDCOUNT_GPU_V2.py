...
################################################################################
"""
Brief:FEATURE_VIS_VIDEO_PEDCOUNT_GPU_V2 Demo, 以及压测数据生成的DEMO
Author: Wu Yongjun (wuyongjun01@baidu.com)
Date: 2020-05-28
Author: Su Xiangbo (suxiangbo@baidu.com)
Date: 2020-06-01
Filename: FEATURE_VIS_VIDEO_PEDCOUNT_GPU_V2.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_VIDEO_PEDCOUNT_GPU_V2 demo
    """
...
def feature_calculate(input_data):
    ...
    data = {
                ...
                "area_dynamic": [[0, 175, 435, 175, 505, 310, 805, 310, 915, 175, 1279, 175, 1279, 959, 0, 959]]
            }
    ...
    job_name = "STRESSJOBFEATURE_VIS_VIDEO_PEDCOUNT_GPU_V2"
    token  = "ba92f83d-955f-5345-9501-c552404f2454"
    ...
    xvision_data = {
            ...
            'feature_name': 'FEATURE_VIS_VIDEO_PEDCOUNT_GPU_V2',           # 算子名
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_VIDEO_PEDCOUNT_GPU_V2.py
    生成压测数据：
        python FEATURE_VIS_VIDEO_PEDCOUNT_GPU_V2.py GEN_STRESS_DATA
    """
    op_type = sys.argv[1] if len(sys.argv) == 2 else 'FEATURE_CALCULATE'
    if op_type == 'GEN_STRESS_DATA':
        #生成压测词表
        gen_stress_data('./video_url_dir/FEATURE_VIS_VIDEO_PEDCOUNT_GPU_V2/url.txt') #./image_dir/ 是本地的图片数据,生成压测数据需要把产品线的数据放到image_dir下边,一张图片一个文件
    else:
        #特征计算Demo
        test_video_url = "https://iov-vision.bj.bcebos.com/person_flow/" + \
            "2019-04-01/KL010/LC9ND10C8JALA6010-20190330145933-4065-1554078975623684825.264.avi"
