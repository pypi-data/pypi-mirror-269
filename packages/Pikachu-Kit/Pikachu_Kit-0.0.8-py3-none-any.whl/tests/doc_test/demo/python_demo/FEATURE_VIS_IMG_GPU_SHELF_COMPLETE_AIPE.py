...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_GPU_SHELF_COMPLETE_AIPE demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_GPU_SHELF_COMPLETE_AIPE',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_GPU_SHELF_COMPLETE_AIPE.py 
    生成压测数据：
        python FEATURE_VIS_IMG_GPU_SHELF_COMPLETE_AIPE.py GEN_STRESS_DATA
    """
