...
################################################################################
"""
Brief:FEATURE_NLP_TXT_LEXER_CPU_V1 Demo, 以及压测数据生成的DEMO
Author: liqinrui(liqinrui@baidu.com)
Date: 2021-05-07
Filename: FEATURE_NLP_TXT_LEXER_CPU_V1.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_NLP_TXT_LEXER_CPU_V1 demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_NLP_TXT_LEXER_CPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_NLP_TXT_LEXER_CPU_V1.py 
    生成压测数据：
        python FEATURE_NLP_TXT_LEXER_CPU_V1.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        #特征计算Demo
        feature_calculate('{"texts":["百度科技园"]}') # 本地文本
