...
"""
Brief:
@Filename: FEATURE_VIS_IMG_LANDMARK201_GPU.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_LANDMARK201_GPU demo
    """
    def prepare_request(self, data):
        ...
        req_data = {
            ...
            "img_data": base64.b64encode(data['image']),
        }
...
def feature_calculate(input_data):
    ...
    job_name = ""  # 申请的作业名
    token = ""  # 作业的token
    feature_name = "FEATURE_VIS_IMG_LANDMARK201_GPU"
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_LANDMARK201_GPU.py
    生成压测数据：
        python FEATURE_VIS_IMG_LANDMARK201_GPU.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        #特征计算Demo
        feature_calculate('./image_dir/demo_img/FEATURE_FACE.png') #本地图片
