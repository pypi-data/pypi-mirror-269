...
#use the same protobuf as FEATURE_VIS_IMG_DETECTION_GPU_AIPE
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_GPU_SCREENSHOT_CLS demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_GPU_SCREENSHOT_CLS',
    ...
    res_json['features'][0]['fea_data'] = infos
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_GPU_SCREENSHOT_CLS.py 
    生成压测数据：
        python FEATURE_VIS_IMG_GPU_SCREENSHOT_CLS.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        #特征计算Demo
        feature_calculate('./image_dir/screenshot.jpg') #./image_dir/img_file 本地图片
