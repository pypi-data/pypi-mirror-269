...
################################################################################
"""
Brief:FEATURE_VIS_VIDEO_DELOGO_DESUBTITLE_GPU_ASYNC_A10_V1_US Demo, 以及压测数据生成的DEMO
Author: liufanglong (liufanglong@baidu.com)
Date: 2022-03-04
Filename: FEATURE_VIS_VIDEO_DELOGO_DESUBTITLE_GPU_ASYNC_A10_V1_US.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_VIDEO_DELOGO_DESUBTITLE_GPU_ASYNC_A10_V1_US demo
    """
...
def feature_calculate(input_data):
    ...
    xvision_data = {
            ...
            'feature_name': 'FEATURE_VIS_VIDEO_DELOGO_DESUBTITLE_GPU_ASYNC_A10_V1_US',           # 算子名
    ...
    # 注意该算子只允许异步访问
    url = featureDemo.xvision_online_url + featureDemo.xvision_callback_path + online_ex_data  # 线上作业调用
    # url = featureDemo.xvision_test_url + featureDemo.xvision_callback_path + online_ex_data  # 压测环境测试
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_VIDEO_DELOGO_DESUBTITLE_GPU_ASYNC_A10_V1_US.py
    """
    #特征计算Demo
    test_video_url = "./00212812-b1e6-11ec-a3a3-b8cef6c1c38c.mp4"
