...
################################################################################
"""
Brief:FEATURE_VIS_IMG_TERROR_GPU_V8 Demo, 以及压测数据生成的DEMO
Author: xiaoyunfeng(xiaoyunfeng@baidu.com)
Date: 2019-10-10
Filename: FEATURE_VIS_IMG_TERROR_GPU_V8.py
"""
...
from proto.FEATURE_VIS_IMG_TERROR_GPU_V8 import general_classify_client_pb2
from proto.FEATURE_VIS_IMG_TERROR_GPU_V8.protobuf_to_dict import protobuf_to_dict


class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_TERROR_GPU_V8 demo
    """
    def prepare_request(self, imgData):
        ...
        classifytype1.type_name = 'terror'
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_TERROR_GPU_V8',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_TERROR_GPU_V8.py
    生成压测数据：
        python FEATURE_VIS_IMG_TERROR_GPU_V8.py GEN_STRESS_DATA
    """
