...
################################################################################
"""
Brief: FEATURE_VIS_KOUBO_TUJI_V1 Demo
Filename: FEATURE_VIS_KOUBO_TUJI_V1.py
"""
...
class FeatureVisKouboTujiV1(XvisionDemo):
    """
    FEATURE_VIS_KOUBO_TUJI_V1 Demo
    """
    ...
    def prepare_request(self, data):
        ...
        输入:
            data: dict 类型, 算子处理对象包含
                  ...
                  category(视频类别信息，例如：音乐、体育等，可以不提供，默认为空)
                  famous_face(视频中包含的名人脸信息，例如：肖战，可以不提供，默认为空)
...
def feature_calculate():
    ...
    featureDemo = FeatureVisKouboTujiV1()
    # 生成算子输入
    data = {
        'video_url': input_url
    }
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_KOUBO_TUJI_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行:
        python FEATURE_VIS_KOUBO_TUJI_V1.py
    生成压测数据：
        python FEATURE_VIS_KOUBO_TUJI_V1.py GEN_STRESS_DATA
    """
