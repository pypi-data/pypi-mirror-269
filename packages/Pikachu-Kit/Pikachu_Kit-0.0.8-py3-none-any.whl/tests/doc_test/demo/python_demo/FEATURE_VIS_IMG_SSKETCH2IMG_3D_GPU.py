...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_SSKETCH2IMG_3D_GPU',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_SSKETCH2IMG_3D_GPU.py
    生成压测数据：
        python FEATURE_VIS_IMG_SSKETCH2IMG_3D_GPU.py GEN_STRESS_DATA
    """
