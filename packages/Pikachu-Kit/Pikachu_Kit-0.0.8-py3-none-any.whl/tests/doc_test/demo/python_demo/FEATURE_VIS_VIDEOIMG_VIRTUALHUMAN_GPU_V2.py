...
################################################################################
"""
Brief:FEATURE_VIS_VIDEOIMG_VIRTUALHUMAN_GPU_V2 Demo, 以及压测数据生成的DEMO
Author: caijinhai(caijinhai@baidu.com)
Date: 2021-04-07
Filename: FEATURE_VIS_VIDEOIMG_VIRTUALHUMAN_GPU_V2.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_VIDEOIMG_VIRTUALHUMAN_GPU_V2 demo  
    """
    def prepare_request(self, data):
        ...
        request_data = {
            ...
            "track_url": "https://facefusion-2021-peoplesdaily.obj.bcebos.com/track/\
            53d23a2e-97c9-4531-8135-6cb307b19d43_v1_data.tar.gz",
            "extra_req_json": { "x":0, "y":0, "width":0, "height":0 },
            "alpha": 1,
            "action_tag": "1 5 2 10 3 20 4 30",
            "video_format": "webm",
        }
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_VIDEOIMG_VIRTUALHUMAN_GPU_V2.py 
    生成压测数据：
        python FEATURE_VIS_VIDEOIMG_VIRTUALHUMAN_GPU_V2.py GEN_STRESS_DATA
    """
