...
################################################################################
"""
Brief:FEATURE_VIS_IMG_GPU_LOWQUALITY Demo, 以及压测数据生成的DEMO
Author: caoqiyun(caoqiyun@baidu.com)
Date: 2019-10-10
Filename: FEATURE_VIS_IMG_GPU_LOWQUALITY.py
"""
...
from proto.FEATURE_VIS_IMG_GPU_LOWQUALITY import general_classify_client_pb2
from proto.FEATURE_VIS_IMG_GPU_LOWQUALITY.protobuf_to_dict import protobuf_to_dict


class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_GPU_LOWQUALITY demo
    """
    def prepare_request(self, imgData):
        ...
        classifytype1.type_name = 'image-quality-low'
        classifytype1.topnum = 1
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_GPU_LOWQUALITY',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_GPU_LOWQUALITY.py
    生成压测数据：
        python FEATURE_VIS_IMG_GPU_LOWQUALITY.py GEN_STRESS_DATA
    """
    op_type = sys.argv[1] if len(sys.argv) == 2 else 'FEATURE_CALCULATE'
    if op_type == 'GEN_STRESS_DATA':
        # 生成压测词表
        gen_stress_data('./images/')  # ./image_dir/ 是本地的图片数据
    else:
        # 特征计算Demo
        feature_calculate('./images/b701665959241ddfee2cc15ae.png')  # ./image_dir/img_file 本地图片
