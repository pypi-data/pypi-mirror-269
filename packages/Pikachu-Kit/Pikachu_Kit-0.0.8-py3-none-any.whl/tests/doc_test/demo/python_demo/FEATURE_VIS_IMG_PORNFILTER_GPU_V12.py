...
################################################################################
"""
Brief:FEATURE_VIS_IMG_PORNFILTER_GPU_V12 Demo, 以及压测数据生成的DEMO
Author: Wu Yongjun01(wuyongjun01@baidu.com)
Date: 2020-03-10
Filename: FEATURE_VIS_IMG_PORNFILTER_GPU_V12.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_PORNFILTER_GPU_V12 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_PORNFILTER_GPU_V12',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_PORNFILTER_GPU_V12.py
    生成压测数据：
        python FEATURE_VIS_IMG_PORNFILTER_GPU_V12.py GEN_STRESS_DATA
    """
