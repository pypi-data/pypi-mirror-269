...
################################################################################
"""
Brief:FEATURE_VIS_IMG_OCR_GPU_IDCARDS3 Demo, 以及压测数据生成的DEMO
Author: zhangxiaoqiang01(zhangxiaoqiang01@baidu.com)
Date: 2020-06-23
Filename: FEATURE_VIS_IMG_OCR_GPU_IDCARDS3.py
"""
import base64
import json
import os
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_OCR_GPU_IDCARDS3 demo
    """
    ...
    def prepare_request(self, data):
        ...
        输出：
            返回算子的输入数据
	"""
        dataTmp = "object_type=id_card&image=" + base64.b64encode(data['image'])
        return json.dumps({
            'appid': 'xvision-app',
            'logid': 'test_1234567',
            'from': 'xvision',
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_OCR_GPU_IDCARDS3',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_OCR_GPU_IDCARDS3.py
    生成压测数据：
        python FEATURE_VIS_IMG_OCR_GPU_IDCARDS3.py GEN_STRESS_DATA
    """
