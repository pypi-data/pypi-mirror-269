...
################################################################################
"""
Brief:FEATURE_VIS_IMG_COLORIZATION_GPU_BDES Demo, 以及压测数据生成的DEMO
Author: liufanglong(liufanglong@baidu.com)
Date: 2022-05-16
Filename: FEATURE_VIS_IMG_COLORIZATION_GPU_BDES.py 
"""
...
class FeatureReq(XvisionDemoEnc):
    """
    FEATURE_VIS_IMG_COLORIZATION_GPU_BDES demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_COLORIZATION_GPU_BDES',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_COLORIZATION_GPU_BDES.py 
    生成压测数据：
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        feature_calculate('/ssd3/liufanglong/data/colorization/val_gray/003/00000.jpg')
