...
class FeatureReq(XvisionDemo):
    """
    FEATURE_FEED_IMG_CLARITY_GPU_V2 demo
    """
    def prepare_request(self, data):
        ...
        输出：
            返回算子的输入数据
        """
        return "svc_name=clarity&image=" + urllib.quote(base64.b64encode(data['image']))
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_FEED_IMG_CLARITY_GPU_V2',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_FEED_IMG_CLARITY_GPU_V2.py
    生成压测数据：
        python FEATURE_FEED_IMG_CLARITY_GPU_V2.py GEN_STRESS_DATA
    """
