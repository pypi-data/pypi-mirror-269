...
################################################################################
"""
Brief:FEATURE_VIS_IMG_CLASSIFY970_GPU Demo, 以及压测数据生成的DEMO
Author: Wu Yongjun(wuyongjun01@baidu.com), shangzhizhou
Date: 2020-06-18
Filename: FEATURE_VIS_IMG_CLASSIFY970_GPU.py
"""
...
from proto.FEATURE_VIS_IMG_CLASSIFY970_GPU import general_classify_client_pb2
from proto.protobuf_to_dict import protobuf_to_dict


class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_CLASSIFY970_GPU demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_CLASSIFY970_GPU',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_CLASSIFY970_GPU.py
    生成压测数据：
        python FEATURE_VIS_IMG_CLASSIFY970_GPU.py GEN_STRESS_DATA
    """
