...
################################################################################
"""
Brief:FEATURE_VIS_IMG_SELFIE2ANIME_DIFFUSION_MERGE_GPU_A30 Demo, 以及压测数据生成的DEMO
Author: wuye(wuye03@baidu.com)
Date: 2023-03-27
Filename: FEATURE_VIS_IMG_SELFIE2ANIME_DIFFUSION_MERGE_GPU_A30.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_SELFIE2ANIME_DIFFUSION_MERGE_GPU_A30 demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_SELFIE2ANIME_DIFFUSION_MERGE_GPU_A30',
