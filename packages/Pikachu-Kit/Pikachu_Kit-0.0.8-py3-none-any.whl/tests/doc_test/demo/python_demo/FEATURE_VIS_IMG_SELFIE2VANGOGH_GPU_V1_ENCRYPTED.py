...
################################################################################
"""
Brief:FEATURE_VIS_IMG_SELFIE2VANGOGH_GPU_V1_ENCRYPTED Demo, 以及压测数据生成的DEMO
Author: lifu(lifu@baidu.com)
Date: 2020-05-26
Filename: FEATURE_VIS_IMG_SELFIE2VANGOGH_GPU_V1_ENCRYPTED.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_SELFIE2VANGOGH_GPU_V1_ENCRYPTED demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_SELFIE2VANGOGH_GPU_V1_ENCRYPTED',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_SELFIE2VANGOGH_GPU_V1_ENCRYPTED.py 
    生成压测数据：
        python FEATURE_VIS_IMG_SELFIE2VANGOGH_GPU_V1_ENCRYPTED.py GEN_STRESS_DATA
    """
