...
################################################################################
"""
Brief: FEATURE_VIS_VIDEO_FACE_INCOMPLETE_GPU Demo
Filename: FEATURE_VIS_VIDEO_FACE_INCOMPLETE_GPU.py
"""
...
class FeatureVisVideoFaceIncomplete(XvisionDemo):
    """
    FEATURE_VIS_VIDEO_FACE_INCOMPLETE_GPU Demo
    """
...
def feature_calculate():
    ...
    featureDemo = FeatureVisVideoFaceIncomplete()
    # 生成算子输入
    data = {
        'video_url': input_url,
        'type_name':'face-incomplete'
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_VIDEO_FACE_INCOMPLETE_GPU',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行:
        python FEATURE_VIS_VIDEO_FACE_INCOMPLETE_GPU.py
    生成压测数据：
        python FEATURE_VIS_VIDEO_FACE_INCOMPLETE_GPU.py GEN_STRESS_DATA
    """
