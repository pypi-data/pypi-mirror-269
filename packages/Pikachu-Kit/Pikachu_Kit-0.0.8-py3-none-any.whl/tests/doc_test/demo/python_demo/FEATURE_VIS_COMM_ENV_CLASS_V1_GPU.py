...
################################################################################
"""
Brief: FEATURE_VIS_COMM_ENV_CLASS_V1_GPU Demo, 以及压测数据生成的 Demo
Filename: FEATURE_VIS_COMM_ENV_CLASS_V1_GPU.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_COMM_ENV_CLASS_V1_GPU Demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_COMM_ENV_CLASS_V1_GPU',
        'X_BD_LOGID': str(random.randint(1000000, 100000000))
    }

    # 高可用型、均衡型作业：xvision_online_url，高吞吐型作业：xvision_offline_url，测试作业：xvision_test_url
    # url = "http://127.0.0.1:8120/GeneralClassifyService/classify"
...
def gen_stress_data(input_dir):
    ...
    for image_file in img_file_list:
        try:
            ...
            print "Error when processing " + input_dir + '/' + image_file
...
if __name__ == '__main__':
    ...
    main
    特征计算执行:
        python FEATURE_VIS_COMM_ENV_CLASS_V1_GPU.py 
    生成压测数据:
        python FEATURE_VIS_COMM_ENV_CLASS_V1_GPU.py GEN_STRESS_DATA
    """
