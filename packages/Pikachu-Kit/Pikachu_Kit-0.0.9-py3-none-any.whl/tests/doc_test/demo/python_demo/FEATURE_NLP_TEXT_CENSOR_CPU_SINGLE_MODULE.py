...
################################################################################
"""
Brief:FEATURE_NLP_TEXT_CENSOR_CPU_SINGLE_MODULE, 以及压测数据生成的DEMO
Author: zhangxiaobin04(zhangxiaobin04@baidu.com)
Date: 2020-12-24
Filename: FEATURE_NLP_TEXT_CENSOR_CPU_SINGLE_MODULE.py
"""
import json
import os
import random
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_NLP_TEXT_CENSOR_CPU_SINGLE_MODULE demo
    """
...
def feature_calculate(input_data):
    ...
    job_name = "STRESSJOBFEATURE_NLP_TEXT_CENSOR_CPU_SINGLE_MODULE"  # 申请的作业名
    token = "d7270658-4612-5e6c-bc97-8c80291e2af2"  # 作业的token
    headers = {
        'Content-Type': 'application/json; charset=UTF-8',
        'resource_key': '',
        'auth_key': token,
        'business_name': job_name,
        'feature_name': 'FEATURE_NLP_TEXT_CENSOR_CPU_SINGLE_MODULE',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_NLP_TEXT_CENSOR_CPU_V2.py
    生成压测数据：
        python FEATURE_NLP_TEXT_CENSOR_CPU_V2.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        #特征计算Demo
        feature_calculate('党中央')  # "今天天气如何" 是本地测试数据
