...
################################################################################
"""
Brief:FEATURE_VIS_IMG_CERTIFICATE_GPU Demo, 以及压测数据生成的DEMO
Author: wanghua11(wanghua11@baidu.com)
Date: 2019-07-29
Filename: FEATURE_VIS_IMG_CERTIFICATE_GPU.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_CERTIFICATE_GPU demo  
    """
    def prepare_request(self, data):
        ...
        return json.dumps({
                    ...
                    'cmdid': '123',
                    'clientip': '0.0.0.0',
                    'data': base64.b64encode("object_type=vehicle_certificate&image=" + base64.b64encode(data['image'])),
                })
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_CERTIFICATE_GPU',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_CERTIFICATE_GPU.py 
    生成压测数据：
        python FEATURE_VIS_IMG_CERTIFICATE_GPU.py GEN_STRESS_DATA
    """
