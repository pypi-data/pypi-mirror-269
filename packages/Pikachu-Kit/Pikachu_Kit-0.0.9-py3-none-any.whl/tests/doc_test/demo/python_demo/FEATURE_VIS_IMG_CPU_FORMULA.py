...
################################################################################
"""
Brief:FEATURE_VIS_IMG_CPU_FORMULA Demo, 以及压测数据生成的DEMO
Author: Wu Yongjun(wuyongjun01@baidu.com)
Date: 2020-03-14
Filename: FEATURE_VIS_IMG_CPU_FORMULA.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_CPU_FORMULA demo
    """
    def prepare_request(self, data_dict):
        ...
        # 算子对应垂类，必填，写死
        data += "object_type=formula_with_text"
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_CPU_FORMULA',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_CPU_FORMULA.py
    生成压测数据：
        python FEATURE_VIS_IMG_CPU_FORMULA.py GEN_STRESS_DATA
    """
