...
################################################################################
"""
Brief:FEATURE_VIS_IMG_WATERMARKREC_GPU_V2_AIPE Demo, 以及压测数据生成的DEMO
Author: Wu Yongjun(wuyongjun01@baidu.com)
Date: 2020-03-15
Filename: FEATURE_VIS_IMG_WATERMARKREC_GPU_V2_AIPE.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_WATERMARKREC_GPU_V2_AIPE demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_WATERMARKREC_GPU_V2_AIPE',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_WATERMARKREC_GPU_V2_AIPE.py 
    生成压测数据：
        python FEATURE_VIS_IMG_WATERMARKREC_GPU_V2_AIPE.py GEN_STRESS_DATA
    """
