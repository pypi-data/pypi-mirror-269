...
################################################################################
"""
Brief:FEATURE_VIS_IMG_FACEMERGE_GPU_AIPE_T4 Demo, 以及压测数据生成的DEMO
Author: work(work@baidu.com)
Date: 2020-06-28
Filename: FEATURE_VIS_IMG_FACEMERGE_GPU_AIPE_T4.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_FACEMERGE_GPU_AIPE_T4 demo
    """
...
def feature_calculate(input_data):
    ...
    params = {
        ...
        "feature_name": "FEATURE_VIS_IMG_FACEMERGE_GPU_AIPE_T4"
    }
...
def gen_stress_data(input_data):
    ...
    for i in range(len(user_img_file_list)):
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_FACEMERGE_GPU_AIPE_T4.py
    生成压测数据：
        python FEATURE_VIS_IMG_FACEMERGE_GPU_AIPE_T4.py GEN_STRESS_DATA
    """
