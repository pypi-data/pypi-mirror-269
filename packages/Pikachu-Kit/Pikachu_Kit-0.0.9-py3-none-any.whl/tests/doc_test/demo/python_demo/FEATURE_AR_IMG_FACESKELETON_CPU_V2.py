...
################################################################################
"""
Brief:FEATURE_AR_IMG_FACESKELETON_CPU_V2 Demo, 以及压测数据生成的DEMO
Author: xieshuai(xieshuai@baidu.com)
Date: 2021-09-10
Filename: FEATURE_AR_IMG_FACESKELETON_CPU_V2.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_AR_IMG_FACESKELETON_CPU_V2 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_AR_IMG_FACESKELETON_CPU_V2',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_AR_IMG_FACESKELETON_CPU_V2.py 
    生成压测数据：
        python FEATURE_AR_IMG_FACESKELETON_CPU_V2.py GEN_STRESS_DATA
    """
