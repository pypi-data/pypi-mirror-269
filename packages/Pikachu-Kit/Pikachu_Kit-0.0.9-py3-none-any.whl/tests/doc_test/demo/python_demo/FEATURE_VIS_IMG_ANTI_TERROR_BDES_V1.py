...
"""
@Author: rongkang@baidu.com
@Date: 2021-11-18 17:11:52
@LastEditTime: 2021-11-18 17:11:53
@Description: 生成压测数据,请求DEMO
@FilePath: FEATURE_VIS_IMG_ANTI_TERROR_BDES_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_ANTI_TERROR_BDES_V1
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_ANTI_TERROR_BDES_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_ANTI_TERROR_BDES_V1
    生成压测数据：
        python FEATURE_VIS_IMG_ANTI_TERROR_BDES_V1 GEN_STRESS_DATA
    """
