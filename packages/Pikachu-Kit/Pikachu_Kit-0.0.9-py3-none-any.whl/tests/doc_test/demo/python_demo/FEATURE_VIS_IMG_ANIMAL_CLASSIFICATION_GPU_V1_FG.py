...
################################################################################
"""
Brief:FEATURE_VIS_IMG_ANIMAL_CLASSIFICATION_GPU_V1_FG Demo, 以及压测数据生成的DEMO
Author: wuyongjun01(wuyongjun01@baidu.com)
Date: 2019-12-06
Filename: FEATURE_VIS_IMG_ANIMAL_CLASSIFICATION_GPU_V1_FG.py 
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_ANIMAL_CLASSIFICATION_GPU_V1_FG demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_ANIMAL_CLASSIFICATION_GPU_V1_FG',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_ANIMAL_CLASSIFICATION_GPU_V1_FG.py 
    生成压测数据：
        python FEATURE_VIS_IMG_ANIMAL_CLASSIFICATION_GPU_V1_FG.py GEN_STRESS_DATA
    """
