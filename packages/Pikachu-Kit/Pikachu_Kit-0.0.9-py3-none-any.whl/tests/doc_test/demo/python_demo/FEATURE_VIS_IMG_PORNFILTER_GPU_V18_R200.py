...
################################################################################
"""
Brief:FEATURE_VIS_IMG_PORNFILTER_GPU_V18_R200 Demo, 以及压测数据生成的DEMO
Author: v_chenhaonan0101@baidu.com
Date: 2023-10-24
Filename: FEATURE_VIS_IMG_PORNFILTER_GPU_V18_R200.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_PORNFILTER_GPU_V18_R200 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_PORNFILTER_GPU_V18_R200',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_PORNFILTER_GPU_V18_R200.py
    生成压测数据：
        python FEATURE_VIS_IMG_PORNFILTER_GPU_V18_R200.py GEN_STRESS_DATA
    """
