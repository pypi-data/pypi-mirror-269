...
message: FEATURE_KG_CMSIM_IT_IMAGE_V1 Demo
...
class XvisionOperator(object):
    """
    FEATURE_KG_CMSIM_IT_IMAGE_V1 demo
    """

    def __init__(self, job_name, token, feature_name='FEATURE_KG_CMSIM_IT_IMAGE_V1'):
        """
        __init__
        """
...
if __name__ == '__main__':
    ...
    operator = XvisionOperator(job_name,
                               token,
                               feature_name='FEATURE_KG_CMSIM_IT_IMAGE_V1')
    line = {"@id": "6cj4x8c", "image_b64": ["image_b64"], "meta": {}}
