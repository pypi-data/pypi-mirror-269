...
################################################################################
"""
Brief: FEATURE_VIS_IMG_SEGMENT_V2_GPU_A10 Demo, 以及压测数据生成的DEMO
Author: liufanglong(liufanglong@baidu.com)
Date: 2023-11-15
Filename: FEATURE_VIS_IMG_SEGMENT_V2_GPU_A10.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_SEGMENT_V2_GPU_A10 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_SEGMENT_V2_GPU_A10',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_SEGMENT_V2_GPU_A10.py
    生成压测数据：
        python FEATURE_VIS_IMG_SEGMENT_V2_GPU_A10.py GEN_STRESS_DATA
    """
