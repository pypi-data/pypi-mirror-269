...
Brief:
@Author: bairuibin
@Date:   2020-04-26 13:20:40
@Filename: FEATURE_VIS_IMG_OCR_CPU_DRIVING_BACK_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_OCR_CPU_DRIVING_BACK_V1 demo  
    """
    def prepare_request(self, data):
        ...
        输出：
            返回算子的输入数据
        """
        feat_args = "object_type=dl_fuye&image=" + base64.b64encode(data['image'])
        req_data = {
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_OCR_CPU_DRIVING_BACK_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_OCR_CPU_DRIVING_BACK_V1.py 
    生成压测数据：
        python FEATURE_VIS_IMG_OCR_CPU_DRIVING_BACK_V1.py GEN_STRESS_DATA
    """
