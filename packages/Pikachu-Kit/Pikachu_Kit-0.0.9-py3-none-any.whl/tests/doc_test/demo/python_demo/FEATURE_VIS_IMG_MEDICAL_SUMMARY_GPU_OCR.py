...
##########################################################################
"""
Brief:FEATURE_VIS_IMG_MEDICAL_SUMMARY_GPU_OCR Demo, 以及压测数据生成的DEMO
Author: liqiaoyi(liqiaoyi@baidu.com)
Date: 2020-11-11
Filename: FEATURE_VIS_IMG_MEDICAL_SUMMARY_GPU_OCR.py
"""
import os
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_MEDICAL_SUMMARY_GPU_OCR demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_MEDICAL_SUMMARY_GPU_OCR',
