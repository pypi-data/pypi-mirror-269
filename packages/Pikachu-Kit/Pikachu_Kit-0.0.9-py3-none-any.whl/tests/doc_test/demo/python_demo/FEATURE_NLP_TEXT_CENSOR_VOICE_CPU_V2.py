...
################################################################################
"""
Brief:FEATURE_NLP_TEXT_CENSOR_VOICE_CPU_V2 Demo, 以及压测数据生成的DEMO
Author: caoyuhui(caoyuhui@baidu.com)
Date: 2022-7-26
Filename: FEATURE_NLP_TEXT_CENSOR_VOICE_CPU_V2.py
"""
import json
import os
import random
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_NLP_TEXT_CENSOR_CPU_V2 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_NLP_TEXT_CENSOR_VOICE_CPU_V2',
