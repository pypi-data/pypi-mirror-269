...
################################################################################
"""
Brief:FEATURE_VIS_IMG_PORNFILTER_GPU_BLUED_POC Demo, 以及压测数据生成的DEMO
Author: zhouzhichao01 (wuyongjun01@baidu.com)
Date: 2020-07-10
Filename: FEATURE_VIS_IMG_PORNFILTER_GPU_BLUED_POC.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_PORNFILTER_GPU_BLUED_POC demo  
    """
    def prepare_request(self, data):
        ...
        new_data = {
                ...
                "classify_type": [
                    {
                        "type_name": "antiporn_20class_poc",
                    }
                ]
        }
        return json.dumps({
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_PORNFILTER_GPU_BLUED_POC',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_PORNFILTER_GPU_BLUED_POC.py 
    生成压测数据：
        python FEATURE_VIS_IMG_PORNFILTER_GPU_BLUED_POC.py GEN_STRESS_DATA
    """
