...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_OCR_GPU_BARCODE demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_OCR_GPU_BARCODE',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_OCR_GPU_BARCODE.py 
    生成压测数据：
        python FEATURE_VIS_IMG_OCR_GPU_BARCODE.py GEN_STRESS_DATA
    """
