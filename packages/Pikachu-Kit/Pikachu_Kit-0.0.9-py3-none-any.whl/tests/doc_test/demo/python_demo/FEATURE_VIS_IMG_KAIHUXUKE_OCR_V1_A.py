...
################################################################################
"""
Brief:FEATURE_VIS_IMG_KAIHUXUKE_OCR_V1_A Demo, 以及压测数据生成的DEMO
Author: chenyulan(chenyulan@baidu.com)
Date: 2024-01-19
Filename: FEATURE_VIS_IMG_KAIHUXUKE_OCR_V1_A.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_KAIHUXUKE_OCR_V1_A demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_KAIHUXUKE_OCR_V1_A',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_KAIHUXUKE_OCR_V1_A.py 
    生成压测数据：
        python FEATURE_VIS_IMG_KAIHUXUKE_OCR_V1_A.py GEN_STRESS_DATA
    """
