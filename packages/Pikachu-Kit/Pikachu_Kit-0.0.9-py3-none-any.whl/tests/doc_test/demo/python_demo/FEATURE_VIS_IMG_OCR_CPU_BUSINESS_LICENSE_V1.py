...
################################################################################
"""
Brief:FEATURE_VIS_IMG_OCR_CPU_BUSINESS_LICENSE_V1 Demo, 以及压测数据生成的DEMO
Author: Wu Yongjun(wuyongjun01@baidu.com)
Date: 2020-03-14
Filename: FEATURE_VIS_IMG_OCR_CPU_BUSINESS_LICENSE_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_OCR_CPU_BUSINESS_LICENSE_V1 demo
    """
    def prepare_request(self, data_dict):
        ...
        data += "&fromproduct=graphtransplugin"
        data += "&is_detect_risk=true"
        data += "&is_detect_rectify=false"
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_OCR_CPU_BUSINESS_LICENSE_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_OCR_CPU_BUSINESS_LICENSE_V1.py
    生成压测数据：
        python FEATURE_VIS_IMG_OCR_CPU_BUSINESS_LICENSE_V1.py GEN_STRESS_DATA
    """
