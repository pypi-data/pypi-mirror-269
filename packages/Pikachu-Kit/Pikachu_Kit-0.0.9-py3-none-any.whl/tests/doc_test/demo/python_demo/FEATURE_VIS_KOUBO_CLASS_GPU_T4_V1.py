...
################################################################################
"""
Brief: FEATURE_VIS_KOUBO_CLASS_GPU_T4_V1 Demo
Filename: FEATURE_VIS_KOUBO_CLASS_GPU_T4_V1.py
"""
...
class FeatureVisKouboClassGPUT4V1(XvisionDemo):
    """
    FEATURE_VIS_KOUBO_CLASS_GPU_T4_V1 Demo
    """
...
def feature_calculate():
    ...
    featureDemo = FeatureVisKouboClassGPUT4V1()
    # 生成算子输入
    data = {
        'video_url': input_url
    }
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_KOUBO_CLASS_GPU_T4_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行:
        python FEATURE_VIS_KOUBO_CLASS_GPU_T4_V1.py
    生成压测数据：
        python FEATURE_VIS_KOUBO_CLASS_GPU_T4_V1.py GEN_STRESS_DATA
    """
