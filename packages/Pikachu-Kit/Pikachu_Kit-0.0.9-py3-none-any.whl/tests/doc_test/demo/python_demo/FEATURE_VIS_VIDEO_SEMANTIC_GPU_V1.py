...
################################################################################
"""
Brief: FEATURE_VIS_VIDEO_SEMANTIC_GPU_V1 Demo, 以及压测数据生成的 Demo
Filename: FEATURE_VIS_VIDEO_SEMANTIC_GPU_V1.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_VIDEO_SEMANTIC_GPU_V1 Demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_VIDEO_SEMANTIC_GPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行:
        python FEATURE_VIS_VIDEO_SEMANTIC_GPU_V1.py 
    生成压测数据:
        python FEATURE_VIS_VIDEO_SEMANTIC_GPU_V1.py GEN_STRESS_DATA
    """
