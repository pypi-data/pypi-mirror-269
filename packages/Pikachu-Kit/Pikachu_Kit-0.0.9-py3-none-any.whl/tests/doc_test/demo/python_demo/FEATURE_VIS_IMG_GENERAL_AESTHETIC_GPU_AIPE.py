...
################################################################################
"""
Brief:FEATURE_VIS_IMG_GENERAL_AESTHETIC_GPU_AIPE Demo, 以及压测数据生成的DEMO
Author: wuyongjun01(wuyongjun01@baidu.com)
Date: 2019-11-20
Filename: FEATURE_VIS_IMG_GENERAL_AESTHETIC_GPU_AIPE.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_GENERAL_AESTHETIC_GPU_AIPE demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_GENERAL_AESTHETIC_GPU_AIPE',
    ...
    print "X" * 80
    pprint(json.loads(res_data))
    # print base64.b64decode(json.loads(value)["result"])
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_GENERAL_AESTHETIC_GPU_AIPE.py 
    生成压测数据：
        python FEATURE_VIS_IMG_GENERAL_AESTHETIC_GPU_AIPE.py GEN_STRESS_DATA
    """
