...
# -*- coding: utf-8 -*-
# @Author: huangjiayan
# @Date:   2021-03-10 10:21:00
"""
Brief:FEATURE_KG_TEXT_CAUSAL_EXTRACT_GPU_V1 Demo, 以及压测数据生成的DEMO
Author: huangjiayan(huangjiayan@baidu.com)
Date: 2021-03-10
Filename: FEATURE_KG_TEXT_CAUSAL_EXTRACT_GPU_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_KG_TEXT_CAUSAL_EXTRACT_GPU_V1 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_KG_TEXT_CAUSAL_EXTRACT_GPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_KG_TEXT_CAUSAL_EXTRACT_GPU_V1.py
    生成压测数据：
        python FEATURE_KG_TEXT_CAUSAL_EXTRACT_GPU_V1.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        #特征计算Demo
        feature_calculate(["由于主营业务不佳，公司业绩在上市(2012年8月1日)后第三年就开始走下坡路"])
