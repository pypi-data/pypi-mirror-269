...
"""
Brief: FEATURE_KG_TEXT_OPINIONEXTRA_GPU_V3 Demo, 以及压测数据生成的DEMO
Author: huangyanhui(huangyanhui@baidu.com)
Date: 2021-12-10
Filename: FEATURE_KG_TEXT_OPINIONEXTRA_GPU_V3.py
"""
...
class FeatureReq(XvisionDemo):
    """
        FEATURE_KG_TEXT_OPINIONEXTRA_GPU_V3 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_KG_OPINIONEXTRA_GPU_V3',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_KG_TEXT_OPINIONEXTRA_GPU_V3.py
    生成压测数据：
        python FEATURE_KG_TEXT_OPINIONEXTRA_GPU_V3.py GEN_STRESS_DATA
    """
    op_type = sys.argv[1] if len(sys.argv) == 2 else 'FEATURE_CALCULATE'
    if op_type == 'GEN_STRESS_DATA':
        # 生成压测数据
        gen_stress_data('./text_dir/topicjudge_testcase.mini.txt')
    else:
        # 文本主题生成Demo
        test_data = {
            "title": "测试标题",
            "content": "中新网江苏新闻7月2日电 7月1日，在喜庆的音乐声中，江苏沛县汉兴街道的10对新人肩并肩、手牵手，" + \
