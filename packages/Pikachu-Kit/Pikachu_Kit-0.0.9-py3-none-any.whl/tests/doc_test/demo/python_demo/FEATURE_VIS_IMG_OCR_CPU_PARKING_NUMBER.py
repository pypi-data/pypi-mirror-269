...
################################################################################
"""
Brief:FEATURE_VIS_IMG_OCR_CPU_PARKING_NUMBER Demo, 以及压测数据生成的DEMO
Author: Wu Yongjun(wuyongjun01@baidu.com)
Date: 2020-03-14
Filename: FEATURE_VIS_IMG_OCR_CPU_PARKING_NUMBER.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_OCR_CPU_PARKING_NUMBER demo
    """
    def prepare_request(self, imgData):
        ...
        data += "&locate_type=v2"
        # 必填，写死
        data += "&object_type=parking_number"
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_OCR_CPU_PARKING_NUMBER',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_OCR_CPU_PARKING_NUMBER.py
    生成压测数据：
        python FEATURE_VIS_IMG_OCR_CPU_PARKING_NUMBER.py GEN_STRESS_DATA
    """
