...
################################################################################
"""
Brief:FEATURE_VIS_IMG_CLARITY_XPU_WANGPAN demo, 以及压测数据生成的DEMO
Author: wuyongjun01(wuyongjun01@baidu.com)
Date: 2020-05-07
Filename: FEATURE_VIS_IMG_CLARITY_XPU_WANGPAN.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_CLARITY_XPU_WANGPAN demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_CLARITY_XPU_WANGPAN',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_CLARITY_XPU_WANGPAN.py 
    生成压测数据：
        python FEATURE_VIS_IMG_CLARITY_XPU_WANGPAN.py GEN_STRESS_DATA
    """
