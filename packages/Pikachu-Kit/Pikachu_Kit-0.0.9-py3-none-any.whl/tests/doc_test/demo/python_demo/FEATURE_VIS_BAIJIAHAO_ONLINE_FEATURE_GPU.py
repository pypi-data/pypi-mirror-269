...
################################################################################
"""
Brief: FEATURE_VIS_BAIJIAHAO_ONLINE_FEATURE_GPU.py Demo, 以及压测数据生成的DEMO
Author: weixiang01(weixiang01@baidu.com)
Date: 2022.4.22
Filename: FEATURE_VIS_BAIJIAHAO_ONLINE_FEATURE_GPU.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_BAIJIAHAO_ONLINE_FEATURE_GPU
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'resource_key': 'test_baijiahao',
        'auth_key': token,
        'business_name': job_name,
        'feature_name': 'FEATURE_VIS_IMG_BAIJIAHAO_ONLINE_GPU',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_BAIJIAHAO_ONLINE_FEATURE_GPU
    """
    # 特征计算Demo
