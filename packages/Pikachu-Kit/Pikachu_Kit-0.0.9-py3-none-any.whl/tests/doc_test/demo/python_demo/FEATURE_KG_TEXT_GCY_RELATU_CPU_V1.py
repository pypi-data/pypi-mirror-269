...
"""
Brief: FEATURE_KG_TEXT_GCY_RELATU_CPU_V1 Demo, 以及压测数据生成的DEMO
Date: 2021-08-25
Filename: FEATURE_KG_TEXT_GCY_RELATU_CPU_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
        FEATURE_KG_TEXT_GCY_RELATU_CPU_V1 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_KG_TEXT_GCY_RELATU_CPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_KG_TEXT_GCY_RELATU_CPU_V1.py
    生成压测数据：
        python FEATURE_KG_TEXT_GCY_RELATU_CPU_V1.py GEN_STRESS_DATA
    """
    op_type = sys.argv[1] if len(sys.argv) == 2 else 'FEATURE_CALCULATE'
    if op_type == 'GEN_STRESS_DATA':
        # 生成压测数据
        gen_stress_data('./text_dir/xvision_gongchengyuan_aw_server_testcase.txt')
    else:
        # 一行数据Demo
        test_data = {"query": "新闻", "api_path": "/gcy/correlation_list"}
