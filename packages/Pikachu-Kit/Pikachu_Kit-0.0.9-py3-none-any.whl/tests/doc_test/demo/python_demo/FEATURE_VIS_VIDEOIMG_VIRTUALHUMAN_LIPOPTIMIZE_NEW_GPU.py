...
################################################################################
"""
Brief:FEATURE_VIS_VIDEOIMG_VIRTUALHUMAN_LIPOPTIMIZE_NEW_GPU Demo, 以及压测数据生成的DEMO
Author: caijinhai(caijinhai@baidu.com)
Date: 2021-04-07
Filename: FEATURE_VIS_VIDEOIMG_VIRTUALHUMAN_LIPOPTIMIZE_NEW_GPU.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_VIDEOIMG_VIRTUALHUMAN_LIPOPTIMIZE_NEW_GPU demo  
    """
...
def feature_calculate(input_data):
    ...
    功能：特征计算
    输入：
        input_data: {'req_video_id': '', 'req_audio_id': ''}
    输出：
        图片特征
    """
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_VIDEOIMG_VIRTUALHUMAN_LIPOPTIMIZE_NEW_GPU.py 
    生成压测数据：
        python FEATURE_VIS_VIDEOIMG_VIRTUALHUMAN_LIPOPTIMIZE_NEW_GPU.py GEN_STRESS_DATA
    """
    ...
    # 合成视频
    feature_calculate({
        "req_video_id": "http://ar-fm.bj.bcebos.com/62b2a310976e231d274d69a4_9f61f20ae5b12cf6.mp4",
