...
################################################################################
"""
Brief:FEATURE_VIS_IMG_GENERAL_SCENCE_CLS_GPU_R200_V1 Demo, 以及压测数据生成的DEMO
Author: v_zhanghao52@baidu.com
Date: 2023-10-24
Filename: FEATURE_VIS_IMG_GENERAL_SCENCE_CLS_GPU_R200_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_GENERAL_SCENCE_CLS_GPU_R200_V1 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_GENERAL_SCENCE_CLS_GPU_R200_V1',
    ...
    ret = json.loads(base64.b64decode(result).decode('utf-8'))
    print(json.dumps(ret).decode("unicode-escape"))
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_GENERAL_SCENCE_CLS_GPU_R200_V1.py
    生成压测数据：
        python FEATURE_VIS_IMG_GENERAL_SCENCE_CLS_GPU_R200_V1.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        # 特征计算Demo
        # feature_calculate('./image_dir/FEATURE_VIS_IMG_ROAD_DROP_GPU_R200_V1.jpg')  # ./image_dir/img_file 本地图片
        feature_calculate('./image_dir/FEATURE_VIS_IMG_GENERAL_SCENCE_CLS_GPU_T4_V1.jpg')