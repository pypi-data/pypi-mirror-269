...
################################################################################
"""
Brief:FEATURE_VIS_IMG_OCR_GPU_SIGNET Demo, 以及压测数据生成的DEMO
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_OCR_GPU_SIGNET',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_OCR_GPU_SIGNET.py 
    生成压测数据：
        python FEATURE_VIS_IMG_OCR_GPU_SIGNET.py GEN_STRESS_DATA
    """
