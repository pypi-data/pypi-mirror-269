...
################################################################################
"""
Brief:FEATURE_VIS_IMG_WATERMARK_GPU_V6_1_0 Demo, 以及压测数据生成的DEMO
Author: zhuruolin(zhuruolin@baidu.com)
Date: 2022-01-06
Filename: FEATURE_VIS_IMG_WATERMARK_GPU_V6_1_0.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_WATERMARK_GPU_V6_1_0 demo
    """

    def prepare_request(self, data):
        """
        功能：构建算子的输入数据 V6.1.0, json版
        输入：
            data：dict类型，算子处理对象image以及必须的额外字段
        输出：
        """
        ...
        texts = [
            ...
            {
                "key": "filter_subtitle",
                "value": "1",  # default is '0': keep subtitle; '1': remove subtitle
            },
        ]
        ...
        feature_request = {
            "query_sign": "query_sign_example",  # optiinal
            "image": image,
            "info": query_info,
        }
        ...
        return json.dumps({
            ...
            'cmdid': '123',
            'clientip': '0.0.0.0',
            'data': base64.b64encode(json.dumps(feature_request)),
        })
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_WATERMARK_GPU_V6_1_0',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_WATERMARK_GPU_V6_1_0.py
    生成压测数据：
        python FEATURE_VIS_IMG_WATERMARK_GPU_V6_1_0.py GEN_STRESS_DATA
    """
