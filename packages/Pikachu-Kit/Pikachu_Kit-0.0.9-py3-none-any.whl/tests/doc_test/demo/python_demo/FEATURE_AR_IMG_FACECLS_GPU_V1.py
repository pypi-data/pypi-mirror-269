...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_AR_IMG_FACECLS_GPU_V1',
...
if __name__ == '__main__':
    ...
    if op_type == 'GEN_STRESS_DATA':
        # 生成压测词表
        input_data = {
            "image": "./image_dir/FEATURE_AR_IMG_FACECLS_GPU_V1/img/",
            "gender": "female"
        }
        ...
        # 特征计算Demo
        input_data = {
            "image": "./image_dir/FEATURE_AR_IMG_FACECLS_GPU_V1/img/woman20.jpg",
            "gender": "female"
        }
