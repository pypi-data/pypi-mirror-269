...
################################################################################
"""
Brief:FEATURE_VIS_IMG_TERROR_GPU_V12 Demo, 以及压测数据生成的DEMO
Author: RongKang (rongkang@baidu.com)
Date: 2021-06-01
Filename: FEATURE_VIS_IMG_TERROR_GPU_V12.py
"""
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_TERROR_GPU_V12',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_TERROR_GPU_V12.py 
    生成压测数据：
        python FEATURE_VIS_IMG_TERROR_GPU_V12.py GEN_STRESS_DATA
    """
