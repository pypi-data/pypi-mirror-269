...
################################################################################
"""
Brief:FEATURE_VIS_IMG_IDG_ROAD_WARNING_COLUMN_DUMP_GPU_T4_V1 Demo, 以及压测数据生成的DEMO
Author: v_chenhaonan01@baidu.com
Date: 2022-10-14
Filename: FEATURE_VIS_IMG_IDG_ROAD_WARNING_COLUMN_DUMP_GPU_T4_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_IDG_ROAD_WARNING_COLUMN_DUMP_GPU_T4_V1 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_IDG_ROAD_WARNING_COLUMN_DUMP_GPU_T4_V1',
...
if __name__ == '__main__':
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        # 特征计算Demo
        feature_calculate('./image_dir/FEATURE_VIS_IMG_IDG_ROAD_WARNING_COLUMN_DUMP_GPU_T4_V1.jpg')  # ./image_dir/img_file 本地图片
