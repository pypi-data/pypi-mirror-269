...
"""
Brief:FEATURE_VIS_IMG_DENOISE_GPU Demo, 以及压测数据生成的DEMO
Author: wuwenhao01
Date: 2021-03-22
Filename: FEATURE_VIS_IMG_DENOISE_GPU.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_DENOISE_GPU demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_DENOISE_GPU',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_DENOISE_GPU.py 
    生成压测数据：
        python FEATURE_VIS_IMG_DENOISE_GPU.py GEN_STRESS_DATA
    """
