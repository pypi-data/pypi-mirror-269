...
################################################################################
"""
Brief:FEATURE_NLP_MEG_TEXT_CENSOR_CPU Demo, 以及压测数据生成的DEMO
Author: caoyuhui(caoyuhui@baidu.com)
Date: 2021-8-4
Filename: FEATURE_NLP_MEG_TEXT_CENSOR_CPU.py
"""
import json
import os
import random
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_NLP_MEG_TEXT_CENSOR_CPU demo
    """
    ...
    def prepare_request(self, data):
        ...
        json_data = {
            ...
            "config": {
                "labels": ["1", "2", "3", "4", "5", "6"],
                "sub_labels":{"4": ["1", "2"]},
                "porn_ensemble": "weight_sum",
                "porn_ensemble_weight": [0.8, 0.2]
            }
        }
        request_data = {
            "appid": "123456",
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_NLP_MEG_TEXT_CENSOR_CPU',
