...
################################################################################
"""
Brief:FEATURE_VIS_IMG_WATERMARK_GPU_V6_A10 Demo, 以及压测数据生成的DEMO
Author: zhuruolin(zhuruolin@baidu.com)
Date: 2021-06-03
Filename: FEATURE_VIS_IMG_WATERMARK_GPU_V6_A10.py
"""
...
import os
import random
from proto.FEATURE_VIS_IMG_WATERMARK_GPU_V6 import imgfeature_pb2
from proto.FEATURE_VIS_IMG_WATERMARK_GPU_V6.protobuf_to_dict import protobuf_to_dict


class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_WATERMARK_GPU_V6_A10 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_WATERMARK_GPU_V6_A10',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_WATERMARK_GPU_V6_A10.py
    生成压测数据：
        python FEATURE_VIS_IMG_WATERMARK_GPU_V6_A10.py GEN_STRESS_DATA
    """
