...
################################################################################
"""
Brief:FEATURE_AR_VIDEO_3DBODYPROCESS_GPU_V1 Demo, 以及压测数据生成的DEMO
Author: lihaowen01
Date: 2022-03-09
Filename: FEATURE_AR_VIDEO_3DBODYPROCESS_GPU_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_AR_VIDEO_3DBODYPROCESS_GPU_V1 demo
    """
...
def feature_calculate(input_data):
    ...
    xvision_data = {
            ...
            'feature_name': 'FEATURE_AR_VIDEO_3DBODYPROCESS_GPU_V1',           # 算子名
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_AR_VIDEO_3DBODYPROCESS_GPU_V1.py
    生成压测数据：
        python FEATURE_AR_VIDEO_3DBODYPROCESS_GPU_V1.py GEN_STRESS_DATA
    """
    op_type = sys.argv[1] if len(sys.argv) == 2 else 'FEATURE_CALCULATE'
    if op_type == 'GEN_STRESS_DATA':
        #生成压测词表
        gen_stress_data('./video_url_dir/FEATURE_AR_VIDEO_3DBODYPROCESS_GPU_V1/video.txt') #./image_dir/ 是本地的图片数据,生成压测数据需要把产品线的数据放到image_dir下边,一张图片一个文件
    else:
        #特征计算Demo
        test_video_url = "https://ar-fm.cdn.bcebos.com/ar/dance1.mp4"
