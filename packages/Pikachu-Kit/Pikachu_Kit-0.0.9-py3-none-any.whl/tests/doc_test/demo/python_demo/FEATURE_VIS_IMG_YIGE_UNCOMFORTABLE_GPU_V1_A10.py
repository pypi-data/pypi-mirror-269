...
################################################################################
"""
Brief:FEATURE_VIS_IMG_DELOGO_YOUJIA_GPU_V1_A30 Demo, 以及压测数据生成的DEMO
Author: zhenghe01
Date: 2022-08-09
Filename: FEATURE_VIS_IMG_YIGE_UNCOMFORTABLE_GPU_V1_A10.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_YIGE_UNCOMFORTABLE_GPU_V1_A10 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_YIGE_UNCOMFORTABLE_GPU_V1_A10',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_YIGE_UNCOMFORTABLE_GPU_V1_A10.py
    生成压测数据：
        python FEATURE_VIS_IMG_YIGE_UNCOMFORTABLE_GPU_V1_A10.py GEN_STRESS_DATA
    """
