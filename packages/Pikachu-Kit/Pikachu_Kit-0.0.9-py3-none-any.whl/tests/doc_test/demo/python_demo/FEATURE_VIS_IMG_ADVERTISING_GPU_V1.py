...
################################################################################
"""
Brief:FEATURE_VIS_IMG_ADVERTISING_GPU_V1 Demo, 以及压测数据生成的DEMO
Author: zhuruolin(zhuruolin@baidu.com)
Date: 2022-01-06
Filename: FEATURE_VIS_IMG_ADVERTISING_GPU_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_ADVERTISING_GPU_V1 demo
    """
    def prepare_request(self, data):
        """
        功能：构建算子的输入数据 V1.0.0, json版
        输入：
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_ADVERTISING_GPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_ADVERTISING_GPU_V1.py
    生成压测数据：
        python FEATURE_VIS_IMG_ADVERTISING_GPU_V1.py GEN_STRESS_DATA
    """
