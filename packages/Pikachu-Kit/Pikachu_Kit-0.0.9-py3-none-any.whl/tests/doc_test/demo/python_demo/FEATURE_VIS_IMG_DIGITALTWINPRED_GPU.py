...
################################################################################
"""
Brief:FEATURE_VIS_IMG_DIGITALTWINPRED_GPU Demo, 以及压测数据生成的DEMO
Author: wanghui48(wanghui48@baidu.com)
Date: 2023-10-25
Filename: FEATURE_VIS_IMG_DIGITALTWINPRED_GPU.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_DIGITALTWINPRED_GPU demo  
    """
    def prepare_request(self, data):
        ...
        """
        request_data = {
            "action": "digitaltwin_pred",  # 固定值
            "task_id": "1111",
            "uuid": "1111",
            "template_image_urls": 
                ["http://12312/6.jpg",
                "http://1231321/7.jpg"],
            "user_image_urls": ["http://12312312/liuyifei.jpg"],
...
def feature_calculate(input_data):
    ...
    job_name = ""  # 申请的作业名
    token = ""  # 作业的token
    feature_name = 'FEATURE_VIS_IMG_DIGITALTWINPRED_GPU'
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_DIGITALTWINPRED_GPU.py 
    """
