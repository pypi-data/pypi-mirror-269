...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_BAD_BEHAVIOR_RECOGNITION_GPU_V1 demo
    """
    def prepare_request(self, imgData):
        ...
        #"type_name": "bad_behavior", 对应分类的具体标签如下：
        # 0正常  1真实吸烟  2卡通吸烟  3毒品  4真实喝酒  5卡通喝酒  6赌博 

        classifytype1.type_name = 'bad_behavior'
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_BAD_BEHAVIOR_RECOGNITION_GPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_BAD_BEHAVIOR_RECOGNITION_GPU_V1.py
    生成压测数据：
        python FEATURE_VIS_IMG_BAD_BEHAVIOR_RECOGNITION_GPU_V1.py GEN_STRESS_DATA
    """
