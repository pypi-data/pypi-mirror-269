...
################################################################################
"""
Brief:FEATURE_VIS_IMG_FEATURE_FRAME_GPU_ONLINE_V3 Demo, 以及压测数据生成的DEMO
Author: xieshuai(xieshuai@baidu.com)
Date: 2021-09-10
Filename: FEATURE_VIS_IMG_FEATURE_FRAME_GPU_ONLINE_V3.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_FEATURE_FRAME_GPU_ONLINE_V3 demo
    """
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_FEATURE_FRAME_GPU_ONLINE_V3.py
    生成压测数据：
        python FEATURE_VIS_IMG_FEATURE_FRAME_GPU_ONLINE_V3.py GEN_STRESS_DATA
    """
