...
################################################################################
"""
Brief:FEATURE_VIS_IMG_SELFIE2PIXEL_GPU_V1_ENCRYPTED Demo, 以及压测数据生成的DEMO
Author: lifu(lifu@baidu.com)
Date: 2020-09-14
Filename: FEATURE_VIS_IMG_SELFIE2PIXEL_GPU_V1_ENCRYPTED.py 
"""
...
class FeatureReq(XvisionDemoEnc):
    """
    FEATURE_VIS_IMG_SELFIE2PIXEL_GPU_V1_ENCRYPTED demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_SELFIE2PIXEL_GPU_V1_ENCRYPTED'
    }
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_SELFIE2PIXEL_GPU_V1_ENCRYPTED.py 
    生成压测数据：
        python FEATURE_VIS_IMG_SELFIE2PIXEL_GPU_V1_ENCRYPTED.py GEN_STRESS_DATA
    """
