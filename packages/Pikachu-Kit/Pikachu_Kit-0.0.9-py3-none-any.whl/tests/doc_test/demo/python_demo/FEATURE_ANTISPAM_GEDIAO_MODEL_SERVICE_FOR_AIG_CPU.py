...
################################################################################
"""
Brief:FEATURE_ANTISPAM_GEDIAO_MODEL_SERVICE_FOR_AIG_CPU Demo, 以及压测数据生成的DEMO
Author: hupeng08(hupeng08@baidu.com)
Date: 2022-01-04
Filename: FEATURE_ANTISPAM_GEDIAO_MODEL_SERVICE_FOR_AIG_CPU.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_ANTISPAM_GEDIAO_MODEL_SERVICE_FOR_AIG_CPU demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_ANTISPAM_GEDIAO_MODEL_SERVICE_FOR_AIG_CPU',
...
def main():
    ...
    main
    简单测试执行：
        python2 FEATURE_ANTISPAM_GEDIAO_MODEL_SERVICE_FOR_AIG_CPU.py 
    生成压测数据：
        python2 FEATURE_ANTISPAM_GEDIAO_MODEL_SERVICE_FOR_AIG_CPU.py GEN_STRESS_DATA
    使用标准输入审核数据执行：
        echo "今天天气如何" | python2 FEATURE_ANTISPAM_GEDIAO_MODEL_SERVICE_FOR_AIG_CPU.py STD_INPUT_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        for line in sys.stdin:
            ...
            input_info = {"check_types": ["illegal"], "check_texts": text_list}
