...
@Date:   2020-03-13
@Filename: FEATURE_VIS_IMG_LANDMARK_GPU_V3.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_LANDMARK_GPU_V3 demo
    """
    def prepare_request(self, data):
        ...
        req_data = {
            ...
            "request_id": random.randint(1000000, 100000000),
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_LANDMARK_GPU_V3',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_LANDMARK_GPU_V3.py
    生成压测数据：
        python FEATURE_VIS_IMG_LANDMARK_GPU_V3.py GEN_STRESS_DATA
    """
