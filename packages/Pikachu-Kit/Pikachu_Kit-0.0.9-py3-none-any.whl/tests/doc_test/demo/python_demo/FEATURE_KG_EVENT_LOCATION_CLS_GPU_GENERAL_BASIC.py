...
"""
Brief:FEATURE_KG_EVENT_LOCATION_CLS_GPU_GENERAL_BASIC Demo, 以及压测数据生成的DEMO
Author: huangjiayan(huangjiayan@baidu.com)
Date: 2021-06-16
Filename: FEATURE_KG_EVENT_LOCATION_CLS_GPU_GENERAL_BASIC.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_KG_EVENT_LOCATION_CLS_GPU_GENERAL_BASIC demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_KG_EVENT_LOCATION_CLS_GPU_GENERAL_BASIC',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_KG_EVENT_LOCATION_CLS_GPU_GENERAL_BASIC.py
    生成压测数据：
        python FEATURE_KG_EVENT_LOCATION_CLS_GPU_GENERAL_BASIC.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        #特征计算Demo
        feature_calculate([[u'北京举行游泳比赛', u'北京']])
