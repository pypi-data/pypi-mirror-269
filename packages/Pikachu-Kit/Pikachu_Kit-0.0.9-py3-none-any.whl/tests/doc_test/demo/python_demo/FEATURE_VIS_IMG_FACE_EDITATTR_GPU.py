...
################################################################################
"""
FEATURE_VIS_IMG_FACE_EDITATTR_GPU Demo, 以及压测数据生成的DEMO
"""
import base64
import json
import os
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_FACE_EDITATTR_GPU demo
    """
    ...
    def prepare_request(self, data):
        ...
        输出：
            返回算子的输入数据
        """
        request_str = "object_type=edit_faceattr&action=to_kid&face_location=&age=22&gender=female&image=" \
...
def feature_calculate(input_data):
    ...
    job_name = ""  # 申请的作业名
    token = ""  # 作业的token
    feature_name = "FEATURE_VIS_IMG_FACE_EDITATTR_GPU"
...
if __name__ == '__main__':
    ...
    if op_type == 'GEN_STRESS_DATA':
        #生成压测词表
        gen_stress_data('./image_dir/FEATURE_VIS_IMG_LANDMARK201_GPU')  #./image_dir/ 是本地的图片数据
    else:
        #特征计算Demo
