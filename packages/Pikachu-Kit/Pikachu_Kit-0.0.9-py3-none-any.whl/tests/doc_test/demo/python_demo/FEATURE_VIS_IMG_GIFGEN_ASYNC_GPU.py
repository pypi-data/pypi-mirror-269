...
################################################################################
"""
Brief:FEATURE_VIS_IMG_GIFGEN_ASYNC_GPU Demo, 以及压测数据生成的DEMO
Author: wuye03(wuye03@baidu.com)
Date: 2023-05-31
Filename: FEATURE_VIS_IMG_GIFGEN_ASYNC_GPU.py
Note: before you  execute "python2 FEATURE_VIS_IMG_GIFGEN_ASYNC_GPU.py", you need execute "python3 callback.py" to launch a local server to receive the return json. As for "callback.py",please contact wuye03
"""
