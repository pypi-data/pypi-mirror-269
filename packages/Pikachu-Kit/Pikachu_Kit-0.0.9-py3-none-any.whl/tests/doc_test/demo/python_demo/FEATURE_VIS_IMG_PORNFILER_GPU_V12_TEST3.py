...
################################################################################
"""
Brief:FEATURE_VIS_IMG_PORNFILER_GPU_V12_TEST3 Demo, 以及压测数据生成的DEMO
Author: v_qiaozhiqi (v_qiaozhiqi@baidu.com)
Date: 2020-10-13
Filename: FEATURE_VIS_IMG_PORNFILER_GPU_V12_TEST3.py
"""
import os
import sys
import json
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_PORNFILER_GPU_V12_TEST3 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_PORNFILER_GPU_V12_TEST3',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_PORNFILER_GPU_V12_TEST3.py
    生成压测数据：
        python FEATURE_VIS_IMG_PORNFILER_GPU_V12_TEST3.py GEN_STRESS_DATA
    """
