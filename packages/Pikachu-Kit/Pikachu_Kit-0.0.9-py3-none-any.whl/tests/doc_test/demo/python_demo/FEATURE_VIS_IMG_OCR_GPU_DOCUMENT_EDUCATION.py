...
Date: 2022-04-06
Filename: FEATURE_VIS_IMG_OCR_GPU_DOCUMENT_EDUCATION.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_OCR_GPU_DOCUMENT_EDUCATION demo  
    """
    def prepare_request(self, data):
        ...
        输出：
            返回算子的输入数据
        """
        new_data = "object_type=general_edu&" \
                   + "recg_formula=true&" \
                   + "simplify_latex=true&" \
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_OCR_GPU_DOCUMENT_EDUCATION',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_OCR_GPU_DOCUMENT_EDUCATION.py 
    生成压测数据：
        python FEATURE_VIS_IMG_OCR_GPU_DOCUMENT_EDUCATION.py GEN_STRESS_DATA
    """
