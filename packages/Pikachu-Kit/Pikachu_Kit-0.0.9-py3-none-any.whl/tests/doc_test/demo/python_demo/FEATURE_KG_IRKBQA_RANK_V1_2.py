...
# coding=utf-8
"""
Author: sunyu32@baidu.com
since: 2022-06-11 19:48:39
LastTime: 2022-06-11 19:48:39
LastAuthor: sunyu32@baidu.com
message: FEATURE_KG_IRKBQA_RANK_V1_2 Demo, 以及压测数据生成的DEMO
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_KG_IRKBQA_RANK_V1_2',
...
def gen_stress_data(input_file):
    ...
    功能：生成压测数据
    输入：
        input_file:待打分的SPO文本，json 形式的 dict, 每一行是一个json字符串
    输出：
        压测数据
    """
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_KG_TEXT_PKEYSIM_GPU_V1_A10.py
    生成压测数据：
        python FEATURE_KG_TEXT_PKEYSIM_GPU_V1_A10.py GEN_STRESS_DATA
    """
    op_type = sys.argv[1] if len(sys.argv) == 2 else 'FEATURE_CALCULATE'
    if op_type == 'GEN_STRESS_DATA':
        # 生成压测词表
        gen_stress_data('./text_dir/irkbqa_api_mock_data.10')
    else:
        # 特征计算Demo
        input = {
            "query": "清华大学占地面积", 
            "query_parsing": {
                "S": {"@value": "清华大学", "source_s": "清华大学", "bkid": "111764", "kgid": "01nsv529"}, 
                "P": None, 
                "status": 0
                }, 
            "meta": {},
            "rawbase_name":"online_wenda_entity_spoBaseOutput"
            }
