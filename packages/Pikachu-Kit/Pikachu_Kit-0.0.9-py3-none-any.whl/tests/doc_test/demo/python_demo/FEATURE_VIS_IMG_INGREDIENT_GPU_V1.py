...
################################################################################
"""
Brief:FEATURE_VIS_IMG_INGREDIENT_GPU_V1 Demo, 以及压测数据生成的DEMO
Author: gongzhenting(gongzhenting@baidu.com)
Date: 2021-01-25
Filename: FEATURE_VIS_IMG_INGREDIENT_GPU_V1.py
"""
...
import random
import commands
from proto.FEATURE_VIS_IMG_FLOWER_GPU_AIPE import general_classify_client_pb2
from proto.protobuf_to_dict import protobuf_to_dict


class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_INGREDIENT_GPU_V1 demo
    """
    ...
    def prepare_request_pb(self, imgData):
        ...
        classifytype1.type_name = 'ingredient'
        classifytype1.topnum = 5
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_INGREDIENT_GPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_INGREDIENT_GPU_V1.py
    生成压测数据：
        python FEATURE_VIS_IMG_INGREDIENT_GPU_V1.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        # 特征计算Demo
        feature_calculate('./image_dir/ingredient-test1.jpg')  # ./image_dir/img_file 本地图片
