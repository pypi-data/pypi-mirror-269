...
################################################################################
"""
Brief:FEATURE_VIS_IMG_POLITICS_7IN1_GPU_V1_A10 Demo, 以及压测数据生成的DEMO
Author: wangyanan15@baidu.com
Date: 2022-06-16
Filename: FEATURE_VIS_IMG_POLITICS_7IN1_GPU_V1_A10.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_POLITICS_7IN1_GPU_V1_A10 demo
    """
    ...
    def prepare_request(self, data):
        ...
        new_data = {
            ...
            "extra_info": json.dumps(
                # {"featureids": "politics,sensitiveflag,chinesemap, \
                #                 cartoon_politician,places2items"}),
                {"featureids": "politics,sensitiveflag,chinesemap,cartoon_politician,places2items"}),
        }
        return json.dumps({
            'appid': '123456',
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_POLITICS_7IN1_GPU_V1_A10',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_POLITICS_7IN1_GPU_V1_A10.py
    生成压测数据：
        python FEATURE_VIS_IMG_POLITICS_7IN1_GPU_V1_A10.py GEN_STRESS_DATA
    """
