...
##########################################################################
"""
Brief:FEATURE_VIS_IMG_MEDICAL_DETAIL_GPU_OCR Demo, 以及压测数据生成的DEMO
Author: liyulin(yulin03@baidu.com)
Date: 2021-03-20
Filename: FEATURE_VIS_IMG_MEDICAL_DETAIL_GPU_OCR.py
"""
import os
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_MEDICAL_DETAIL_GPU_OCR demo
    """
        ...
        return json.dumps(
            {
                ...
                'data': base64.b64encode(
                    "object_type=medical_detail_clinic&image=" +
                    base64.b64encode(
                        data['image'])),
            })
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_MEDICAL_DETAIL_GPU_OCR',
