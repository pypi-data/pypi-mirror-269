...
################################################################################
"""
Brief: FEATURE_VIS_IMG_BAD_BEHAVIOR_RECOGNITION_GPU_V3 Demo, 以及压测数据生成的DEMO
Author: Rong Kang(rongkang@baidu.com)
Date: 2021-05-12
Filename: FEATURE_VIS_IMG_BAD_BEHAVIOR_RECOGNITION_GPU_V3.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_BAD_BEHAVIOR_RECOGNITION_GPU_V3 demo
    """
    def prepare_request(self, imgData):
        ...
        # 0正常  1真实吸烟  2卡通吸烟  3毒品  4真实喝酒  5卡通喝酒  6赌博 7纹身
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_BAD_BEHAVIOR_RECOGNITION_GPU_V3',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_BAD_BEHAVIOR_RECOGNITION_GPU_V3.py
    生成压测数据：
        python FEATURE_VIS_IMG_BAD_BEHAVIOR_RECOGNITION_GPU_V3.py GEN_STRESS_DATA
    """
