...
################################################################################
"""
Brief:FEATURE_VIS_IMG_OCR_GPU_DRIVING_V0 Demo, 以及压测数据生成的DEMO
Author: Wu Yongjun(wuyongjun01@baidu.com)
Date: 2020-03-14
Filename: FEATURE_VIS_IMG_OCR_GPU_DRIVING_V0.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_OCR_GPU_DRIVING_V0 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_OCR_GPU_DRIVING_V0',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_OCR_GPU_DRIVING_V0.py
    生成压测数据：
        python FEATURE_VIS_IMG_OCR_GPU_DRIVING_V0.py GEN_STRESS_DATA
    """
