...
################################################################################
"""
Brief:FEATURE_VIS_IMG_ADCLS_GPU Demo, 以及压测数据生成的DEMO
Author: Feng Yuan(fengyuan01@baidu.com)
Date: 2020-12-24
Filename: FEATURE_VIS_IMG_ADCLS_GPU.py
"""
...
from proto.FEATURE_VIS_IMG_ADCLS_GPU import imgfeature_pb2


class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_ADCLS_GPU demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_ADCLS_GPU',
    ...
    if (("code" in res_data)
        ...
        if result['err_no'] != 0:
            ...
            for feaname in features:
                if feaname == 1400:
                    res_data = json.loads(features[feaname])
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_ADCLS_GPU.py
    生成压测数据：
        python FEATURE_VIS_IMG_ADCLS_GPU.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        # 特征计算Demo
        feature_calculate('./image_dir/FEATURE_VIS_IMG_ADCLS_GPU.jpg')  # ./image_dir/img_file 本地图片
