...
################################################################################
"""
Brief:FEATURE_IMG_FAMOUS_FACEREC_V1 Demo, 以及压测数据生成的DEMO
Author: Wu Yongjun(wuyongjun01@baidu.com), shangzhizhou
Date: 2020-06-18
Filename: FEATURE_IMG_FAMOUS_FACEREC_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_IMG_FAMOUS_FACEREC_V1 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_IMG_FAMOUS_FACEREC_V1',
    ...
    feature_data = json.dumps({
        ...
        "feature_list": [
            {"feature_name": "FEATURE_IMG_FAMOUS_FACEREC_V1"} # 算子名称
        ]
    })
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_IMG_FAMOUS_FACEREC_V1.py
    生成压测数据：
        python FEATURE_IMG_FAMOUS_FACEREC_V1.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        # 特征计算Demo
        feature_calculate('./image_dir/FEATURE_IMG_FAMOUS_FACEREC_V1.jpg')  # ./image_dir/img_file 本地图片
