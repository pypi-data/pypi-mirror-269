...
################################################################################
"""
Brief:FEATURE_VIS_IMG_10W_GPU Demo, 以及压测数据生成的DEMO
Author: zhangbin33(zhangbin33@baidu.com)
Date: 2021-02-02
Filename: FEATURE_VIS_IMG_GPU_10W.py
"""
from proto.FEATURE_VIS_IMG_10W_GPU import imgfeature_pb2
...
def feature_calculate(input_data):
    ...
    job_name = "STRESSJOBFEATURE_VIS_IMG_10W_GPU"
    token = "e6da94ce-420f-571c-ac2d-aee35d073a98"
    ...
    xvision_data = featureDemo.gen_xvision_data({
            ...
            'feature_name': 'FEATURE_VIS_IMG_10W_GPU',#算子名
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_GPU_10W.py
    生成压测数据：
        python FEATURE_VIS_IMG_GPU_10W.py GEN_STRESS_DATA
    """
