...
@Date:   2020-03-19
@Filename: FEATURE_VIS_IMG_GPU_TRANSLATION_V2.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_GPU_TRANSLATION_V2 demo
    """
    def prepare_request(self, data):
        ...
        params = {
            "feat_args": {
                "lang": "chn", #必选项  chn，中英混合；eng，纯英文
                "paragragh": 0, #不是必选项 是否输出段落信息，0不输出段落信息
                "detect_direction": 0, #不是必选项 是否进行方向判断，0不进行方向判断
                #"mask": "", #不是必选项 是否进行mask识别，mask图片的base64编码
            },
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_GPU_TRANSLATION_V2',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_GPU_TRANSLATION_V2.py
    生成压测数据：
        python FEATURE_VIS_IMG_GPU_TRANSLATION_V2.py GEN_STRESS_DATA
    """
