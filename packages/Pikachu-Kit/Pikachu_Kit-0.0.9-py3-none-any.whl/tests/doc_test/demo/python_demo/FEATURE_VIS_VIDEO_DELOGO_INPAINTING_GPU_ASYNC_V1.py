...
################################################################################
"""
Brief:FEATURE_VIS_VIDEO_DELOGO_INPAINTING_GPU_ASYNC_V1 Demo, 以及压测数据生成的DEMO
Author: zhenghe (zhenghe01@baidu.com)
Date: 2022-01-11
Filename: FEATURE_VIS_VIDEO_DELOGO_INPAINTING_GPU_ASYNC_V1.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_VIDEO_DELOGO_INPAINTING_GPU_ASYNC_V1 demo
    """
...
def feature_calculate(input_data):
    ...
    xvision_data = {
            ...
            'feature_name': 'FEATURE_VIS_VIDEO_DELOGO_INPAINTING_GPU_ASYNC_V1',           # 算子名
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_VIDEO_DELOGO_INPAINTING_GPU_ASYNC_V1.py
    """
    #特征计算Demo
