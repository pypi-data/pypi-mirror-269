...
################################################################################
"""
Brief:FEATURE_VIS_IMG_SKETCH2IMG_ANIME_GPU Demo, 以及压测数据生成的DEMO
Author: wuye(wuye03@baidu.com)
Date: 2023-07-26
Filename: FEATURE_VIS_IMG_SKETCH2IMG_ANIME_GPU.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_SKETCH2IMG_ANIME_GPU demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_SKETCH2IMG_ANIME_GPU',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_SKETCH2IMG_ANIME_GPU.py
    生成压测数据：
        python FEATURE_VIS_IMG_SKETCH2IMG_ANIME_GPU.py GEN_STRESS_DATA
    """
