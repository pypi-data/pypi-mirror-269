...
################################################################################
"""
Brief:FEATURE_NLP_TEXT_CTINKER_LIGHTDET_CPU_V02 Demo, 以及压测数据生成的DEMO
Author: v_zhouxuhui(v_zhouxuhui@baidu.com)
Date: 2022-11-30
Filename: FEATURE_NLP_TEXT_CTINKER_LIGHTDET_CPU_V02.py
"""
import json
import os
import random
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_NLP_TEXT_CTINKER_LIGHTDET_CPU_V02 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_NLP_TEXT_CTINKER_LIGHTDET_CPU_V02',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_NLP_TEXT_CTINKER_LIGHTDET_CPU_V02.py
    生成压测数据：
        python FEATURE_NLP_TEXT_CTINKER_LIGHTDET_CPU_V02.py GEN_STRESS_DATA
    """
