...
################################################################################
"""
Brief:FEATURE_VIS_IMG_INGREDIENT_GPU_AIPE Demo, 以及压测数据生成的DEMO
Author: Wu Yongjun(wuyongjun01@baidu.com)
Date: 2020-02-18
Filename: FEATURE_VIS_IMG_INGREDIENT_GPU_AIPE.py
"""
...
from proto.FEATURE_VIS_IMG_INGREDIENT_GPU_AIPE import general_classify_client_pb2
from proto.protobuf_to_dict import protobuf_to_dict


class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_INGREDIENT_GPU_AIPE demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_INGREDIENT_GPU_AIPE',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_INGREDIENT_GPU_AIPE.py
    生成压测数据：
        python FEATURE_VIS_IMG_INGREDIENT_GPU_AIPE.py GEN_STRESS_DATA
    """
