...
Brief:
@Author: yuanruiting
@Date:   2020-06-03 18:12:58
@Filename: FEATURE_VIS_PERSONPART_PARSING_GPU_V1.py
"""
...
from proto.FEATURE_VIS_PERSONPART_PARSING_GPU_V1 import personpart_service_pb2
from proto.protobuf_to_dict import protobuf_to_dict

class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_PERSONPART_PARSING_GPU_V1 demo
    """
    def prepare_request(self, imgData):
        ...
        Returns:
            data: protobuf
        """
        proto_data = personpart_service_pb2.PersonpartServiceRequest()
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_PERSONPART_PARSING_GPU_V1',
    ...
    if (("code" in res_data)
            ...
            # 解pb
            proto_result = personpart_service_pb2.PersonpartServiceResponse()
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_PERSONPART_PARSING_GPU_V1.py
    生成压测数据：
        python FEATURE_VIS_PERSONPART_PARSING_GPU_V1.py GEN_STRESS_DATA
    """
