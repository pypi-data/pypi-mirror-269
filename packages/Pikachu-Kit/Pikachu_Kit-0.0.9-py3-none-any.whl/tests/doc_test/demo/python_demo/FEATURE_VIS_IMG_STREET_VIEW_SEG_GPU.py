...
################################################################################
"""
Brief:FEATURE_VIS_IMG_STREET_VIEW_SEG_GPU Demo, 以及压测数据生成的DEMO
Author: chenkehua(chenkehua@baidu.com)
Date: 2022-11-21
Filename: FEATURE_VIS_IMG_STREET_VIEW_SEG_GPU.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_STREET_VIEW_SEG_GPU demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_STREET_VIEW_SEG_GPU',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_STREET_VIEW_SEG_GPU.py
    生成压测数据：
        python FEATURE_VIS_IMG_STREET_VIEW_SEG_GPU.py GEN_STRESS_DATA
    """
    op_type = sys.argv[1] if len(sys.argv) == 2 else 'FEATURE_CALCULATE'
    if op_type == 'GEN_STRESS_DATA':
        # 生成压测词表
        gen_stress_data('./image_dir/FEATURE_VIS_IMG_STREET_VIEW_SEG_GPU')  # ./image_dir/ 是本地的图片数据
    else:
        # 特征计算Demo
        feature_calculate('./image_dir/FEATURE_VIS_IMG_STREET_VIEW_SEG_GPU.jpg')  # ./image_dir/img_file 本地图片
