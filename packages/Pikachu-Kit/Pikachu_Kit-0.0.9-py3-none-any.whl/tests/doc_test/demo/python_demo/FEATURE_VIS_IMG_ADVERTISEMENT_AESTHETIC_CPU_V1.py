...
################################################################################
"""
Brief:FEATURE_VIS_IMG_ADVERTISEMENT_AESTHETIC_CPU_V1 Demo, 以及压测数据生成的DEMO
Author: Wu Yongjun(wuyongjun01@baidu.com)
Date: 2020-05-08
Filename: FEATURE_VIS_IMG_ADVERTISEMENT_AESTHETIC_CPU_V1.py
"""
...
from proto.FEATURE_VIS_IMG_ADVERTISEMENT_AESTHETIC_CPU_V1 import general_classify_client_pb2
from proto.protobuf_to_dict import protobuf_to_dict


class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_ADVERTISEMENT_AESTHETIC_CPU_V1 demo
    """
    def prepare_request(self, imgData):
        ...
        classifytype1.type_name = 'aesthetic'
        classifytype1.topnum = 3
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_ADVERTISEMENT_AESTHETIC_CPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_ADVERTISEMENT_AESTHETIC_CPU_V1.py
    生成压测数据：
        python FEATURE_VIS_IMG_ADVERTISEMENT_AESTHETIC_CPU_V1.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        # 特征计算Demo
        feature_calculate('./image_dir/FEATURE_VIS_IMG_GENERAL_AESTHETIC_GPU_V1.jpg')  # ./image_dir/img_file 本地图片
