...
################################################################################
"""
Brief:FEATURE_VIS_IMG_SENSITIVE_FLAG_GPU_BDES Demo, 以及压测数据生成的DEMO
Author: zhouzhichao01@baidu.com
Date: 2021-12-27
Filename: FEATURE_VIS_IMG_SENSITIVE_FLAG_GPU_BDES.py1
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_SENSITIVE_FLAG_GPU_BDES demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_SENSITIVE_FLAG_GPU_BDES',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_SENSITIVE_FLAG_GPU_BDES.py
    生成压测数据：
        python FEATURE_VIS_IMG_SENSITIVE_FLAG_GPU_BDES.py GEN_STRESS_DATA
    """
