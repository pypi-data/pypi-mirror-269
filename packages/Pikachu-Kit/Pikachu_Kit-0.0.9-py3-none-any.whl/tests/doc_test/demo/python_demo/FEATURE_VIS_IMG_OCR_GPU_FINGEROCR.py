...
################################################################################
"""
Brief:FEATURE_VIS_IMG_OCR_GPU_FINGEROCR Demo, 以及压测数据生成的DEMO
Author: wanghua11(wanghua11@baidu.com)
Date: 2019-11-22
Filename: FEATURE_VIS_IMG_OCR_GPU_FINGEROCR.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_OCR_GPU_FINGEROCR demo  
    """
    def prepare_request(self, data):
        ...
        输出：
            返回算子的输入数据
        """
        new_data = "object_type=finger_ocr&type=st_ocrapi_all&disp_line_poly=true&image=" \
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_OCR_GPU_FINGEROCR',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_OCR_GPU_FINGEROCR.py 
    生成压测数据：
        python FEATURE_VIS_IMG_OCR_GPU_FINGEROCR.py GEN_STRESS_DATA
    """
