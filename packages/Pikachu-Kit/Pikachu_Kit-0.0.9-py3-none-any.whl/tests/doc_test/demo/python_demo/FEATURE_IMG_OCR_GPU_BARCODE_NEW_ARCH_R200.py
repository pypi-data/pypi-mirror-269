...
Brief:
@Author: yuanruiting
@Date:   2020-03-30 19:19:41
@Filename: FEATURE_VIS_IMG_OCR_GPU_BARCODE.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_IMG_OCR_GPU_BARCODE_NEW_ARCH demo  
    """
    def prepare_request(self, data):
        ...
        输出：
            返回算子的输入数据
        """
        data = "object_type=barcode&image=" + base64.b64encode(data['image'])
        return json.dumps({
                    'appid': '123456',
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_IMG_OCR_GPU_BARCODE_NEW_ARCH',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_IMG_OCR_GPU_BARCODE_NEW_ARCH.py 
    生成压测数据：
        python FEATURE_IMG_OCR_GPU_BARCODE_NEW_ARCH.py GEN_STRESS_DATA
    """
