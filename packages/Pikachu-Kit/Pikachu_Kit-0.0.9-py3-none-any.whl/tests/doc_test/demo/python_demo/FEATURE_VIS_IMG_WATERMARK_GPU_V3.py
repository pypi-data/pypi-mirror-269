...
################################################################################
"""
Brief:FEATURE_VIS_IMG_WATERMARK_GPU_V3 Demo, 以及压测数据生成的DEMO
Author: fumingxin(fumingxin@baidu.com)
Date: 2019-08-24
Filename: FEATURE_VIS_IMG_WATERMARK_GPU_V3.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_WATERMARK_GPU_V3 demo
    """

    def prepare_request_v3(self, data):
        """
        功能：构建算子的输入数据
        输入：
        ...
        req_array = {
            ...
            'cmdid': '123',
            'clientip': clientip,
            'data': base64.b64encode(data['image']),
        }
...
def feature_calculate(input_data):
    ...
    # feature_data = feature_demo.prepare_request_v3(data)
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_WATERMARK_GPU_V3',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_WATERMARK_GPU_V3.py
    生成压测数据：
        python FEATURE_VIS_IMG_WATERMARK_GPU_V3.py GEN_STRESS_DATA
    """
