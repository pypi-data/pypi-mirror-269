...
################################################################################
"""
Brief:FEATURE_VIS_IMG_PLANT_GPU_V9 Demo, 以及压测数据生成的DEMO
Author: wuyongjun01(wuyongjun01@baidu.com)
Date: 2019-11-05
Filename: FEATURE_VIS_IMG_PLANT_GPU_V9.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_PLANT_GPU_V9 demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_PLANT_GPU_V9',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_PLANT_GPU_V9.py 
    生成压测数据：
        python FEATURE_VIS_IMG_PLANT_GPU_V9.py GEN_STRESS_DATA
    """
