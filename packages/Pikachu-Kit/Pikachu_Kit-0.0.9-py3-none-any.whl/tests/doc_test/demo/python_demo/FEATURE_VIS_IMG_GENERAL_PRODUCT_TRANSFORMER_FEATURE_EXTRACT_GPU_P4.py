...
# -*- coding: utf-8 -*-
"""
Brief:FEATURE_VIS_IMG_GENERAL_PRODUCT_TRANSFORMER_FEATURE_EXTRACT_GPU_P4 Demo, 以及压测数据生成的DEMO
Author: weixiang01(weixiang01@baidu.com)
Date: 2022-03-18
Filename: FEATURE_VIS_IMG_GENERAL_PRODUCT_TRANSFORMER_FEATURE_EXTRACT_GPU_P4.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_GENERAL_PRODUCT_TRANSFORMER_FEATURE_EXTRACT_GPU_P4 demo
    """
    def prepare_request(self, data):
        ...
        info_texts.value = 'deit_base_patch16_224_char'
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_GENERAL_PRODUCT_TRANSFORMER_FEATURE_EXTRACT_GPU_P4',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_GENERAL_PRODUCT_TRANSFORMER_FEATURE_EXTRACT_GPU_P4.py
    生成压测数据：
        python FEATURE_VIS_IMG_GENERAL_PRODUCT_TRANSFORMER_FEATURE_EXTRACT_GPU_P4.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        #特征计算Demo
        feature_calculate('./image_dir/product_img.jpg') #./image_dir/img_file 本地图片
