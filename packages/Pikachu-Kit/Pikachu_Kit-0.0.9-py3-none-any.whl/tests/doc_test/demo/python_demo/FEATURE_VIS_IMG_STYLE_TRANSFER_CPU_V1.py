...
################################################################################
"""
Brief:FEATURE_VIS_IMG_STYLE_TRANSFER_CPU_V1 Demo, 以及压测数据生成的DEMO
Author: chengang06(chengang06@baidu.com)
Date: 2019-08-26
Filename: FEATURE_VIS_IMG_STYLE_TRANSFER_CPU_V1.py
"""
import base64
import json
import os
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_STYLE_TRANSFER_CPU_V1 demo
    """
    ...
    def prepare_request(self, data):
        ...
        base_data['option'] = 'pencil'  # could be pencil or cartoon
        return json.dumps({
            'appid': '123456',
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_STYLE_TRANSFER_CPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_STYLE_TRANSFER_CPU_V1.py
    生成压测数据：
        python FEATURE_VIS_IMG_STYLE_TRANSFER_CPU_V1.py GEN_STRESS_DATA
    """
