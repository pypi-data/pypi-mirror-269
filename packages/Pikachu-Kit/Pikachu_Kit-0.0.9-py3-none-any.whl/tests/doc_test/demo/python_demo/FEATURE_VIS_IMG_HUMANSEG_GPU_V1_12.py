...
################################################################################
"""
Brief:FEATURE_VIS_IMG_HUMANSEG_GPU_V1_12 Demo, 以及压测数据生成的DEMO
Author: wuyongjun01(wuyongjun01@baidu.com)
Date: 2019-12-02
Filename: FEATURE_VIS_IMG_HUMANSEG_GPU_V1_12.py 
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_HUMANSEG_GPU_V1_12 demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_HUMANSEG_GPU_V1_12',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_HUMANSEG_GPU_V1_12.py 
    生成压测数据：
        python FEATURE_VIS_IMG_HUMANSEG_GPU_V1_12.py GEN_STRESS_DATA
    """
