...
################################################################################
"""
Brief:FEATURE_VIS_IMG_SELFIE2ANIME_DIFFUSION_GPU_A30 Demo, 以及压测数据生成的DEMO
Author: zhangqi44(zhangqi44@baidu.com)
Date: 2023-04-20
Filename: FEATURE_VIS_IMG_SELFIE2ANIME_DIFFUSION_GPU_A30.py 
"""
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_TEXT2IMG_TERABOX_GPU_A10',
