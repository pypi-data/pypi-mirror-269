...
################################################################################
"""
Brief:FEATURE_VIS_IMG_GENERAL_PORTRAIT_ENHANCE_GPU_V1 Demo, 以及压测数据生成的DEMO
Author: lifu(lifu@baidu.com)
Date: 2020-05-26
Filename: FEATURE_VIS_IMG_GENERAL_PORTRAIT_ENHANCE_GPU_V1.py 
"""
...
class FeatureReq(XvisionDemoEnc):
    """
    FEATURE_VIS_IMG_GENERAL_PORTRAIT_ENHANCE_GPU_V1 demo  
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_GENERAL_PORTRAIT_ENHANCE_GPU_V1',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_GENERAL_PORTRAIT_ENHANCE_GPU_V1.py 
    生成压测数据：
