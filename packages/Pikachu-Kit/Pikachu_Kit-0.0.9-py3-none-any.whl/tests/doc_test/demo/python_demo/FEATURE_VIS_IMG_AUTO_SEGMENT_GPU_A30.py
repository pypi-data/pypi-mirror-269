...
################################################################################
"""
Brief: FEATURE_VIS_IMG_AUTO_SEGMENT_GPU_A30 Demo, 以及压测数据生成的DEMO
Author: rongkang(rongkang@baidu.com)
Date: 2023-08-18
Filename: FEATURE_VIS_IMG_AUTO_SEGMENT_GPU_A30.py
"""
...
class FeatureReq(XvisionDemo):
    """
    FEATURE_VIS_IMG_AUTO_SEGMENT_GPU_A30 demo
    """
...
def feature_calculate(input_data):
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_AUTO_SEGMENT_GPU_A30',
...
if __name__ == '__main__':
    ...
    main
    特征计算执行：
        python FEATURE_VIS_IMG_AUTO_SEGMENT_GPU_A30.py
    生成压测数据：
        python FEATURE_VIS_IMG_AUTO_SEGMENT_GPU_A30.py GEN_STRESS_DATA
    """
    ...
    if op_type == 'GEN_STRESS_DATA':
        ...
        #特征计算Demo
        feature_calculate('./image_dir/FEATURE_VIS_IMG_AUTO_SEGMENT_GPU_A30.jpeg') #./image_dir/img_file 本地图片