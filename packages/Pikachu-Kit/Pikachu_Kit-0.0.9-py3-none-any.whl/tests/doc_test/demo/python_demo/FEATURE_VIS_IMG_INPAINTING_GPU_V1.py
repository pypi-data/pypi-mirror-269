...
################################################################################
"""
Brief:FEATURE_VIS_IMG_INPAINTING_GPU_V1 Demo, 以及压测数据生成的DEMO
Author: lichao(lichao40@baidu.com)
Date: 2020-05-09
Filename: FEATURE_VIS_IMG_INPAINTING_GPU_V1.py
"""
...
def feature_calculate(input_data):
    ...
    data = {
                ...
                "mask": Util.read_file(input_data)
            }
    ...
    headers = {
        ...
        'feature_name': 'FEATURE_VIS_IMG_INPAINTING_GPU_V1',
...
def gen_stress_data(input_dir):
    ...
    for image_file in img_file_list:
        data = {
                    ...
                    "mask": Util.read_file(input_dir + '/' + image_file),
                }
