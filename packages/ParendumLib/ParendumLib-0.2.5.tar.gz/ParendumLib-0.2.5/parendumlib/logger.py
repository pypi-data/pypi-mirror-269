...
class Logger:
    ...
    def log(self, level: str, message: str, content: dict = None, status_code: int = 0, save: bool = False):
        stack = inspect.stack()
        caller_info = stack[1]
        caller_name = caller_info.function
        caller_line_no = caller_info.lineno
        self._do_log(level, f"{caller_name}():{caller_line_no}", message, status_code, content=content, save=save)

    def success(self, message: str, content: dict = None, status_code: int = 0, save: bool = False):
        stack = inspect.stack()
        caller_info = stack[1]
        caller_name = caller_info.function
        caller_line_no = caller_info.lineno
        self._do_log('success', f"{caller_name}():{caller_line_no}", message, status_code, content=content, save=save)

    def debug(self, message: str, content: dict = None, status_code: int = 100, save: bool = False):
        stack = inspect.stack()
        caller_info = stack[1]
        caller_name = caller_info.function
        caller_line_no = caller_info.lineno
        self._do_log('debug', f"{caller_name}():{caller_line_no}", message, status_code, content=content, save=save)

    def info(self, message: str, content: dict = None, status_code: int = 200, save: bool = False):
        stack = inspect.stack()
        caller_info = stack[1]
        caller_name = caller_info.function
        caller_line_no = caller_info.lineno
        self._do_log('info', f"{caller_name}():{caller_line_no}", message, status_code, content=content, save=save)

    def warning(self, message: str, content: dict = None, status_code: int = 400, save: bool = False):
        stack = inspect.stack()
        caller_info = stack[1]
        caller_name = caller_info.function
        caller_line_no = caller_info.lineno
        self._do_log('warning', f"{caller_name}():{caller_line_no}", message, status_code, content=content, save=save)

    def error(self, message: str, content: dict = None, status_code: int = 500, save: bool = False):
        stack = inspect.stack()
        caller_info = stack[1]
        caller_name = caller_info.function
        caller_line_no = caller_info.lineno
        self._do_log('error', f"{caller_name}():{caller_line_no}", message, status_code, content=content, save=save)

    def exception(self, message: str, content: dict = None, status_code: int = 600, save: bool = False):
        stack = inspect.stack()
        caller_info = stack[1]
        caller_name = caller_info.function
        caller_line_no = caller_info.lineno
        self._do_log('exception', f"{caller_name}():{caller_line_no}", message, status_code, content=content, save=save)
