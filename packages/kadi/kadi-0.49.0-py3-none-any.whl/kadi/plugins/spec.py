...
def kadi_get_translations_paths():
    ...
    `Flask-Babel <https://python-babel.github.io/flask-babel>`__ Python library in order
    to find and extract strings to translate. Afterwards, the Kadi CLI can be used to
...
def kadi_register_oauth2_providers(registry):
    ...
    <https://docs.authlib.org>`__ Python library using a unique name, preferably by
