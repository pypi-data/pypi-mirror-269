...
class LookerViewQuery:
    ...
    default_schema: Optional[str] = None
    query: Optional[str] = None
    referenced_views: Optional[List[str]] = None
    ...
    def from_dict(obj: Any) -> 'LookerViewQuery':
        ...
        default_schema = from_union([from_str, from_none], obj.get("defaultSchema"))
        query = from_union([from_str, from_none], obj.get("query"))
        referenced_views = from_union([lambda x: from_list(from_str, x), from_none], obj.get("referencedViews"))
        ...
        return LookerViewQuery(default_database, default_schema, query, referenced_views, source_dataset_account, source_platform)
    ...
    def to_dict(self) -> dict:
        ...
        if self.query is not None:
            result["query"] = from_union([from_str, from_none], self.query)
        if self.referenced_views is not None:
            result["referencedViews"] = from_union([lambda x: from_list(from_str, x), from_none], self.referenced_views)
