...
class SpreadSheets:
    def __init__(self, credentials_file_path: Optional[str] = None, service_account_info: Optional[Any] = None, credentials_from_file: bool =True):
        self.credentials_file_path = credentials_file_path
        self.credentials_from_file = credentials_from_file
        self.service_account_info = service_account_info
        self.service = self.get_service()

    def get_credentials(self):
        if self.credentials_from_file:
