...
class RoleParameterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] variable_name: The name of the session variable to modify.
        :param pulumi.Input[str] variable_value: The value to assign to the session variable.
...
class _RoleParameterState:
    ...
    @property
    @pulumi.getter(name="variableValue")
    def variable_value(self) -> Optional[pulumi.Input[str]]:
        """
        The value to assign to the session variable.
        """
        return pulumi.get(self, "variable_value")
    ...
    @variable_value.setter
    def variable_value(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "variable_value", value)
...
class RoleParameter(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            role_name: Optional[pulumi.Input[str]] = None,
            variable_name: Optional[pulumi.Input[str]] = None,
            variable_value: Optional[pulumi.Input[str]] = None) -> 'RoleParameter':
        """
    ...
    @property
    @pulumi.getter(name="variableValue")
    def variable_value(self) -> pulumi.Output[str]:
        """
        The value to assign to the session variable.
        """
        return pulumi.get(self, "variable_value")
