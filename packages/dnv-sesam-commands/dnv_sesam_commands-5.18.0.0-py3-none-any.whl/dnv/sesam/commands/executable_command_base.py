...
class ExecutableCommandBase(WorkerCommand):
    ...
    Attributes:
        ...
        ExecutableFolder (str): The folder where the executable command is located.
        ShouldMoveOutputFiles (bool): Indicates if output files in sub-folders within the command's
            working directory should be moved to the working directory itself.
        OutputFilesToInclude (List[str]): A list of glob patterns representing files that will
            be moved from their locations to the command's working directory during the file moving
            process.
        OutputFilesToExclude (List[str]): A list of glob patterns representing files that will
            remain in their locations during the file moving process.
    """
    ...
    def arguments(self) -> str:
        """
        Gets the arguments to be passed to the command.
        """
    ...
    def executable_folder(self) -> str:
        """
        Gets the folder where the executable command is located.
        """
    ...
    def executable_folder(self, value: str):
        """
        Sets the folder where the executable command is located.
        """
    ...
    def should_move_output_files(self) -> bool:
        """
        Indicates if output files in sub-folders of the command's working directory should be moved
    ...
    def should_move_output_files(self, value: bool):
        """
        Sets the flag that determines if output files in sub-folders of the command's working
        director should be moved to the working directory itself.
        """
    ...
    def output_files_to_include(self) -> List[str]:
        """
        Gets a list of glob patterns representing files that will be moved from their locations to
        command's working directory during the file relocation process.
        """
    ...
    def output_files_to_include(self, value: Optional[List[str]]):
        """
        Sets a list of glob patterns representing files that will be moved from their locations to
        the command's work directory during the file relocation process. If None is passed, the list
        is set to ["**/**"], which includes all files in the command's working directory and its
        sub-directories.
        """
    ...
    def output_files_to_exclude(self) -> List[str]:
        """
        Gets a list of glob patterns representing files that will remain in their original
    ...
    def output_files_to_exclude(self, value: Optional[List[str]]):
        """
        Sets a list of glob patterns representing files that will remain in their original
        locations during the file relocation process. If None is passed, an empty list is assigned,
        which includes no files.
        """
