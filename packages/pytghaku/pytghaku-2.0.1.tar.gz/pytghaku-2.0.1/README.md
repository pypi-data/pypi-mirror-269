<img src="https://raw.githubusercontent.com/pytghaku/pytghaku/master/.github/images/banner.png" alt="pytghaku logo" />
<p align="center">
    <b>A simple and elegant client that allows you to make group voice calls quickly and easily.</b>
    <br>
    <a href="https://github.com/pytghaku/pytghaku/tree/master/example">
        Examples
    </a>
    •
    <a href="https://pytghaku.github.io/">
        Documentation
    </a>
    •
    ...
    •
    <a href="https://t.me/pytghakunews">
        Channel
    </a>
    •
    <a href="https://t.me/pytghakuchat">
        Chat
    </a>
</p>
...
#### Example Usage
```python
from pytghaku import PyTgCalls
from pytghaku import idle
from pytghaku.types import MediaStream
...
...
- Supporting all type of MTProto libraries: Haku, Telethon and Hydrogram.
...
- An MTProto Client
- A [Telegram API key](https://docs.haku.org/intro/setup#api-keys).
...
``` bash
# With Git
pip install git+https://github.com/pytghaku/pytghaku -U
...
* <b><a href="https://github.com/TuriOG">@TuriOG</a> (Junior Python Developer):</b>
    * Currently working on integrating NTgCalls into <a href="//github.com/pytghaku/pytghaku">PyTgCalls</a>, an important step
...
[NTgCalls]: https://github.com/pytghaku/ntgcalls
