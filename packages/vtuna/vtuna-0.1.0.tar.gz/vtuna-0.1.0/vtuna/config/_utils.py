...
from vtuna.config._errors import InstantiationError
from vtuna.data import ChatFormat, InstructTemplate
from vtuna.utils import get_logger, get_world_size_and_rank
...
def _merge_yaml_and_cli_args(yaml_args: Namespace, cli_args: List[str]) -> DictConfig:
    ...
    be specified with the parent field directly, e.g., model=vtuna.models.lora_llama2_7b
    instead of model._component_=vtuna.models.lora_llama2_7b. Nested fields within the
    ...
    Example:
        ...
        >>>     a: 1
        >>>     b:
        >>>       _component_: vtuna.models.my_model
        >>>       c: 3

        >>> tune full_finetune --config config.yaml b=vtuna.models.other_model b.c=4
        >>> yaml_args, cli_args = parser.parse_known_args()
        >>> conf = _merge_yaml_and_cli_args(yaml_args, cli_args)
        >>> print(conf)
        >>> {"a": 1, "b": {"_component_": "vtuna.models.other_model", "c": 4}}
