...
from vtuna.config._utils import _get_component_from_path, _has_component
...
def instantiate(
    ...
    **kwargs: Dict[str, Any],
    ...
    You can use this function to create the exact instance of a vtuna object you want
    ...
    Examples:
        >>> config.yaml:
        >>>     model:
        >>>       _component_: vtuna.models.llama2
        >>>       num_layers: 32
        >>>       num_heads: 32
        >>>       num_kv_heads: 32

        >>> from vtuna import config
        >>> vocab_size = 32000
