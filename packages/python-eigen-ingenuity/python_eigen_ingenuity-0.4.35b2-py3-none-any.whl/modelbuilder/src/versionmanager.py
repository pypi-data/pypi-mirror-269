...
class VersionManager:
    ...
    def __init__(self, config_manager):
        self.frozen_labels_list = config_manager.get_frozen_labels_list()
        self.version_labels_list = config_manager.get_version_labels_list()
        ...
        self.version_relationship = config_manager.get_version_relationship()
        self.next_version_relationship = config_manager.get_next_version_relationship()
...
#        self.future = assetmodelutilities.get_formatted_future_time()
    ...
    def get_labels_for_version_node(self, current_labels):
        ...
        for original_label in current_labels:
            ...
            if original_label in self.frozen_labels_list + self.required_labels:
                ...
                version_labels.append(self.version_prefix + original_label)
            else:
                pass
    ...
    def build_query_to_copy_node(self, original_node):
        ...
        for key, value in original_node[self.property_label].items():
            ...
            key = assetmodelutilities.validate_property(key)
    ...
    def make_copy_of_node(self, query, db_connector):
        ...
        if current_node_response:
            try:
                ...
                # Current node doesn't have the required property, so let's create and execute a query to add it
...
#       print(current_node_id, last_version_node_id, version_node_id)
    ...
    def update_version_numbers(self, current_node, last_version_node, version_node, db_connector):
        ...
        # This should always return a result because the query will add the property if it was missing
