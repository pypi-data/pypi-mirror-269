...
class Attachment(object):
    ...
    def __init__(self, filename=None, description=None, tags=None, size=None, last_modified_user=None, last_modified_date=None, hidden=None, local_vars_configuration=None):  # noqa: E501
