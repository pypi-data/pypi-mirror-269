...
class InsightDmpContext(object):
    ...
    def pftoken(self):
        ...
        Platform token that can be used to authorize requests to DMP webservices.  # noqa: E501
    ...
    def pftokenexpiry(self):
        ...
        The expiry time of the platform token, as milliseconds since 1/1/1970.  # noqa: E501
