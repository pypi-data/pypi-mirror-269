...
class AttachmentRules(object):
    ...
    def __init__(self, maxsize=None, maxattachcount=None, maxfilenamelen=None, invalidfilenamechars=None, maxdescriptionlen=None, local_vars_configuration=None):  # noqa: E501
        """AttachmentRules - a model defined in OpenAPI"""  # noqa: E501
