...
class OrderAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('created', 'updated', 'user_id',
                       'amount_requested', 'amount_approved', 'amount_approved_max',
                       'period_requested', 'period_approved', 'interests', 'period_free', 'free_loan',
                       'product', 'sign', 'status', 'promocode_code', 'contract_demo',
                       'is_first_loan', 'is_first_order'
                       )
