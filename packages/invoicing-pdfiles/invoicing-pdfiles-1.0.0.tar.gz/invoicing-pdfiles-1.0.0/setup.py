...
setup(
  name = 'invoicing-pdfiles',         #* Your package will have this name
  ...
  description="This package can be used to convert Excel invoices to PDF invoices. From Ardit Sulce's Udemy course.",    # Short description of your library
  author = 'Anon Ymous',                   # Your name
  author_email = 'AnonYmous@gmail.com',  # Your email
