...
def generate_model(
    ...
    * default - to set the default value for the attribute. It should be provided in the format: `default=<value>`.
    Example: `age:number:default=18 name:string:default="John Doe"`

    The options can be combined. Example: `email:string:unique:required`. The ordering of the options does not matter.
    """
