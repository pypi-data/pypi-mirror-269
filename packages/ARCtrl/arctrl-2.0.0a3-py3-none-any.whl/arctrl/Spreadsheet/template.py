...
TemplateReadError_reflection = _expr917
...
Metadata_Template_TemplateInfo_reflection = _expr918
                    ...
                    def _arrow927(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                        def _arrow926(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                            def _arrow925(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                ...
                                return append(singleton(SparseRowModule_fromValues(to_enumerable(["AUTHORS"]))), delay(_arrow924))

                            return append(Metadata_Tags_toRows(None, to_list(template.Tags)), delay(_arrow925))

                        return append(singleton(SparseRowModule_fromValues(to_enumerable(["TAGS"]))), delay(_arrow926))
