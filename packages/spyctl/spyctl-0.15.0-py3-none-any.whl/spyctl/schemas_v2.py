...
class ResponseActionsModel(BaseModel):
    ...
    @model_validator(mode="before")
    @classmethod
    def validated_not_none_if_set(cls, values):
...
class UidListMetadataModel(BaseModel):
    ...
    def valid_end_time(cls, values: Dict):
        start_time = values[lib.METADATA_START_TIME_FIELD]
        end_time = values[lib.METADATA_END_TIME_FIELD]
