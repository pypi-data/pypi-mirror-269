...
class StreamFile:
    async def stream_file(
        ...
        try:
            ...
            next_buffer = b''
            while True:
                print(1, len(buffer), len(next_buffer), current_file_part, file_part)
                try:
                    ...
                    if file_part is None or file_part == current_file_part:
                        print('storing', len(buffer), len(next_buffer), current_file_part, file_part, file_total_parts)
                    ...
                    buffer = next_buffer
                    next_buffer = b''
                    print(2, len(buffer), len(next_buffer), current_file_part, file_part)
