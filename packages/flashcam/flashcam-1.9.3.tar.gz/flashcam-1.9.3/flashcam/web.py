...
def ptz_windowsxp():
    ...
    if ptz_ok:
        ...
        print(f"i... {fg.orange} experim: dx=-1=no laps; laps 1s, 15s 60s {fg.default}")
        timelaps = 0
        try:
        ...
        try:
            ...
            pass
        if switchzoom>0: mmwrite(f"switch_re_on SWITCH_RES_ON" )
        if switchzoom<0: mmwrite(f"switch_re_off SWITCH_RES_OFF" )
