...
class App(object):
    _shares = {}  # 共享实例
    _alias = {  # 别名
        'redis': 'jeutil.Redis.Redis',
        'log': 'jeutil.Log.Log',
        'request': 'jeutil.Request.Request',
        'env': 'jeutil.Env.Env',
        'async': 'jeutil.Async.Async',
        'config': 'jeutil.ConfigParser.ConfigParser',
        'oss': 'jeutil.Oss.Oss',
        'path': 'jeutil.Path.Path',
        'rabbitmq': 'jeutil.RabbitMQ.RabbitMQ',
    }
