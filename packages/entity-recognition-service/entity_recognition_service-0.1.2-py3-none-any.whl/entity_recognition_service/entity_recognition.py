import json
import asyncio
from services.entity_extraction import extract_tech_entities, initialize_matcher_with_patterns
from services.recommendation_generation import dynamic_score_entities, recommend_technologies
from services.topic_classification import classify_text
