...
class QueryProcessor(object):
    """
       ...
       Args:
           data (NestedDict): A dataset wrapped in a NestedDict object.
    """

    def __init__(self, data):
        self.results = None
        self.dataset: NestedDict = NestedDict.convert_nested(data)  # Dictionary of data
    ...
    def process_query(self, query):
        """
           ...
           Returns:
               The result set after applying the query operations on the dataset.
           """
        ...
        if '$select' in query and '$operations' in query:
            ...
            raise QueryFormatError("Combining 'select' and aggregate functions in the same query is not supported.")
    ...
    def filter(self, data):
        ...
        result = list(self.dataset['data'].values())
