...
from data.neuro.models import RAMA_NO_SPRING_DETECT_MODEL_ADDRESS, RAMA_SPRING_DETECT_MODEL_ADDRESS
...
class Danila:
    ...
    def __init__(self, yolov5_dir):
        ...
        rama_no_spring_detect_model_path = RAMA_SPRING_DETECT_MODEL_ADDRESS
        self.rama_no_spring_detect_model = Rama_detect_class(rama_no_spring_detect_model_path, 'rama_spring_detect',
                                                             yolo_path)
