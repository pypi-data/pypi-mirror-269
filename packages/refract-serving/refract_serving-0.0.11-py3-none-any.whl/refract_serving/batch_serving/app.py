...
def write_result_db(data, predictions, write_strategy, input_file, output_path):
    ...
    new_table_name = f"{run_id}_{os.getenv('model_id')}_{os.getenv('version_id')}"
    ...
    # publish_url = "https://dev.fdc.leni.ai/project-manager/connections/api/Scan/v1/publish"
    ...
    # }
    # pulish_data = {
    #     "connectionId": "3e4a2c92-4a9d-4d01-bce1-ef58b5cd9bee", ##########
    #     "groupId": "admin",
    #     "sourceSystem": "",
    #     "userID": os.getenv('userId'),
    #     "createdBy": os.getenv('userId'),
    #     "projectId": os.getenv('PROJECT_ID'),
    #     "dataNodes": [{"label": "CAR_NEW",
    #                    "children": [],
    #                    "value": {"isDsNode": "True", "dbName": "SNOW_AMIT", "schemaName": "FIFA"},
    #                    "tags": [],
    #                    "dataDictionary": [], "expert": None, "sampling": False, "profiling": False, "isPublic": None,
    #                    "isBusinessMetaData": None, "description": None, "derivedFrom": None, "rangeOptions": None,
    #                    "leaf": True, "isFolder": None,
    #                    "displayName": "CAR_NEW",
    #                    "governWorkflow": None,
    #                    "fieldList": None, "level": "Table", "databaseseName": None, "schemaName": None,
    #                    "tableName": None, "checkBox": True, "dataMasking": None, "onlyFolder": None,
    #                    "additionalProperty": None, "policyMap": None, "application": None,
    #                    "sourceDataRefreshFrequency": None, "physicalName": None, "fullDataProfile": False,
    #                    "fullDataQuality": False, "consistencyReferenceAsset": None, "connectionDetails": None,
    #                    "key": 8004526120619534000, "published": False, "checked": True,
    #                    "connection": "SNOWFLAKE"}]
    # }
    #
    # result = requests.post(publish_url, json=pulish_data, headers=headers)
    # print("publish_details - ", result)
