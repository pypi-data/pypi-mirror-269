...
def run():
    ...
    depicting the leading edge radius of curvature for the most basic `pymead.core.airfoil.Airfoil` design: an
    airfoil with no `pymead.core.free_point.FreePoint`s or `pymead.core.anchor_point.AnchorPoint`s.
    """
