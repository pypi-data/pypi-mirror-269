...
def updateBin(rootDir):
    ...
    if sys.platform == "win32":
        getOssResource(rootDir, "https://p-template-hk.oss-cn-hongkong.aliyuncs.com/res/skymedia_win.zip", "2ffe4b19b531b42f81c2244283b32d1a", "skymedia.zip.py")
        ...
        getOssResource(rootDir, "https://p-template-hk.oss-cn-hongkong.aliyuncs.com/res/skymedia_darwin_20240425.zip", "3c05ab3c08f848f663d6a73303341f80", "skymedia.zip.py")
