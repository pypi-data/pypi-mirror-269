...
@aws_provider(name='pro',should_load=lambda:config.is_env_true(constants.ENV_PRO_ACTIVATED)and config_ext.ENABLE_DMS)
...
def events_v2():from localstack.services.events.provider_v2 import EventsProvider as A;B=A();return Service.for_provider(B)
@pro_aws_provider()
