...
class LHCbStepManagerHandler(WebHandler):
    ...
    def __getFilter(self):
        ...
        try:
            ...
            gLogger.info(f"__getFilter: Wrong selection: {str(e)}")
    ...
    def web_getStep(self):
        ...
        try:
            ...
            return {"success": "false", "result": [], "error": f"Can not convert File Types: {str(e)}"}
        self.__runtimeProjectsConvert(step)
    ...
    def __decodeFileTypes(self, s):
        ...
        try:
            ...
            gLogger.error(f"Cound not covert 's': {str(e)}")
        return r
