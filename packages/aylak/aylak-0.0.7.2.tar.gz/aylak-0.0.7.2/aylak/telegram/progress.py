...
from aylak.utils.human import TimeFormatter, humanbytes
    ...
    if round(diff % 10.00) == 0 or current == total:
        ...
        tmp = (
            ...
            + "__**{d_or_u} :**__ {current} / {total}\n__**Hız :**__ {speed}/s\n__**ETA :**__ {eta}\n".format(
                ...
                current=humanbytes(current, precision=3),
                total=humanbytes(total, precision=3),
                speed=humanbytes(speed, precision=3),
