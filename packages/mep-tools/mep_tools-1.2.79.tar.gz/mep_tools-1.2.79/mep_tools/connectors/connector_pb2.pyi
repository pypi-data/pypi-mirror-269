...
class DispatcherParams(_message.Message):
    __slots__ = ("start_date", "end_date", "filters", "requested_fields", "session_uuid", "is_compare_dataset")
    START_DATE_FIELD_NUMBER: _ClassVar[int]
    END_DATE_FIELD_NUMBER: _ClassVar[int]
    FILTERS_FIELD_NUMBER: _ClassVar[int]
    REQUESTED_FIELDS_FIELD_NUMBER: _ClassVar[int]
    SESSION_UUID_FIELD_NUMBER: _ClassVar[int]
    IS_COMPARE_DATASET_FIELD_NUMBER: _ClassVar[int]
    start_date: str
    end_date: str
    ...
    session_uuid: str
    is_compare_dataset: str
    def __init__(self, start_date: _Optional[str] = ..., end_date: _Optional[str] = ..., filters: _Optional[_Iterable[_Union[DispatcherFilter, _Mapping]]] = ..., requested_fields: _Optional[_Iterable[str]] = ..., session_uuid: _Optional[str] = ..., is_compare_dataset: _Optional[str] = ...) -> None: ...
