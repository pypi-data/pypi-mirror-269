...
class DispatcherParams(_message.Message):
    ...
    session_uuid: str
    is_compare_dataset: bool
    def __init__(self, start_date: _Optional[str] = ..., end_date: _Optional[str] = ..., filters: _Optional[_Iterable[_Union[DispatcherFilter, _Mapping]]] = ..., requested_fields: _Optional[_Iterable[str]] = ..., session_uuid: _Optional[str] = ..., is_compare_dataset: bool = ...) -> None: ...
