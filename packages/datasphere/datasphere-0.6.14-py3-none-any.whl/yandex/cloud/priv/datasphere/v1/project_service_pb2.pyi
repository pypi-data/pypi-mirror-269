...
class CreateProjectRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["description", b"description", "folder_id", b"folder_id", "labels", b"labels", "limits", b"limits", "name", b"name", "parent_checkpoint_uri", b"parent_checkpoint_uri", "settings", b"settings"]) -> None: ...
