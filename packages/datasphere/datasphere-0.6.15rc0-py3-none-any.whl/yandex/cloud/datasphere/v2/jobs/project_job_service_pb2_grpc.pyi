...
class ProjectJobServiceStub:
    ...
    DeleteAllData: grpc.UnaryUnaryMultiCallable[
        yandex.cloud.datasphere.v2.jobs.project_job_service_pb2.DeleteAllDataRequest,
        yandex.cloud.operation.operation_pb2.Operation,
    ]
...
class ProjectJobServiceServicer(metaclass=abc.ABCMeta):
    ...
    def DeleteAllData(
        self,
        request: yandex.cloud.datasphere.v2.jobs.project_job_service_pb2.DeleteAllDataRequest,
        context: _ServicerContext,
    ) -> typing.Union[yandex.cloud.operation.operation_pb2.Operation, collections.abc.Awaitable[yandex.cloud.operation.operation_pb2.Operation]]:
        """Delete all jobs data."""
