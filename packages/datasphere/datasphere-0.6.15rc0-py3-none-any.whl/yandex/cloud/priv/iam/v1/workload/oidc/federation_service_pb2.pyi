...
class UpdateFederationRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["audiences", b"audiences", "description", b"description", "disabled", b"disabled", "federation_id", b"federation_id", "issuer", b"issuer", "jwks_url", b"jwks_url", "labels", b"labels", "name", b"name", "update_mask", b"update_mask"]) -> None: ...
