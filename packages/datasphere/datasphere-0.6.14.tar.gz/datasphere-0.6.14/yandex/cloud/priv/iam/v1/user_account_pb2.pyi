...
class UserAccount(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["oauth_user_account", b"oauth_user_account", "saml_user_account", b"saml_user_account", "user_account", b"user_account", "yandex_passport_user_account", b"yandex_passport_user_account"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["id", b"id", "oauth_user_account", b"oauth_user_account", "saml_user_account", b"saml_user_account", "user_account", b"user_account", "yandex_passport_user_account", b"yandex_passport_user_account"]) -> None: ...
