...
class SalesforceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.BigCommerceLogin = channel.unary_unary(
                ...
                request_serializer=salesforce__service__pb2.Blah.SerializeToString,
                response_deserializer=salesforce__service__pb2.Blah.FromString,
                )
...
def add_SalesforceServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'BigCommerceLogin': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=salesforce__service__pb2.Blah.FromString,
                    response_serializer=salesforce__service__pb2.Blah.SerializeToString,
            ),
    }
...
class SalesforceService(object):
    ...
    def BigCommerceLogin(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mobilegateway.protos.SalesforceService/BigCommerceLogin',
            salesforce__service__pb2.Blah.SerializeToString,
            salesforce__service__pb2.Blah.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
